...
### [2] [Institutional Books - Visual Elements: An open-source pipeline for extracting, classifying, deduplicating, and captioning visual elements from digital book collections](https://arxiv.org/abs/2608.18957)
...
### [84] [Real-Time Design of Public Transport Lines: Reconciling Adaptivity and Efficiency](https://arxiv.org/abs/2608.18314)
...
### [85] [A Benchmark Graph Dataset for Transient Stability Assessment of the IEEE 9-Bus System: 20,000 Scenarios with Full Generator Trajectories](https://arxiv.org/abs/2608.18318)
...
### [86] [Model Predictive Supervisory Control for Hierarchical and Distributed UAS Traffic Management](https://arxiv.org/abs/2608.18353)
...
### [87] [LiDAR-Derived Surface Priors for Multimodal Sensing-Assisted NLoS Beam Search in Indoor 60-GHz Networks](https://arxiv.org/abs/2608.18396)
...
### [88] [Power Estimation and Optimal Work-Charging Scheduling of Construction Electric Vehicles via Mobile Charging Stations](https://arxiv.org/abs/2608.18494)
...
### [89] [Toward Controllability-Aware Performance Measures: A Case Study on Controllable Highway Congestion](https://arxiv.org/abs/2608.18510)
...
### [90] [Exact Robust Instability Analysis for Networked Dynamical Systems with Biological Application](https://arxiv.org/abs/2608.18553)
...
### [91] [Robust Instability Radius for Networked Dynamical Systems: Upper and Lower Bounds](https://arxiv.org/abs/2608.18561)
*Shinji Hara,Yutaka Hori,Tetsuya Iwasaki,Chung-Yao Kao,Sei Zhen Khong*
...
### [92] [Toward S^2C^2I-Integrated High-Altitude Platforms: Architectures, Cross-Functional Design, Evaluation, and Deployment Perspectives](https://arxiv.org/abs/2608.18587)
...
### [93] [Payload Swing Estimation and Damping Without Payload Parameters for Multirotor UAVs](https://arxiv.org/abs/2608.18625)
*K. Taki,K. Umemoto*
...
### [94] [Adaptive Nonlinear Control with Online Identification and Receding-Horizon Optimization](https://arxiv.org/abs/2608.18717)
*Igor Ladnik*
...
### [95] [Detecting Feedback-path Delay Injection Attacks Using Interacting Multiple Model Filtering](https://arxiv.org/abs/2608.18824)
...
### [96] [Robust Joint Planning of EV and eBus Charging Infrastructure with PV Self-Consumption under Demand Uncertainty](https://arxiv.org/abs/2608.18844)
*Biswarup Mukherjee*
...
### [97] [Comparing Controller Synthesis Methods with Deadline-Miss Awareness](https://arxiv.org/abs/2608.18850)
...
### [98] [Deciding Relabeling Observation Consistency in Multi-Agent Discrete-Event Systems](https://arxiv.org/abs/2608.18866)
*Tomáš Masopust*
...
### [99] [Limitations of RMS-based Stability Assessment of Converter-based Grids: A Case Study](https://arxiv.org/abs/2608.18989)
...
### [100] [Comparison of several model averaging methods in nuclear charge radius predictions](https://arxiv.org/abs/2608.18463)
...
### [101] [Reaction Cross Sections and $α$-Cluster Geometry in $^{12}$C and Be Isotopes](https://arxiv.org/abs/2608.18538)
...
### [102] [Toward testing antinucleon$\unicode{x2013}$nucleus optical potentials with antineutron scattering lengths](https://arxiv.org/abs/2608.18668)
...
### [103] [Balancing theory uncertainties in ab initio nuclear structure calculations: Many-body truncation versus finite basis size](https://arxiv.org/abs/2608.18975)
...
### [104] [Symmetries of QCD and their relevance for low-energy nuclear physics](https://arxiv.org/abs/2608.18995)
...
### [105] [Global Crises and National Policies: A Large Scale Analysis of Political Content in German Language Online Media](https://arxiv.org/abs/2608.18268)
...
### [106] [Multimedia Asset Personalization via Multimodal Embeddings at Netflix](https://arxiv.org/abs/2608.18322)
...
### [107] [AI in Search Reduces Publisher Referrals Without Improving User Experience: Experimental Evidence](https://arxiv.org/abs/2608.18352)
...
### [108] [More Context, Same Budget: Dual-Bounded Relational Recall Beyond Top-K Retrieval](https://arxiv.org/abs/2608.18448)
*Thomson D. Nguy*
...
### [109] [OneModel: A Unified Foundation for Platform-Scale Multi-Scenario Ranking](https://arxiv.org/abs/2608.18606)
...
### [110] [PILOT Technical Report](https://arxiv.org/abs/2608.18637)
...
### [111] [GreekBarRetrieval: A Benchmark for Greek Statutory Retrieval](https://arxiv.org/abs/2608.18752)
...
### [112] [GateDiffInt: Gate-Mediated Controllable Diffusion and Multi-Intent LLM Distillation for User Behavior Modeling](https://arxiv.org/abs/2608.18764)
...
### [113] [SIDScope: A Diagnostic Resource for Semantic-ID Interfaces in Generative Recommendation](https://arxiv.org/abs/2608.18779)
...
### [114] [Think-to-Personalize: Unifying Reasoning and Retrieval for User-Centric Personalized Dense Retrieval](https://arxiv.org/abs/2608.18855)
...
### [115] [rEDMRec: Distilling Large Language Model Reasoning into an Editable Experience Memory for Recommendation](https://arxiv.org/abs/2608.18952)
...
### [116] [Demo: tfdrift - A Severity Taxonomy and Risk Classification Framework for Infrastructure Drift Detection](https://arxiv.org/abs/2608.18173)
...
### [117] [Reproducibility is Not Enough: Artifact Verifiability in Decentralized-Build Package Ecosystems](https://arxiv.org/abs/2608.18180)
...
### [118] [What Makes Software Issue Resolution Tasks Difficult for Agents?](https://arxiv.org/abs/2608.18280)
...
### [119] [Engine-Transfer-Bench: An Evidence-Based Benchmark for Document Compilation Engine Selection](https://arxiv.org/abs/2608.18329)
...
### [120] [One Gate Is Not Enough: Composing Stateful Pre-Action Controls for Agentic AI](https://arxiv.org/abs/2608.18360)
*Gaston Besanson*
...
### [121] [Building real-time digital twin instances with Function+Data Flow: user evaluation and extension for iterative pipelines](https://arxiv.org/abs/2608.18480)
...
### [122] [SemaPLC: A Project-Grounded, Verification-Gated Agent Harness for PLC Code Generation](https://arxiv.org/abs/2608.18565)
...
### [123] [AppEval: A Unified Benchmark for LLM-Based Mobile Application Repair in ArkTS, Swift, and Kotlin](https://arxiv.org/abs/2608.18588)
...
### [124] [OdinEval: A Reproducible Benchmark for LLM-Based Program Repair in the Odin Programming Language](https://arxiv.org/abs/2608.18595)
...
### [125] [Code Health in LLM-Based Test Generation: Effectiveness and Token Efficiency](https://arxiv.org/abs/2608.18645)
...
### [126] [Flama: a Python framework for development and deployment of production-ready APIs, machine learning, and LLM services](https://arxiv.org/abs/2608.18733)
...
### [127] [Contract-Aware Rescue of a Drifted Isabelle Development: The Double-Tank Case Study](https://arxiv.org/abs/2608.18822)
...
### [128] [SkillForge: Self-Distilling Agents for Project-Specific Issue Resolution](https://arxiv.org/abs/2608.18933)
...
### [129] [MediaGraph: A Content-Aware Data Model and Query Framework for Multimodal Knowledge Graphs](https://arxiv.org/abs/2608.18895)
...
### [130] [Position: Collusion Risks Among AI Reasoning Agents Justify Certification Requirements for Making Market Decisions](https://arxiv.org/abs/2608.18078)
...
### [131] [Position: Profiling Game Worlds by Transition Complexity](https://arxiv.org/abs/2608.18079)
*Lele Cao*
...
### [132] [Large Language Models in Mental Health: A Systematic Review of Applications, Innovations, and Ethical Challenges](https://arxiv.org/abs/2608.18080)
...
### [133] [Position: Behavioral Systems Require Behavioral Tests](https://arxiv.org/abs/2608.18081)
...
### [134] [Position: Current Model Cards Are Insufficient for Downstream Governance of Open-Weight Foundation Models](https://arxiv.org/abs/2608.18086)
...
### [135] [A Metamorphic Artificial Age Score Decision-Support Prototype for Flight-Log-Based Drone Propeller Health Monitoring](https://arxiv.org/abs/2608.18088)
...
### [136] [Position: Multi-Agent Systems Should Prioritize Concurrency Control](https://arxiv.org/abs/2608.18092)
...
### [137] [FinSkillBench: Evaluating AI Agents and Domain Skills for Investment Management](https://arxiv.org/abs/2608.18099)
...
### [138] [Self-Evolving Agents as Dynamic Graph Transformation: A Survey and New Perspective](https://arxiv.org/abs/2608.18104)
...
### [139] [Emergence of Agentic AI: A Review on Evolution, Background, Working Principles, Applications, Adoption Factors, and Future Research Directions](https://arxiv.org/abs/2608.18110)
...
### [140] [Solving Is Not Drawing: A Benchmark for Diagrammatic Reasoning in Olympiad Geometry](https://arxiv.org/abs/2608.18111)
...
### [141] [Redakto - The Incognito Tab for LLMs](https://arxiv.org/abs/2608.18260)
...
### [142] [Position: AI Leaderboards Are Underserving the Global South: A Case Study from India](https://arxiv.org/abs/2608.18117)
...
### [143] [Evaluating Structured Information Extraction with Open Models in a High Risk Public Sector Application](https://arxiv.org/abs/2608.18289)
...
### [144] [Safety Alignment Illusion: The Cross-Lingual Safety Gap in LLMs](https://arxiv.org/abs/2608.18131)
*Namya Bhatnagar*
...
### [145] [FinRCA-Bench: Benchmarking Evidence Retrieval and Reasoning for Financial AI Systems](https://arxiv.org/abs/2608.18534)
*Pratik Ghawate*
...
### [146] [Optimized Fuzzy Logic Approach with the IEEE Key Gas Method for Diagnosing Power Transformer Faults Using Dissolved Gas Analysis](https://arxiv.org/abs/2608.18133)
...
### [147] [Adversarial Review: Structured Disagreement for Grounded Agentic Code Review](https://arxiv.org/abs/2608.18167)
...
### [148] [Improving Rural Medication Safety with AI: A Scoping Review](https://arxiv.org/abs/2608.18135)
...
### [149] [FraudBench: Stress-Testing Policy-Grounded Banking Agents Against Adaptive Fraud](https://arxiv.org/abs/2608.18136)
...
### [150] [Metrics That Write Themselves: Evolving an Evaluator from Its Own Blind Spots](https://arxiv.org/abs/2608.18744)
...
### [151] [Efficient Adaptation of LLMs for Hate Speech Detection in Low-Resource Languages: A Comparative Study on Roman Urdu](https://arxiv.org/abs/2608.18142)
...
### [153] [RDFdL: Integrating RDF with Differential Dynamic Logic](https://arxiv.org/abs/2608.18165)
...
### [154] [Grouping the Stochastic Machine: Precision, Not Capability, as the Frontier Metric for AI Systems](https://arxiv.org/abs/2608.19140)
*George Andrikopoulos*
...
### [155] [Looped Language Models Improve Compositional Tool Calling](https://arxiv.org/abs/2608.18171)
...
### [156] [On the Triangle Inequality for the Jaccard Distance in Arbitrary Lattices](https://arxiv.org/abs/2608.18194)
...
### [157] [GenEx: A Graph-Based Representational Paradigm for SARS-CoV-2 Variant Detection via Codon Co-occurrence Networks](https://arxiv.org/abs/2608.18238)
...
### [158] [Cacheable by Design? Training Mixture-of-Experts Routers for Locality Against the Edge Memory-Bandwidth Wall: A Pre-Registered Negative Result with a Systems Measurement Study](https://arxiv.org/abs/2608.18261)
...
### [159] [The Lifecycle of LLM-as-a-Judge for Large-Scale Recommendation Explanations](https://arxiv.org/abs/2608.18300)
...
### [160] [SESSE: Sketch, Expand, Sort, Summarize, Evaluate -- LLM-as-Judge Evaluation via Structured Decomposition](https://arxiv.org/abs/2608.18303)
...
### [161] [ComponentBench: Diagnosing Component-Level Failures in Computer-Use Agents](https://arxiv.org/abs/2608.18307)
...
### [162] [Governance Records as Supervision: Verifier-Selected Self-Training for Structured Workflow Repair](https://arxiv.org/abs/2608.18324)
*Jesus Salas*
...
### [163] [Measuring the Partial-Credit Gap: A Strict Benchmark on Vietnam's 2025 Convex Marking Scheme](https://arxiv.org/abs/2608.18336)
...
### [164] [A Jagged Frontier: Evaluating Robustness of Code Agents to Semantics-Preserving Transformations](https://arxiv.org/abs/2608.18389)
...
### [165] [When Clean Signals Are Not Enough: Detecting Structural Ambiguity for Safe Wearable Stress Classification](https://arxiv.org/abs/2608.18397)
...
### [166] [Improving Natural-Language Combinatorial-Optimization Accuracy in Resource-Constrained Language Models via Formal Abstractions](https://arxiv.org/abs/2608.18409)
...
### [167] [FM-Bench: A Benchmark for Long-Horizon Management with Competing Agents](https://arxiv.org/abs/2608.18423)
...
### [168] [UMER: Unifying Embedding and Ranking via Pair-Aware Discriminative Reasoning for Universal Multimodal Retrieval](https://arxiv.org/abs/2608.18504)
...
### [169] [Which Negatives Matter? Ask Your Text Encoder: Adaptive Similarity Margins for Dense-Caption Retrieval](https://arxiv.org/abs/2608.18521)
...
### [170] [Pairwise Ranking Outperforms Single-Action RL for Offline Explanation Selection: A Practical Lesson](https://arxiv.org/abs/2608.18531)
...
### [171] [Bridging Search and CRM: Productionizing AI Product Research Agents for Customer Re-Engagement](https://arxiv.org/abs/2608.18543)
...
### [172] [FACET: Preserving Source Intent and Executable State in Terminal Task Synthesis](https://arxiv.org/abs/2608.18580)
...
### [174] [CTIFoundry: An Agent-Native Corpus Scaffold for Cyber Threat Intelligence](https://arxiv.org/abs/2608.18613)
...
### [175] [Preference Reasoning under Indeterminacy in Large Language Models](https://arxiv.org/abs/2608.18631)
...
### [176] [Candidate-Fate Accounting for Transparent Sensor Diagnostic Pipeline Search](https://arxiv.org/abs/2608.18665)
...
### [177] [Sanyu Studio: A Multi-Agent System for Art-Historical Narrative Construction](https://arxiv.org/abs/2608.18677)
...
### [178] [RTPO: Reverse-Turn Policy Optimization for Stabilizing Agentic RL Training](https://arxiv.org/abs/2608.18682)
...
### [179] [Competence, Not Accuracy: A Diagnostic for Reference-Free Judge Gates in Skill Optimization](https://arxiv.org/abs/2608.18719)
...
### [180] [A Multi-Agent Platform for Automated Enterprise Analytics and Insight Generation](https://arxiv.org/abs/2608.18740)
...
### [181] [Pairwise Logical Selection of Enthymeme Completions under Semantic-Link Uncertainty](https://arxiv.org/abs/2608.18820)
...
### [182] [Verifiable abstention makes AI leak diagnosis accountable in water distribution networks](https://arxiv.org/abs/2608.18836)
...
### [183] [ORBITER: Conflict-Aware Decision-Making for Agentic Last-Mile Delivery](https://arxiv.org/abs/2608.18846)
...
### [184] [SkillGate: Training In-Policy Skill Selection in Long-Horizon Agents](https://arxiv.org/abs/2608.18852)
...
### [185] [DentAgent: Evidence-Centric Multi-Agent Coordination for Multimodal Dental Reasoning](https://arxiv.org/abs/2608.18878)
...
### [186] [Training-Free Inference-Time Self-Reflection and Cost-Bounded Early Stopping for Large Language Models](https://arxiv.org/abs/2608.18884)
...
### [187] [Syntactic Simplification of OWL Class Expressions](https://arxiv.org/abs/2608.18899)
...
### [188] [\textsc{TestifAI}: Tomography-Based Testing for Deep Learning Systems](https://arxiv.org/abs/2608.18900)
...
### [189] [Breaking the weakest link to evade vision language models](https://arxiv.org/abs/2608.18938)
...
### [190] [A Theory of Post-hoc Debate Judgement](https://arxiv.org/abs/2608.19002)
...
### [191] [Self-prompting and cross-model consensus enable reproducible data extraction from scientific literature with large language models](https://arxiv.org/abs/2608.19025)
...
### [192] [Adaptive Memory and Reflection Multi-Agent System for Medical Question Answering](https://arxiv.org/abs/2608.19029)
...
### [193] [Eureka: Task-Conditioned Meta-Agent Orchestration for Scientific Discovery](https://arxiv.org/abs/2608.19047)
...
### [194] [What is Missing from AI Post-Training AI: An Empirical Analysis](https://arxiv.org/abs/2608.19072)
...
### [195] [Robust Risk Under Evolving Uncertainty: A Wasserstein Counterpart of the Entropic Value-at-Risk](https://arxiv.org/abs/2608.19073)
...
### [196] [Beyond the Transcript: Detecting Covert Co ordination in Latent Multi-Agent Communication](https://arxiv.org/abs/2608.19161)
...
### [197] [Observation of enhanced baryon production using strange hadrons in oxygen-oxygen collisions](https://arxiv.org/abs/2608.18256)
*CMS Collaboration*
...
### [198] [Improved $^{94}$Mo neutron resonance parameters from neutron capture and transmission measurements at n_TOF and GELINA](https://arxiv.org/abs/2608.18775)
...
### [199] [When Do Microservices Save Energy? Evidence from Environmental Simulation Workflows](https://arxiv.org/abs/2608.18376)
...
### [200] [SLO-Scaler: Uncertainty-Aware SLO-Driven Autoscaling for Microservices](https://arxiv.org/abs/2608.18390)
...
### [201] [A Simple Construction of Locally Checkable Problems Filling the LOCAL Complexity Gaps in Graphs with Arbitrary Large Degrees](https://arxiv.org/abs/2608.18684)
...
### [202] [Enabling Reuse for Data-Sharing Pipelines in Federated Environments](https://arxiv.org/abs/2608.18751)
...
### [203] [Tight Energy Lower Bounds for Distributed Graph Algorithms](https://arxiv.org/abs/2608.18992)
...
### [204] [Approximating Minimum Dominating Set with Few Awake Rounds](https://arxiv.org/abs/2608.19096)
...
### [205] [Pre-Compiled Pipeline Shards for Distributed LLM Inference on Intel AI PC Fleets](https://arxiv.org/abs/2608.19147)
...
### [206] [Upper and Lower Bounds on the Space Complexity of Multi-word Single-Writer Registers](https://arxiv.org/abs/2608.19167)
...
### [207] [A Fast Deterministic Algorithm for $(Δ+1)$-edge coloring in CONGEST](https://arxiv.org/abs/2608.19184)
