...
### [6] [PBLH Estimation from Satellite Radiances via a Dual-Encoder Transformer](https://arxiv.org/abs/2609.28286)
...
### [8] [Spec2COBOLRot: An Agentic-AI Degradation Loop for Realistic COBOL Corpus Generation](https://arxiv.org/abs/2609.26835)
...
### [9] [A Hybrid Rule-Based and AI-Augmented Framework for Automatic Failure Recovery in DevOps Deployments](https://arxiv.org/abs/2609.26838)
...
### [10] [Who Finishes the Job? A Study of Follow-Up Fixes and Commit Authorship on AI Coding Agent Pull Requests](https://arxiv.org/abs/2609.26847)
...
### [11] [Kubernetes Misconfigurations in the Wild: Taxonomy, Evolution, and Automated Repair with Large Language Models](https://arxiv.org/abs/2609.27030)
...
### [12] [Stage-Supervised Latent Reasoning for Single-Shot JavaScript Deobfuscation](https://arxiv.org/abs/2609.27058)
...
### [13] [Does Graph Structure Earn Its Place in Microservice Root-Cause Analysis? A Controlled Study on RCAEval, and What the Benchmark Was Really Measuring](https://arxiv.org/abs/2609.27069)
*Imad Buljić*
...
### [14] [Verified Learning for Compiler Optimization: An LLM-Guided Architecture with Formal Control](https://arxiv.org/abs/2609.27214)
...
### [15] [From PyTorch to the NPU: LLM-Agent-Driven Model Conversion Across Heterogeneous Inference Runtimes](https://arxiv.org/abs/2609.27249)
...
### [16] [Specifying and Maintaining Agentic Workflows: An Empirical Study of GitHub Agentic Workflows](https://arxiv.org/abs/2609.27263)
...
### [17] [Teach-to-Crash: A Closed-Loop Student-Teacher LLM Framework for Collision-Inducing Test Scenario Generation](https://arxiv.org/abs/2609.27296)
...
### [18] [FairTest: Search-Based Fairness Testing for Multi-Agent Reinforcement Learning Systems](https://arxiv.org/abs/2609.27309)
...
### [19] [Constraint-Driven Context Engineering: Designing Domain Interfaces for AI Systems](https://arxiv.org/abs/2609.27354)
...
### [20] [FDE-Bench: Evaluating LLM Agents for Deployment Environment Configuration](https://arxiv.org/abs/2609.27571)
...
### [21] [Unity Insight: A Production Code--Asset Index for LLM Coding Agents in Unity Projects](https://arxiv.org/abs/2609.27585)
...
### [22] [AST-Based Automated Elimination of break and continue Statements in Java Code](https://arxiv.org/abs/2609.27627)
...
### [23] [Foundations of Algebraic Architecture Theory: A Rising Sea of Geometry, Transport, Comparison, and Reconstruction](https://arxiv.org/abs/2609.27638)
*Hiroyuki Nakahata*
...
### [24] [Satisfaction Is Not Explanation: Auditing Vacuity and Training Influence in Temporal-Logic-Guided Reinforcement Learning](https://arxiv.org/abs/2609.27743)
*Lorenzo Bacchiani*
...
### [25] [DualMine: Static-Dynamic REST API Constraint Discovery with Dual Validation](https://arxiv.org/abs/2609.27806)
...
### [26] [PonyEval: Evaluating LLM-Based Program Repair for Capability-Safe and Actor-Oriented Pony Software](https://arxiv.org/abs/2609.27832)
...
### [27] [Bounded Loops: Pre-Run Spend Bounds, Proved Termination, and Verified Completion for Agent Harnesses](https://arxiv.org/abs/2609.27871)
...
### [28] [Schrödinger's Code Repository: Have LLMs Learned SWE-bench or Memorized It?](https://arxiv.org/abs/2609.27891)
...
### [29] [From Agent Output to Authorized Transition](https://arxiv.org/abs/2609.28216)
*Christopher Koch*
...
### [31] [Non-Commutative State Tracking with Input-Dependent Low-Rank Updates in Mamba-3](https://arxiv.org/abs/2609.28273)
...
### [32] [Propose, Don't Judge: An Anytime-Valid Referee for LLM Agents That Mine Investment Factors](https://arxiv.org/abs/2609.27051)
