...
### [1] [Observation of Strong $φ$-meson Directed Flow at High Baryon Density](https://arxiv.org/abs/2606.05694)
...
### [2] [Heavy flavor physics with the sPHENIX MAPS vertex tracker upgrade](https://arxiv.org/abs/2606.05726)
*Yuanjing Ji*
...
### [3] [Emerging collectivity and phase transition in mass A$\approx$150 region. New information for Nd isotopes](https://arxiv.org/abs/2606.06319)
...
### [6] [Characterization and Analysis of Emergency Landing Flight Envelopes with Graded Safety Specifications](https://arxiv.org/abs/2606.05350)
...
### [8] [$γW$-exchange correction beyond the forward-angle limit in neutron $β$ decay](https://arxiv.org/abs/2606.05643)
...
### [10] [Reply to the Comment on "Partial conservation of seniority in semi-magic nuclei"](https://arxiv.org/abs/2606.06112)
*Chong Qi*
...
Abstract: The present Reply addresses the Comment as posted on arXiv (arXiv:2606.04137 [nucl-th], June 2026).

</details>


### [11] [Equilibrium state of a Fermi system in the diffusion approximation of kinetic theory](https://arxiv.org/abs/2606.06321)
*Sergiy V. Lukyanov*
