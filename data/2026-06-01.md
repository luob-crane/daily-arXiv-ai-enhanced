...
### [68] [SpatialAct: Probing Spatial Reasoning-to-Action Capabilities of VLM Agents in 3D Scenes](https://arxiv.org/abs/2605.31148)
...
### [71] [Benchmarking and Enhancing Text-to-Image Models for Generating Visual Representations in Early Arithmetic Education](https://arxiv.org/abs/2605.31212)
...
### [78] [Detect in Any Scene: An Agentic Framework for Object Detection with Experience-Aware Reasoning](https://arxiv.org/abs/2605.31174)
...
### [80] [Vanilla ViT for Automotive Point Cloud Semantic Segmentation](https://arxiv.org/abs/2605.31177)
...
### [81] [From Local Geometry to Global Pseudo Labeling for Robust Positive Unlabeled Learning under Covariate Shift](https://arxiv.org/abs/2605.31187)
...
### [82] [The Regularizing Power of Language-Training Deepfake Detectors](https://arxiv.org/abs/2605.31192)
...
### [84] [RayDer: Scalable Self-Supervised Novel View Synthesis from Real-World Video](https://arxiv.org/abs/2605.31535)
...
### [85] [Probabilistic Precipitation Nowcasting with Rectified Flow Transformers](https://arxiv.org/abs/2605.31204)
...
### [86] [Vision-Language Models Suppress Female Representations Under Ambiguous Input](https://arxiv.org/abs/2605.31556)
...
### [87] [TALON: Token-Aligned Lightweight Adapters for 6-DoF Spacecraft Pose Estimation](https://arxiv.org/abs/2605.31217)
...
### [89] [Latent Geometric Chords for Query-Efficient Decision-Based Adversarial Attacks](https://arxiv.org/abs/2605.31219)
...
### [91] [HiERO-StepG @ Ego4D Step Grounding Challenge: hierarchical activity understanding enables zero-shot step grounding](https://arxiv.org/abs/2605.31227)
...
### [92] [DriveMA: Driving Vision-Language-Action Models with verifiable Meta-Actions](https://arxiv.org/abs/2605.31271)
...
### [93] [Topologically Consistent Multi-view 3D Head Reconstruction via Coarse-Guided Layered Surface Sampling](https://arxiv.org/abs/2605.31283)
...
### [94] [Authentication of Copy Detection Patterns via Cross-Camera Dual-Synthetic Referencing](https://arxiv.org/abs/2605.31292)
...
### [95] [TokTalk: Expressive Real-time Facial Animation from Audio-LLM Tokens](https://arxiv.org/abs/2605.31294)
...
### [96] [Learning from Fine-Grained Visual Discrepancies: Mitigating Multimodal Hallucinations via In-Context Visual Contrastive Optimization](https://arxiv.org/abs/2605.31312)
...
### [97] [DecMem: Towards Minute-Long Consistent World Generation with Decoupled Memory](https://arxiv.org/abs/2605.31336)
...
### [120] [Time-ordered Diagrammatic Monte Carlo for atomic nuclei](https://arxiv.org/abs/2605.30527)
...
### [122] [Optimized basis of covariant density functional theory: point coupling functionals and excited states](https://arxiv.org/abs/2605.30669)
...
### [123] [Dynamical selection of fragment shell effects in spontaneous fission of $^{240}$Pu, $^{232}$Th, and $^{264}$Fm](https://arxiv.org/abs/2605.30828)
...
### [125] [High-Dimensional Bayesian Calibration of Expensive Nuclear Models with Differentiable Emulation](https://arxiv.org/abs/2605.30980)
*Jin Lei*
...
Abstract: Full Bayesian calibration of expensive nuclear models has been blocked not by the cost of any single solve, but by the absence of exact likelihood gradients in legacy parameter-dependent operators, which forces gradient-free samplers to spend $\mathcal{O}(10^5)$ evaluations exploring high-dimensional correlated posteriors. I introduce DREAM, a differentiable calibration strategy in which the parameter-dependent operator is sampled offline by any legacy code, compressed by singular value decomposition, and reconstructed online in a differentiable framework so that automatic differentiation delivers exact likelihood gradients through the full forward solve at the cost of one additional evaluation per Hamiltonian Monte Carlo step. The construction is operator-level and depends only on smooth, compressible parameter dependence; the underlying physics solver is treated as a black box. As a representative demonstration, DREAM is applied to a continuum-discretized coupled-channels (CDCC) analysis of $d$+$^{58}$Ni elastic scattering at $21.6$~MeV with eighteen optical-potential parameters, for which No-U-Turn Sampling converges on a single GPU in tens of minutes with zero divergent transitions, yielding a full Bayesian posterior for a breakup reaction. The mean emulator error is more than an order of magnitude below the inferred model discrepancy, so the posterior is set by the reaction model rather than the surrogate. The posterior tightly constrains the average deuteron surface absorption and supports a substantial proton/neutron asymmetry relative to the Koning-Delaroche systematics, a representative payoff that the multi-energy datasets DREAM is designed to accommodate can sharpen into a full physics interpretation.

</details>


### [126] [Accessing Exotic Hadronic States via Charmed-Meson Femtoscopy in Relativistic Heavy-Ion Collisions](https://arxiv.org/abs/2605.31527)
...
### [127] [Resonant Method-based Fully Automated Core Loss Measurement System for Sub-MHz Magnetics With Switched Capacitor Sequence](https://arxiv.org/abs/2605.30460)
...
### [128] [Bounds on Prediction Error When Using an Impulse Response/Equilibrium Model Structure](https://arxiv.org/abs/2605.30691)
...
### [129] [A Data-Driven Methodology for Scalable Distributed MPC in Heterogeneous Building Aggregation: From Systematic Feature Selection to Convex Optimization](https://arxiv.org/abs/2605.30763)
...
### [130] [Safe Arrival Scheduling at Constraint Waypoints in UAM Corridors](https://arxiv.org/abs/2605.31243)
...
### [131] [Steering Fractional-Order Network Dynamics via Joint Parameter and State Control](https://arxiv.org/abs/2605.31270)
...
### [132] [Model-free LQG Control with Chance Constraints](https://arxiv.org/abs/2605.31310)
...
### [133] [Current Practices in Electricy Demand and Charging Scheduling for On-Road Electric Fleet Operations: An Industry-Wide Review](https://arxiv.org/abs/2605.31396)
...
### [134] [Polynomial Histograms for Memory-Efficient Representation of Long-tailed System Distributions](https://arxiv.org/abs/2605.30360)
...
### [135] [Energy-Efficient Aggregation and Minimum-Degree Spanning Trees in Radio Networks](https://arxiv.org/abs/2605.30546)
...
### [136] [A Datalog Framework for Conflict-Free Replicated Data Types](https://arxiv.org/abs/2605.31569)
...
### [137] [PhyDrawGen: Physically Grounded Diagram Generation from Natural Language](https://arxiv.org/abs/2605.30512)
...
### [138] [Physically Viable World Models: A Case for Query-Conditioned Embodied AI](https://arxiv.org/abs/2605.30542)
...
### [139] [Transforming and Encoding FTS for SAT Solving: What Helps, What Hurts (Extended Version)](https://arxiv.org/abs/2605.30563)
...
### [140] [Procedural Generation of First Person Shooter Maps using Map-Elites](https://arxiv.org/abs/2605.30570)
...
### [141] [Vector Linking via Cross-Model Local Isometric Consistency](https://arxiv.org/abs/2605.31100)
...
### [142] [Uncertainty-Aware and Temporally Regulated Expert Advice in Reinforcement Learning for Autonomous Driving](https://arxiv.org/abs/2605.30576)
...
### [143] [Harness Updating Is Not Harness Benefit: Disentangling Evolution Capabilities in Self-Evolving LLM Agents](https://arxiv.org/abs/2605.30621)
...
### [144] [EHRBench: An Automated and Reliable EHR-based Benchmark for Clinical Decision Making with LLMs](https://arxiv.org/abs/2605.30637)
...
### [145] [Structure-Induced Information for Rerooting Levin Tree Search](https://arxiv.org/abs/2605.30664)
...
### [146] [Healthcare Mechanisms from Policy-as-Code Search under Strategic Provider Response](https://arxiv.org/abs/2605.30680)
...
### [147] [MAVEN: Improving Generalization in Agentic Tool Calling](https://arxiv.org/abs/2605.30738)
...
### [148] [Generating Graph-like Rules for Knowledge Graph Reasoning via Diffusion Models](https://arxiv.org/abs/2605.30747)
...
### [149] [Learning Agent-Compatible Context Management for Long-Horizon Tasks](https://arxiv.org/abs/2605.30785)
...
### [150] [PReMISE: Policy Rubrics as Measurement Specifications for LLM Judges](https://arxiv.org/abs/2605.30803)
...
### [151] [Planner-Centric Reinforcement Learning for Deep Research with Structure-Aware Reward](https://arxiv.org/abs/2605.30824)
...
### [152] [SLAT: Segment-Level Adaptive Trimming for Efficient CoT Reasoning](https://arxiv.org/abs/2605.30832)
...
### [153] [COMPASS: Cognitive MCTS-Guided Process Alignment for Safe Search Agents](https://arxiv.org/abs/2605.30838)
...
### [154] [Distilling LLM Feedback for Lean Theorem Proving](https://arxiv.org/abs/2605.30861)
...
### [155] [UniScale: Adaptive Unified Inference Scaling via Online Joint Optimization of Model Routing and Test-Time Scaling](https://arxiv.org/abs/2605.30898)
...
### [156] [BilliardPhys-Bench: Benchmarking Physical Reasoning and Visual Dynamics of Multimodal LLMs](https://arxiv.org/abs/2605.30900)
...
### [157] [A Persona-Based Evaluation Framework for Pluralistic Alignment in Generative AI](https://arxiv.org/abs/2605.31021)
*Atahan Karagoz*
...
### [158] [HADT: A Heterogeneous Multi-Agent Differential Transformer for Autonomous Earth Observation Satellite Cluster](https://arxiv.org/abs/2605.31023)
...
### [159] [GraphARC: A Comprehensive Benchmark for Graph-Based Abstract Reasoning](https://arxiv.org/abs/2605.31031)
...
### [160] [LLM-FACETS: A Privacy-Preserving Framework for Evaluating LLM Transparency and Accountability](https://arxiv.org/abs/2605.31167)
...
### [161] [Formalizing and falsifying causal pathways of rare events](https://arxiv.org/abs/2605.31254)
...
### [162] [COLLEAGUE.SKILL: Automated AI Skill Generation via Expert Knowledge Distillation](https://arxiv.org/abs/2605.31264)
...
### [163] [Industrializing Prediction-Powered Inference: The GLIDE Library for Reliable GenAI and Agentic Systems Evaluation](https://arxiv.org/abs/2605.31278)
...
### [164] [TraceGraph: Shared Decision Landscapes for Diagnosing and Improving Agent Trajectories](https://arxiv.org/abs/2605.31308)
...
### [165] [Diagnosing Failure Modes of Shared-State Collaboration in Resource-Constrained Visual Agents](https://arxiv.org/abs/2605.31354)
*Yunpeng Zhou*
...
### [166] [Learning to Adapt: Self-Improving Web Agent via Cognitive-Aware Exploration](https://arxiv.org/abs/2605.31365)
...
### [167] [HypoAgent: An Agentic Framework for Interactive Abductive Hypothesis Generation over Knowledge Graphs](https://arxiv.org/abs/2605.31370)
...
### [168] [FAM-Bench: A Multimodal Benchmark for Condition-Aware Food-as-Medicine Reasoning](https://arxiv.org/abs/2605.31410)
...
### [169] [Answer-Set-Programming-based Abstractions for Reinforcement Learning](https://arxiv.org/abs/2605.31444)
...
### [170] [AutoSci: A Memory-Centric Agentic System for the Full Scientific Research Lifecycle](https://arxiv.org/abs/2605.31468)
...
### [171] [LinTree: Improving LLM Reasoning with Explicitly Structured Search Histories](https://arxiv.org/abs/2605.31492)
...
### [172] [Choosing the Lens: Strategic Perspective Activation in Context-Dependent Argumentation](https://arxiv.org/abs/2605.31581)
...
### [173] [CodeGolf Bench: A Multi-Language Benchmark for Evaluating Concise Code Generation Capabilities of Large Language Models](https://arxiv.org/abs/2605.30394)
*Vedant Padwal*
...
### [174] [Improving Small Language Models for Code Generation with Reinforcement Learning from Verification Feedback](https://arxiv.org/abs/2605.30478)
...
### [175] [Neurodiversity in Agile Teams: Obstacles and Inclusion Barriers](https://arxiv.org/abs/2605.30555)
...
### [176] [What Breaks When LLMs Code? Characterizing Operational Safety Failures of Agentic Code Assistants](https://arxiv.org/abs/2605.30777)
...
### [177] [BlueFin: Benchmarking LLM Agents on Financial Spreadsheets](https://arxiv.org/abs/2605.30907)
...
### [178] [Governance-Aware Software Architecture for Multi-Stakeholder Platforms](https://arxiv.org/abs/2605.31316)
...
### [179] [Ladder Logic Translation using Large Language Models in Industrial Automation](https://arxiv.org/abs/2605.31458)
...
### [180] [Knowledge Boundary Probing and Demand-Guided Intervention for LLM-Based Power System Code Generation](https://arxiv.org/abs/2605.31478)
...
### [181] [Separating Secrets from Placeholders: A Hybrid CNN-CodeBERT Framework for Three-Class Credential Leakage Detection](https://arxiv.org/abs/2605.31520)
...
### [182] [FOSTER: First-order Dataset Distillation for Text-based Sequential Recommendation](https://arxiv.org/abs/2605.30772)
...
### [183] [On the impact of retrieved content representations in RAG Pipelines](https://arxiv.org/abs/2605.30790)
...
### [184] [Inference-Free Multimodal Learned Sparse Retrieval for Production-Scale Visual Document Search](https://arxiv.org/abs/2605.30917)
...
### [185] [Reading Between the Citations: A Typed Claim Network for Scientific Literature](https://arxiv.org/abs/2605.30966)
...
### [186] [Graph-GRPO: Dependency-Aware Credit Assignment for Generative E-commerce Search Relevance](https://arxiv.org/abs/2605.31003)
...
### [187] [Fighting Numerical Hallucinations via Data-centric Compilation for Online Financial QA](https://arxiv.org/abs/2605.31064)
...
### [188] [MIMO: Multilingual Information Retrieval via Monolingual Objectives](https://arxiv.org/abs/2605.31171)
...
### [189] [Contextual Scalarisation Thompson Sampling for multi-objective decisions in public media](https://arxiv.org/abs/2605.31291)
...
### [190] [DynaTree: Dynamic Agentic Retrieval Tree for Time-Sensitive News Retrieval](https://arxiv.org/abs/2605.31377)
...
### [191] [Beyond Instance-Level Alignment and Uniformity: Semantic Factor Learning for Collaborative Filtering](https://arxiv.org/abs/2605.31414)
...
### [192] [Evaluating Factual Density in Multi-Source RAG: A Study in Medical AI Accuracy](https://arxiv.org/abs/2605.31506)
*Michael R. DeMarco*
...
### [193] [SPECTRA: Synthetic IR Test Collections with Relevance Oracles and Controlled Distractor Diagnostics](https://arxiv.org/abs/2605.31575)
*Eric Liang*
...
### [194] [Effects of Vertex Merging & Splitting on Large Coauthorship Networks: A Counterfactual Analysis](https://arxiv.org/abs/2605.31555)
*Jinseok Kim*
