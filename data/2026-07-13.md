...
### [43] [CtrlVTON: Controllable Virtual Try-On via Visual-Instance-Prompt Segmentation](https://arxiv.org/abs/2607.09362)
...
### [59] [4DR360: State Reasoning for Joint 3D Detection and Occupancy Prediction in 4D Radar-Camera Full-Scene Perception](https://arxiv.org/abs/2607.09629)
...
### [71] [Observer Design for a Class of Systems Described by Differential-Algebraic Equations and Parameter Identification of an Unmeasured Disturbance](https://arxiv.org/abs/2607.08864)
...
### [72] [Learning-enabled Parameter Synthesis for Nonlinear Systems from Signal Temporal Logic](https://arxiv.org/abs/2607.08899)
...
### [73] [Adaptive MPPI with Online Disturbance Covariance Estimation: Provable Stability Tightening via Spatial Smoothing](https://arxiv.org/abs/2607.08942)
...
### [74] [Can the Cloud Drive? Infrastructure Feasibility of Offloading Autonomous Driving Across 5G and 6G](https://arxiv.org/abs/2607.09045)
...
### [75] [Structural Decoupling and Current-Angle Steering for Post-Fault Recovery of Current-Limited Grid-Forming Inverters](https://arxiv.org/abs/2607.09058)
...
### [76] [Latency-Aware Digital Twin-Assisted Cooperative Perception for Autonomous Vehicles](https://arxiv.org/abs/2607.09070)
...
### [77] [On robustness, input-to-state stability and backstepping for stochastic differential equations](https://arxiv.org/abs/2607.09127)
...
### [78] [Data-driven predictive control of nonlinear systems using weighted regularization](https://arxiv.org/abs/2607.09187)
...
### [79] [Cyclic Reformulation-Based Identification and Polytopic Uncertainty Modeling for Multirate Systems](https://arxiv.org/abs/2607.09194)
...
### [80] [Jacobian Voltage Stiffness Metric -- A Measure of Grid-Forming Capability and System Strength in IBR-Dominated Grids](https://arxiv.org/abs/2607.09249)
...
### [81] [Dissipativity-Based Multiport Stability Root-Cause Identification and Mitigation for Solid-State Transformers](https://arxiv.org/abs/2607.09271)
...
### [82] [A Multi-Frequency Input-Admittance Model of Locomotive Rectifier Considering PWM Sideband Harmonic Coupling in Electrical Railways](https://arxiv.org/abs/2607.09275)
...
### [83] [An Improved Deep Reinforcement Learning Control Strategy for Traction Dual Rectifiers in EMUs](https://arxiv.org/abs/2607.09276)
...
### [84] [Inertia-Aware Optimal Power Flow Using PINN in IBR-Dominated Power Systems](https://arxiv.org/abs/2607.09297)
...
### [85] [Sharing Coefficient-Based Price Signals for Demand Response in Renewable Energy Communities](https://arxiv.org/abs/2607.09357)
...
### [86] [Event-triggered parameter estimator for sensor fusion](https://arxiv.org/abs/2607.09496)
...
### [87] [Interval Certifications for Multilayered Perceptrons via Lattice Traversal](https://arxiv.org/abs/2607.08773)
...
### [88] [CogniConsole: Externalizing Inference-Time Control as a Formal Abstraction for Reliable LLM Interactions](https://arxiv.org/abs/2607.08774)
...
### [89] [GATS: Graph-Augmented Tree Search with Layered World Models for Efficient Agent Planning](https://arxiv.org/abs/2607.08894)
...
### [90] [Long-Horizon-Terminal-Bench: Testing the Limits of Agents on Long-Horizon Terminal Tasks with Dense Reward-Based Grading](https://arxiv.org/abs/2607.08964)
...
### [91] [A Formalization of the Mean-Field Derivation of the Vlasov Equation: AI-Assisted Lean Formalization as a Strategy Game](https://arxiv.org/abs/2607.08986)
*Joseph K. Miller*
...
### [92] [ARCANA: A Reflective Multi-Agent Program Synthesis Framework for ARC-AGI-2 Reasoning](https://arxiv.org/abs/2607.09059)
...
### [93] [Neuro-Agentic Control: A Deep Learning-based LLM-Powered Agentic AI Framework for Controlling Security Controls](https://arxiv.org/abs/2607.09076)
...
### [94] [L-MAD: A Systematic Evaluation of Multi-Agent Debate Structures in Legal Reasoning](https://arxiv.org/abs/2607.09099)
...
### [95] [MedRealMM: A Real-World Multimodal Benchmark for Chinese Online Medical Consultation](https://arxiv.org/abs/2607.09142)
...
### [96] [KV-PRM: Efficient Process Reward Modeling via KV-Cache Transfer for Multi-Agent Test-Time Scaling](https://arxiv.org/abs/2607.09153)
...
### [97] [Scoped Verification for Reliable Long-Horizon Agentic Context Evolution under Distribution Shift](https://arxiv.org/abs/2607.09175)
*Dan C. Hsu,Luke Lu*
...
### [98] [Toward Auditable AI Scientists: A Hypothesis Evolution Protocol for LLM Agents](https://arxiv.org/abs/2607.09195)
...
### [99] [OpenProver: Agentic and Interactive Theorem Proving with Lean 4](https://arxiv.org/abs/2607.09217)
...
### [100] [LongMedBench: Benchmarking Medical Agents for Long-Horizon Clinical Decision-Making](https://arxiv.org/abs/2607.09322)
...
### [101] [Communication-Efficient Digital-Twin Coordination for Heterogeneous LLM Embodied Agents over Computing Power Networks](https://arxiv.org/abs/2607.09330)
...
### [102] [Fictional Worldbuilding: Multi-Agent LLM Collaboration with Hierarchical Context Compression and Iterative Review](https://arxiv.org/abs/2607.09403)
...
### [103] [How Does Bayesian Causal Discovery Fail? Characterising Structural Consequences in Linear Gaussian Networks under Latent Confounding](https://arxiv.org/abs/2607.09449)
...
### [104] [ProofCouncil: An LLM Agent for Solving Open Mathematical Problems](https://arxiv.org/abs/2607.09474)
...
### [105] [Ceci n'est pas une pipe: AI systems as semantic abstractions](https://arxiv.org/abs/2607.09489)
...
### [106] [Multimodal Reward Hacking in Reinforcement Learning](https://arxiv.org/abs/2607.09492)
...
### [107] [Shared Selective Persistent Memory for Agentic LLM Systems](https://arxiv.org/abs/2607.09493)
...
### [108] [SAGEAgent: A Self-Evolving Agent for Cost-Aware Modality Acquisition in Multimodal Survival Prediction](https://arxiv.org/abs/2607.09521)
...
### [109] [Beyond Fixed Representations: The Vocabulary and Verifier Gaps in Open-Ended AI](https://arxiv.org/abs/2607.09560)
...
### [110] [Knowledge Graphs and Explainable AI as Complementary Resources for Urban Mining](https://arxiv.org/abs/2607.09578)
...
### [111] [TrustX Agent Risk Classification Framework (ARC): Risk-Tiering Internally Created Agentic AI Systems](https://arxiv.org/abs/2607.09586)
...
### [112] [Agora: Enhancing LLM Agent Reasoning Via Auction-Based Task Allocation](https://arxiv.org/abs/2607.09600)
...
### [113] [ConceptSMILE: Auditing the Trustworthiness of Concept-Based Explainable AI](https://arxiv.org/abs/2607.09649)
...
### [114] [Stochastic Similarity Renormalization Group](https://arxiv.org/abs/2607.08830)
...
### [115] [The impact of nuclear uncertainties on the p-process nucleosynthesis in Supernovae](https://arxiv.org/abs/2607.09208)
...
### [118] [Monte Carlo rate uncertainty of the $^{8}$Li(n,$γ$)$^{9}$Li reaction within $R$-matrix framework](https://arxiv.org/abs/2607.09158)
...
### [119] [Medium-mass nuclei with neural quantum states](https://arxiv.org/abs/2607.09223)
...
### [121] [Bayesian inference of the dense matter equation of state built upon extended Skyrme interactions: A generalization](https://arxiv.org/abs/2607.09369)
...
### [148] [Beyond Sphericity in a Semi-Magic Nucleus: Multiple-Shape Coexistence in $^{116}$Sn](https://arxiv.org/abs/2607.09551)
*Marco Siciliano,Marco Rocchini,Tomás R. Rodríguez,Alain Goasduff,Andres Illana,Mansi Saxena,Giacomo de Angelis,Samuel Bakes,Tuncay Bayram,Dino Bazzacco,Kevin Belvedere,Giovanna Benzoni,Daniele Brugnara,Petra Colović,Martha L. Cortes,Daniel T. Doherty,Rafael Escudeiro,Andres Gadea,Franco Galtarossa,Paul E. Garrett,Nicla Gelli,Eleonora T. Gregor,Andrea Gottardo,Andrea Gozzelino,Jeongsu Ha,Katarzyna Hadyńska-Klȩk,Philipp R. John,Calum E. Jones,Maria L. Jurado-Goméz,Marta Kicińska-Habior,Michalina Komorowska,Naomi Marchini,Magdalena Matejska-Minda,Roberto Menegazzo,Daniele Mengoni,Adriana Nannini,Pawel J. Napiorkowski,Daniel R. Napoli,Joonas Ojala,Giorgia Pasqualato,Costel M. Petrache,Francesco Recchia,Dmitry Testov,Javeier J. Valiente-Dobón,Irene Zanon,Magdalena Zielińska*
...
### [149] [Beyond Topicality: A Conceptual Analysis of Societal Relevance and Its Application to Search Results and AI Responses](https://arxiv.org/abs/2607.09264)
*Dirk Lewandowski*
...
### [150] [From Raw IDs to Semantic Planning: How Recommender Systems Utilize Information at Scale](https://arxiv.org/abs/2607.09540)
...
### [151] [SiFAR: Synchronization-Free All-Reduce for Low-Latency LLM Inference](https://arxiv.org/abs/2607.08973)
...
### [152] [Distributed Symmetry Breaking on Hyperbolic Random Graphs](https://arxiv.org/abs/2607.09170)
...
### [153] [Bidirectional Resource Scheduling for Disaggregated and Asynchronous RL Post-Training](https://arxiv.org/abs/2607.09207)
...
### [154] [EcoKube: Simulating Carbon-Aware Scheduling Policies in Heterogeneous Edge-Cloud Environments](https://arxiv.org/abs/2607.09318)
...
### [155] [STEEL: Sparsity-Aware Fused Attention for Energy-Efficient Long-Sequence Inference on AMD's XDNA NPU](https://arxiv.org/abs/2607.09385)
...
### [156] [Short Graph Sketches Suffice for Error-resilient Leader Verification in CONGEST](https://arxiv.org/abs/2607.09522)
...
### [157] [New Complexity Classes in Locally Checkable Labeling for Local Computation Algorithms](https://arxiv.org/abs/2607.09626)
*Sijin Peng*
...
### [158] [Feeling UISTful: An Interactive Portrait of Scholarly Authorship, Readership, and the In-Between](https://arxiv.org/abs/2607.09155)
*Sophia Liu,Shm Garanganao Almeda,Max Kreminski,Bjoern Hartmann*
...
### [159] [Two Vocabularies, One Phenomenon: Metadata Bias in AI Evidence Synthesis on Fertility Decline](https://arxiv.org/abs/2607.09409)
