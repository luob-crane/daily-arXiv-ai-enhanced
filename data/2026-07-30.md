...
### [63] [Hearsay: Vision-Language Medical Diagnoses Without an Image](https://arxiv.org/abs/2607.26886)
*Siddharth Vohra*
...
### [86] [Optimal sizing of a hydrogen-based direct reduced iron-electric arc furnace system integrated with methanol synthesis toward zero-carbon steel production](https://arxiv.org/abs/2607.26270)
...
### [87] [Data-Driven Stability and Performance Analysis of Lurye Systems](https://arxiv.org/abs/2607.26277)
...
### [88] [Planning Waste-to-Energy-Coupled AI Data Centers Through Grade-Matched Cooling and Corridor Screening](https://arxiv.org/abs/2607.26324)
...
### [89] [Time-delay Control Using a New Nonlinear Adaptive Law for Cable-Driven Robots](https://arxiv.org/abs/2607.26383)
...
### [90] [Fully distributed singularity-free prescribed-time stabilization of the continuous-time generalized adaptive Bellman-Ford algorithm](https://arxiv.org/abs/2607.26424)
...
### [91] [Global Exponential Stabilization of the Kinematic Bicycle Model of a Car in Polar Coordinates](https://arxiv.org/abs/2607.26442)
...
### [92] [Online Monitoring and Risk Assessment of Non-Cooperative UAVs via STL-Aware Adaptive Fusion Kalman Filtering](https://arxiv.org/abs/2607.26527)
...
### [93] [Emission-Forecasting-Based Spatial-Temporal Carbon Response: A Multi-Agent Attention-Enhanced Deep Learning Framework](https://arxiv.org/abs/2607.26560)
...
### [94] [A Physics-Informed Framework for PID Tuning of Chemical Processes Using Large Language Model Agents](https://arxiv.org/abs/2607.26594)
...
### [95] [An extended Perron-Frobenius operator filter for nonlinear state estimation](https://arxiv.org/abs/2607.26632)
...
### [96] [UAV Swarming for Air-Ground ISAC via Cross-Region Cooperation](https://arxiv.org/abs/2607.26679)
...
### [97] [Global Sensitive-Based Input Shaping for UAV-Payload Precision Motion Control](https://arxiv.org/abs/2607.26717)
...
### [98] [Joint State-Parameter Inference Enhances Estimation Performance in Model-Based Digital Therapeutics for Type 1 Diabetes](https://arxiv.org/abs/2607.26790)
...
### [99] [Network Verified NTN Positioning for 6G A Standards Oriented Survey of Hybrid TN NTN Localization](https://arxiv.org/abs/2607.26846)
...
### [100] [From Crop and Energy Data to Optimized Lighting Scheduling: A Surrogate-Based MILP Framework for Vertical Farming](https://arxiv.org/abs/2607.26968)
...
### [101] [Dynamic Storage Operation Under Uncertainty and the Reliability Externality: Implications for Capacity Investments](https://arxiv.org/abs/2607.27021)
...
### [102] [Some intuition for why cooperative systems "look 1-dimensional" and 2-cooperative systems "look 2-dimensional"](https://arxiv.org/abs/2607.27176)
*Eduardo D. Sontag*
...
### [103] [Cross-Model Cross-Language AI Coding Agent Performance: Accuracy and Speed of Parallel CLRS Algorithms](https://arxiv.org/abs/2607.26083)
...
### [104] [Large Language Models for Software Engineering Diagrams: A Systematic Review of UML and ER modelling](https://arxiv.org/abs/2607.26100)
...
### [105] [Validating ETCS Data with the B Mathematical Language: An Industrial Pipeline and a Blueprint for LLM Integration](https://arxiv.org/abs/2607.26111)
...
### [106] [NISPO: Open-source IUPAC name generation tool](https://arxiv.org/abs/2607.26113)
...
### [107] [Try Again, Don't Look Back: Blind Resampling Outperforms Self-Repair in Small Code Models](https://arxiv.org/abs/2607.26117)
*Yuvraj Verma*
...
### [108] [Multi-Agent Debate Strategies: Survey, Taxonomy, and Challenges](https://arxiv.org/abs/2607.26212)
...
### [109] [Model-Driven Requirements Configuration with Three-Valued Uncertainty Scoring](https://arxiv.org/abs/2607.26220)
*Ahmed Ibrahim*
...
### [110] [Do Code Language Models Use Tests? A Behavioral and Representational Study of Test-Driven Code Generation](https://arxiv.org/abs/2607.26244)
...
### [111] [SARC-DQ: Runtime Data-Quality Gating for Agentic AI: Silent Evidence Defects, the Incompetence Shield, and Downstream-Only Remediation](https://arxiv.org/abs/2607.26313)
*Gaston Besanson*
...
### [112] [Impossible to hide secret ...: Uncovering Security and Privacy Issues in LLM-native IDEs](https://arxiv.org/abs/2607.26390)
...
### [113] [ExplainBench: Evaluating Code Explanations from Agents](https://arxiv.org/abs/2607.26451)
...
### [114] [MultiFixer: A Coordinator-Proposer Based Multi-Agent Framework For Fixing Multi-Hunk Bugs](https://arxiv.org/abs/2607.26591)
...
### [115] [Tangling Pull Requests: Curating a Commit Untangling Dataset from Merged PRs](https://arxiv.org/abs/2607.26730)
...
### [116] [CodeSpec: Dual Executable Specifications for Agentic Long-Horizon Feature Development](https://arxiv.org/abs/2607.26777)
...
### [117] [MRCoder: An Efficient Context Selecting Approach for Repository-Level Code Generation](https://arxiv.org/abs/2607.26805)
...
### [118] [A First Look at Coding Agents' Compliance with AI Contribution Rules in Open-Source Communities](https://arxiv.org/abs/2607.26819)
...
### [119] [A Scalable AI-Powered System for Explainable Machine Learning Pipelines in Brain Tumor](https://arxiv.org/abs/2607.26834)
...
### [120] [When Knowledge Changes: Metamorphic Testing of RAG Systems with Mutations](https://arxiv.org/abs/2607.26843)
...
### [121] [VITAL-RAG: Invariance Race for Context Allocation in Coding Agents](https://arxiv.org/abs/2607.26937)
...
### [122] [How Developers Experience Debugging Unfamiliar Codebases with Code Tours Generated and Evaluated by Local LLMs](https://arxiv.org/abs/2607.26987)
...
### [123] [MindForge: Teaching Small Language Models Whole-Life-Cycle Software Engineering via Source-Free Program Synthesis](https://arxiv.org/abs/2607.27146)
...
### [124] [SpecFirst: Behavioral Specification Elicitation as a First-Class Step in Agent-Based Program Synthesis from Scratch](https://arxiv.org/abs/2607.27167)
...
### [125] [Route-Block Membership Selects Packed-AWQ Arithmetic: A Controlled Single-Fixture Mechanism Study](https://arxiv.org/abs/2607.26316)
*Lukas Stepanek*
...
### [126] [The Fabric Is the Cluster Driver: Cross-Layer eBPF Policies for GPU-CXL Fabrics](https://arxiv.org/abs/2607.26335)
...
### [127] [StrataCL: Fabric-Native Communication Library for Production Supernodes](https://arxiv.org/abs/2607.26444)
...
### [128] [DualDecoder: Accelerate Long Context LLM Inference by Predictive Prefetch](https://arxiv.org/abs/2607.26475)
...
### [129] [Safety-Gated Autoscaling: A Multi-Layered Defense Architecture for Kubernetes Vertical Resource Optimization](https://arxiv.org/abs/2607.26503)
...
### [130] [ServerlessT2I: Efficient Text-to-Image Workflow Serving on a Serverless Platform](https://arxiv.org/abs/2607.26566)
...
### [131] [Nix to the Rescue for a Reproducible HPC-AI Software Stack](https://arxiv.org/abs/2607.26688)
...
### [132] [Mind the Gap: The Disconnect Between Synthetic and Natural Edge Weights in Parallel Single-Source Shortest Path](https://arxiv.org/abs/2607.26821)
...
### [133] [Hybrid Workflow Composition for Extreme-Scale Data Processing: A Case Study on the HL-LHC (Extended Version)](https://arxiv.org/abs/2607.26877)
...
### [134] [InferScale: GPU-Native KV Injection for Personalized LLM Serving](https://arxiv.org/abs/2607.27090)
...
### [167] [Measurement of the average transverse momentum of forward prompt charged particles in $pp$ and $p\mathrm{Pb}$ collisions at $\sqrt{s_{NN}} = 5.02\; \mathrm{TeV}$](https://arxiv.org/abs/2607.26783)
...
### [168] [Bias at the Borderline: Who Gets the Benefit of the Doubt in Peer Review?](https://arxiv.org/abs/2607.26280)
...
### [170] [SimpleWikiSearch: A Clean Offline Wikipedia Environment for Agentic Search](https://arxiv.org/abs/2607.26070)
...
### [171] [GuidedRAG: Semantic Steering of Retrieval-Augmented Generation](https://arxiv.org/abs/2607.26071)
...
### [172] [IFCMemoryBench: Evaluating Long-Term Memory of LLM-Based Agents in BIM Information Retrieval](https://arxiv.org/abs/2607.26072)
...
### [173] [Guess Where You Go: Generative Next Point-of-Interest Recommendation in Amap](https://arxiv.org/abs/2607.26073)
...
### [174] [Reproducibility in Recommender Systems: A Survey](https://arxiv.org/abs/2607.26074)
...
### [175] [IDP AutoOpt: Agent-Driven Optimization of Document Processing Pipeline Configurations](https://arxiv.org/abs/2607.26075)
...
### [176] [FinCacheServe: Dependency-Consistent Answer Reuse for Cost-Efficient RAG Serving over Mutable Enterprise Documents](https://arxiv.org/abs/2607.26076)
...
### [177] [Embedding Items at Scale: Comparing GNN-Based and ID-Based Item Embeddings in the Yandex Ecosystem](https://arxiv.org/abs/2607.26365)
...
### [178] [Continuous Online Evaluation of Recommendation Strategies in Social Science Academic Search](https://arxiv.org/abs/2607.26380)
...
### [179] [DIRECTOR: Dynamic Index-based Recommendation with Transport-Optimized Retrieval](https://arxiv.org/abs/2607.26418)
...
### [180] [PSG: Pair-Space Generation for Efficient Generative Reranking](https://arxiv.org/abs/2607.26427)
...
### [181] [NMKFR: A Robust Framework for Time-Aware Cold-Start Recommendation](https://arxiv.org/abs/2607.26429)
...
### [182] [Multi-Decoder OneRec: Controllable Generative Retrieval for Multi-Objective Industrial Recommendation](https://arxiv.org/abs/2607.26500)
...
### [183] [ASARL: Autonomous Social-Aware Relevance Learning for QQ Search](https://arxiv.org/abs/2607.26593)
...
### [184] [WhisperRec: Latent Reasoning for Efficient Foundation Recommendation Models](https://arxiv.org/abs/2607.26621)
...
### [185] [CaIRec: Calibrated Modality Imputation for Incomplete Multimodal Recommendation](https://arxiv.org/abs/2607.26720)
...
### [186] [MediaWiki Code2Code Search: Neural Retrieval for the Semantic Discovery of Open-Source Software Entities](https://arxiv.org/abs/2607.26766)
*Francesco Tosoni*
...
### [187] [Beyond Action Imitation: Learning a Decision-Aware User Simulator for Online Advertising](https://arxiv.org/abs/2607.26893)
...
### [188] [IMFuse: Instance-Aware Multi-Layer Fusion for LLM-Enhanced Sequential Recommendation](https://arxiv.org/abs/2607.27002)
...
### [189] [Learning from the Future: Privileged Self-Distillation for Sequential Recommendation](https://arxiv.org/abs/2607.27055)
...
### [190] [KAMR: Grounding Generation via Knowledge-Aligned Multi-hop Retrieval](https://arxiv.org/abs/2607.27136)
...
### [191] [Improving Item Discoverability in e-Commerce Search via Related Intent Generation](https://arxiv.org/abs/2607.27172)
...
### [192] [Impacts of hexadecapole correlations in actinide nuclei](https://arxiv.org/abs/2607.26499)
...
Abstract: The impact of hexadecapole correlations on the low-energy spectroscopic properties of Th, U, and Pu nuclei, within the mass range $232 \le A \le 240$, is studied systematically using the mapped $sdg$-IBM model. Fermionic input is obtained via the quadrupole-hexadecapole constrained Hartree-Fock-Bogoliubov approximation, based on the parametrization D1S of the Gogny energy density functional. The $sdg$-IBM Hamiltonian parameters are determined by mapping the quadrupole-hexadecapole fermionic mean-field potential energy surfaces onto the corresponding bosonic surfaces. The low-energy spectra and transition strengths, obtained via the diagonalization of the $sdg$-IBM Hamiltonian, compare well with the available experimental data. It is shown that the effects of hexadecapole collectivity can be observed in high-spin yrast states with spins $J^π \geqslant 10^{+}$. The mapped $sdg$-IBM improves the excitation energies of those states, as compared with the simpler $sd$-IBM model. The $sdg$-IBM also improves the description of the $E2$ transition strengths between high-spin yrast states and predicts strong $E4$ transitions from nonyrast $4^+$ states to the $0^+$ ground state.

</details>


### [193] [Intruder-driven mirror energy differences between $^{29}$Cl and $^{29}$Mg studied with antisymmetrized molecular dynamics](https://arxiv.org/abs/2607.26546)
...
### [195] [Structure of multi-$Λ$ hypernuclei with a Skyrme-type $ΛΛ$ interaction constrained by data on double-$Λ$ hypernuclei and neutron stars](https://arxiv.org/abs/2607.26800)
