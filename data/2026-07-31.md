...
### [8] [Learning Color Grading, No Photo Sharing: Federated Aesthetic Preference Learning for Personalized Image Enhancement](https://arxiv.org/abs/2607.27659)
...
### [20] [MedXplore: Towards Reliable and Unbiased Generalized Category Discovery in Medical Imaging](https://arxiv.org/abs/2607.27620)
...
### [21] [BlindPSNR: A No-Reference Fidelity Predictor for Low-Light Image Enhancement](https://arxiv.org/abs/2607.27628)
...
### [23] [4DHumanDiff: Direct Text-to-4DGS Generation for Consistent 360-Degree Dynamic Humans](https://arxiv.org/abs/2607.27634)
...
### [24] [MMOOC: A Comprehensive Benchmark for Out-of-Context Evaluation in Multimodal Large Language Models](https://arxiv.org/abs/2607.27637)
...
### [108] [CLVisc Agent for autonomous relativistic hydrodynamics studies](https://arxiv.org/abs/2607.27822)
...
Abstract: The odd-mass $^\text{91-101}$Y isotopes provide a testing ground for how an unpaired proton modifies an abrupt collective structural evolution. A configuration-mixing Bose-Fermi description shows that the lowest negative- and positive-parity states undergo a crossing of normal and intruder configurations near neutron number $N = 60$, intertwined with an evolution from weak coupling of a quasiparticle to a near-spherical core toward strong coupling to a deformed core. To isolate the role of the odd proton, a differential charge-radius polarization observable is introduced as the difference between the isotope shifts of the odd-mass chain with those of the corresponding even-even cores. Its pronounced peak at $N = 58$ and sign reversal at $N = 60$ reveal a localized modification of the core evolution in the critical region. Energy levels, wave-function content, electromagnetic moments, two-neutron separation energies, and coherent-state energy surfaces support this interpretation.

</details>


### [110] [Coulomb and nuclear polarization of the nucleon density in the dinuclear configuration of the $^{40}$Ca + $^{208}$Pb system](https://arxiv.org/abs/2607.27926)
*Bakhodir Kayumov*
...
### [111] [Relativistic transport near moving interfaces](https://arxiv.org/abs/2607.28569)
*Lorenzo Gavassino*
...
### [112] [Bridging openEHR and OMOP: Expanded Mappings and Systematic Analysis of Semantic and Structural Limitations in the OMOP CDM](https://arxiv.org/abs/2607.27208)
...
Abstract: Background: Interoperability between clinical and research data systems is essential for enabling secondary use of EHR data. The openEHR standard provides structured, model-driven clinical information, while the OMOP Common Data Model (CDM) supports large-scale observational analytics. The Eos engine and OMOP Conversion Language (OMOCL) previously introduced a standards-based transformation approach, but limited value set support, rigid visit generation, and incomplete mapping coverage restricted broader applicability.
  Methods: A new generation of Eos and OMOCL was implemented to improve semantic completeness and address earlier limitations. New functionality enables mapping of internal openEHR value sets via conceptMaps, supports visit occurrence generation using Archetype Query Language (AQL), and expands the international archetype mapping library. The framework was evaluated by assessing mapping coverage, terminology completeness, and domain distribution. Structural constraints of OMOP were examined using representative archetype mappings.
  Results: 196 openEHR archetypes were mapped, covering all stable archetypes in the international Clinical Knowledge Manager with OMOP-equivalent tables. 8.65% of primary concept identifiers could not be linked to OMOP standard terminologies. Most mappings targeted the Measurement (50.5%) and Observation (41.0%) domains. Structural analysis showed that coherent clinical concepts often required fragmentation across multiple loosely connected OMOP tables; the Problem/Diagnosis archetype alone required more than 20 linked records.
  Conclusions: The new framework strengthens openEHR-OMOP interoperability and reduces information loss. However, structural and semantic limitations within OMOP introduce fragmentation that may affect downstream analytics, suggesting a need for greater convergence between both ecosystems.

</details>


### [113] [Reviewer Scores Are Not Comparable Across Research Areas in ML Peer Review](https://arxiv.org/abs/2607.27209)
...
### [114] [SciSchema.org: A Multidisciplinary Collection of Schemas for Structured Scientific Process Descriptions](https://arxiv.org/abs/2607.27955)
...
### [115] [Probing (Hyper)Nuclei Wave Functions and Production Mechanisms in $\sqrt{s_{\rm{NN}}}=200$ GeV Isobar Collisions at RHIC](https://arxiv.org/abs/2607.28113)
...
### [116] [OneShot: Index-in-Ranking with Neural Scoring for Large-Scale Retrieval](https://arxiv.org/abs/2607.27475)
...
### [117] [Hierarchical Reranking for Scalable Financial RAG System](https://arxiv.org/abs/2607.27523)
...
### [118] [Heterogeneous Ranking in Industrial-Scale Recommender Systems: A Case Study](https://arxiv.org/abs/2607.27577)
...
### [119] [An Exploration Graph with Continuous Refinement for Efficient Multimedia Retrieval](https://arxiv.org/abs/2607.27623)
...
### [120] [Dynamic Exploration Graph: A Novel Approach for Efficient Nearest Neighbor Search in Evolving Multimedia Datasets](https://arxiv.org/abs/2607.27640)
...
### [121] [LoopMemGR: From Behavior Logs to Evolving Memory for Generative Recommendation](https://arxiv.org/abs/2607.27647)
...
### [122] [Restoring Collaborative Signals in Semantic-ID Generative Recommendation via Personalized Natural Language](https://arxiv.org/abs/2607.27682)
...
### [123] [Measuring Alignment With Reader Highlights Net of Position and Length](https://arxiv.org/abs/2607.27739)
...
### [124] [A Structured Knowledge Infrastructure for Domain-Specific Data Asset Discovery](https://arxiv.org/abs/2607.27748)
...
### [125] [Hierarchical Latent Reasoning for LLM-based Recommendation](https://arxiv.org/abs/2607.27760)
...
### [126] [From Understanding to Action: Feedback-Grounded Policy Discovery for Generative Recommendation](https://arxiv.org/abs/2607.27789)
...
### [127] [Interpretable Representation via LLM-Driven Generative Disentanglement for Local-Life Service Recommendation](https://arxiv.org/abs/2607.27944)
...
### [128] [VIG-RL: Learning to Search and Insert for Verified Image Grounding](https://arxiv.org/abs/2607.28055)
...
### [129] [CCFormer: Efficient Cross-Field Interaction and Hierarchical Sequence Compression for Industrial Recommendation at Tencent](https://arxiv.org/abs/2607.28070)
...
### [130] [TCA-SIR: Learning Target-Conditioned Abstractions for Scientific Inspiration Retrieval](https://arxiv.org/abs/2607.28498)
...
### [131] [MagicSelector: Joint Optimization for Agent Tool Selection via Counterfactual Decomposition and Progressive Reranking](https://arxiv.org/abs/2607.17751)
...
### [132] [Dynamics-matched Physical Reservoir Computing for Undersensed Traffic Prediction](https://arxiv.org/abs/2607.27371)
...
### [133] [Estimated-State Adaptive Sliding Mode Control and Disturbance Observation Using Second-Order Surfaces for Spacecraft Formation Reconfiguration](https://arxiv.org/abs/2607.27524)
...
### [134] [Inter-Area Oscillation Damping in Data-Center-Integrated Power Systems](https://arxiv.org/abs/2607.27575)
...
### [135] [Structural Averaged Controllability for Linear Ensemble Systems: Multi-input Case](https://arxiv.org/abs/2607.27706)
...
### [136] [Chance-Constrained Nonlinear Covariance Control via Robust Linearization Remainder Bounds](https://arxiv.org/abs/2607.27742)
...
### [137] [Robust PIDNet Control of a Dual-Actuator Thrust Vectoring Platform](https://arxiv.org/abs/2607.27793)
...
### [138] [Safety-Gated Agentic Supervisory Control on a Coupled Distillation Benchmark: Regime Map, Auditable Gate, and Co-Design Findings](https://arxiv.org/abs/2607.27849)
*Christian Rosenthal*
...
### [139] [On the Strong Structural Controllability of Matrix-Weighted Networks](https://arxiv.org/abs/2607.27852)
*Lanhao Zhao*
...
### [140] [Data-Driven Formal Methods for Complex Dynamical Systems: A Survey](https://arxiv.org/abs/2607.27908)
...
### [141] [Anonymous sharing is pairwise phase-blind](https://arxiv.org/abs/2607.28377)
...
### [142] [Projection-Regularized Indirect Data-Driven Predictive Control](https://arxiv.org/abs/2607.28123)
...
### [143] [Data-Driven Dead-Zone Compensation via Projection in Predictive Control Setting](https://arxiv.org/abs/2607.28142)
*Mahmood Mazare,Hossein Ramezani*
...
### [144] [Stochastic Average Consensus Filtering and Distributed State Estimation for Boolean Control Networks](https://arxiv.org/abs/2607.28158)
*Rong Yang,Chi Huang*
...
### [145] [Self-Evolving Learning for Embodied AI with Criticality Model](https://arxiv.org/abs/2607.28251)
...
### [146] [Grid-Forming Converter DC-link Control Considering the Primary Energy Source](https://arxiv.org/abs/2607.28270)
...
### [147] [Adaptive Demand-Driven Energy Management of PCM-Integrated District Heating Systems: Operational Flexibility and Techno-Economic Assessment](https://arxiv.org/abs/2607.28280)
...
### [148] [Input-to-state Stable Approximate Nonlinear Model Predictive Control with Realtime Feasibility](https://arxiv.org/abs/2607.28353)
...
### [149] [Potentials and Limitations on Different Busbar Protections in Industrial Applications](https://arxiv.org/abs/2607.28453)
...
### [150] [On the Implementation of Two-Parameter Stabilizing Controllers Using Stable-Block Input-Output Feedback Structures](https://arxiv.org/abs/2607.28469)
...
### [151] [A subspace approach to data-driven predictive control for linear parameter-varying systems](https://arxiv.org/abs/2607.28490)
...
### [152] [A Sub-6G Mixer First RXFE with LO Overlap Reduction and 1.08 dB NF Degradation](https://arxiv.org/abs/2607.28546)
...
### [153] [Multi-Head Attention Residuals](https://arxiv.org/abs/2607.27230)
...
### [154] [KernelGenBench: A Multi-Source and Multi-Chip Benchmark for LLM-based Kernel Generation](https://arxiv.org/abs/2607.27231)
...
### [155] [RadHarmony: Radiological Data Handling in the Era of Agentic AI](https://arxiv.org/abs/2607.27235)
...
### [156] [Asymmetric Collapse in Model Merging: When Refusal Over- writes Recognition](https://arxiv.org/abs/2607.27240)
...
### [157] [Divergence Decoding: Training-Free Capability Fusion](https://arxiv.org/abs/2607.27248)
...
### [158] [PIE-APT: A Unified Framework for Temporal Planning and Contradiction Hunting via Incremental Direct-Derivation Abduction](https://arxiv.org/abs/2607.27287)
...
### [159] [PAUSE: A User-Centric Benchmark for Personal AI Assistants in Unified Service Environments](https://arxiv.org/abs/2607.27354)
...
### [160] [SkillMentor: LLM Agent Self-Evolution via Learning Blind-Spot Diagnosis](https://arxiv.org/abs/2607.27360)
...
### [161] [Beyond the Bidirectional Promise: Re-evaluating the Robustness of Diffusion Language Models](https://arxiv.org/abs/2607.27386)
...
### [162] [Bridging Inference-Time Scaling and Episodic Memory with Action-Centric Graphs](https://arxiv.org/abs/2607.27415)
...
### [163] [Dimensionality and Measurement Precision in HLE's Multiple-Choice Subset](https://arxiv.org/abs/2607.27420)
...
### [164] [Leveraging Trajectory Graphs for Pre-Execution Error Diagnosis in Agentic LLM Systems](https://arxiv.org/abs/2607.27443)
...
### [165] [VAmoS Bench: Voice Agent Simulation Bench](https://arxiv.org/abs/2607.27453)
...
### [166] [Skill Use or Skill Theater? Evaluating the Reasoning Backroom in Skill-Augmented Language Agents](https://arxiv.org/abs/2607.27484)
...
### [167] [INCLAIR: Inception-Based Longitudinal Clinical Anomaly Detection with Informed Reasoning](https://arxiv.org/abs/2607.27487)
...
### [168] [MedLLM: An Open Medical Language Model at the Sub-Billion Scale](https://arxiv.org/abs/2607.27490)
...
### [169] [GLM-RAG: Graph Language Models for Graph-Based Retrieval-Augmented Generation](https://arxiv.org/abs/2607.28397)
...
### [170] [A dataset of rated conceptual arguments](https://arxiv.org/abs/2607.27499)
...
### [171] [Automated Transcript Analysis for Detecting Flaws in Agentic Benchmarks](https://arxiv.org/abs/2607.27518)
...
### [172] [AI Literacy: An Exercise in Power-Knowledge](https://arxiv.org/abs/2607.27547)
...
### [173] [Using Large Language Models for Idea Generation in Innovation](https://arxiv.org/abs/2607.27553)
...
### [174] [Evaluating Agentic Bioinformatics through Function, Evidence, and Validation](https://arxiv.org/abs/2607.27556)
...
### [175] [DeepResearch Agent System](https://arxiv.org/abs/2607.27562)
...
### [176] [What makes prompts a graph: necessary and sufficient conditions for prompt graph engineering](https://arxiv.org/abs/2607.27578)
*Sandeco Macedo*
...
### [177] [From Minds to Models: The Intersection of Psychology and LLM Behaviours](https://arxiv.org/abs/2607.27579)
...
### [178] [Wiring diagram extraction and gluing: a case study in classifying figure skating jumps using 3D dataset](https://arxiv.org/abs/2607.27598)
...
### [179] [World Action Planner: Generalizable Decision-Making with Action-Conditioned World Models](https://arxiv.org/abs/2607.27599)
...
### [180] [HALO: Heterogeneous Admission through Localized Obligations for Safe Agentic Execution](https://arxiv.org/abs/2607.27636)
...
### [181] [CORE: In-Context Reconstruction for Unified Tabular Anomaly Detection](https://arxiv.org/abs/2607.27615)
...
### [182] [Old Tricks, New Models: How Simple Image Transformations Break Modern AI-based Content Moderation](https://arxiv.org/abs/2607.28187)
...
### [183] [Hidden APIs in Language Models: Discovering Reusable Causal Interfaces from Forked Futures](https://arxiv.org/abs/2607.27617)
...
### [184] [SCOPE: Synthetic Conditional Objectives for Policy Evolution in Black-Box Combinatorial Optimization](https://arxiv.org/abs/2607.27630)
...
### [185] [ReDiPPO: Reference-Guided Value Calibration and Discrepancy-Aware Token Reweighting for Mathematical Reasoning](https://arxiv.org/abs/2607.27631)
...
### [186] [HealthCAT: An Interpretable Encoder-only Transformer Framework for Health Indicator Prediction and Temporal Interpretation of Wearable Sensor Data](https://arxiv.org/abs/2607.27635)
...
### [187] [Evaluating and Pricing Advertisements in AI-Generated Responses](https://arxiv.org/abs/2607.27686)
...
### [188] [Rehearse: Stepping Back from the Confidence Cliff in Self-Improving Autoresearch](https://arxiv.org/abs/2607.27687)
...
### [189] [Guiding Large Language Models with Genetic Programming-Evolved Heuristic Knowledge for Dynamic Multi-Mode Project Scheduling](https://arxiv.org/abs/2607.27698)
...
### [190] [SpatialCLI: Learning to Reason With Spatial Tools, Then Without Them](https://arxiv.org/abs/2607.27703)
...
### [191] [Albilich: Steerable Proof-State Orchestration for LLM-Based Mathematical Research with CAS Integration](https://arxiv.org/abs/2607.27705)
...
### [192] [MECA: A Mechanism-Centered Agent for Constructing Well-Specified and Valuable Mathematical Conjectures](https://arxiv.org/abs/2607.27709)
...
### [193] [New Synchronous Computation Dynamics for Hopfield Networks](https://arxiv.org/abs/2607.27720)
...
### [194] [Baikal: Structured Search for Deep Research over Data Lakes](https://arxiv.org/abs/2607.27726)
...
### [195] [VeriSkill: A Self-Evolution Framework for Program Verification Skills](https://arxiv.org/abs/2607.27733)
...
### [197] [Annotating Topical Legal Insights from Case Proceedings](https://arxiv.org/abs/2607.27792)
...
### [198] [MemeBench: What LVLMs Miss When Interpreting Culture-Dependent Memes](https://arxiv.org/abs/2607.27798)
...
### [199] [STEREODISCO: Discovering Stereotypicality in LLMs](https://arxiv.org/abs/2607.27824)
...
### [200] [Sign Language Question Answering: A New Task, Benchmark, and Baseline for Sign Language Understanding](https://arxiv.org/abs/2607.27826)
...
### [201] [MemTxn: A Transaction Boundary for Source-Supported Updates and Complete-State Recovery in Agent Memory](https://arxiv.org/abs/2607.27834)
...
### [202] [Crossing the Margin Cliff: Toward Relearn-Robust LLM Unlearning via Margin Calibration](https://arxiv.org/abs/2607.27836)
...
### [203] [Virtual Process Dossier: A Process-Aware Data Catalogue](https://arxiv.org/abs/2607.27840)
...
### [204] [Simplifying Neural Networks During Training](https://arxiv.org/abs/2607.27854)
...
### [205] [Back to All-Entity Ranking: Sampler-Dependent Evaluation in Continuous-Time Dynamic Graphs](https://arxiv.org/abs/2607.27861)
...
### [206] [Orca: Neural Operators for Causal Reasoning in Continuous Time](https://arxiv.org/abs/2607.27867)
...
### [207] [Search as Computation Allocation](https://arxiv.org/abs/2607.27871)
*Alexander Tuisov*
...
### [208] [An Empirical Study of Coordination Mode as the First-Class Citizen in From-Scratch Multi-Agent Coding](https://arxiv.org/abs/2607.27877)
...
### [209] [Not All Tokens Deserve Equal Credit: Counterfactual Sensitivity Credit Reallocation for Long-CoT Reasoning](https://arxiv.org/abs/2607.27888)
...
### [210] [Dynamic Spectral Filtering for Temporal Graph Learning: Learning Evolving Propagation Operators](https://arxiv.org/abs/2607.27891)
*Yan Kong*
...
### [211] [MMHBench: A Multi-Perspective Benchmark for Mental Health Understanding in Long-Form Videos](https://arxiv.org/abs/2607.27895)
...
### [212] [A Cross-Architecture Audit of Direction-Based Inference-Time Defences in Vision-Language Models](https://arxiv.org/abs/2607.27910)
...
### [213] [IFHierBench: Hierarchical Instruction Following for Large Language Models](https://arxiv.org/abs/2607.27912)
...
### [214] [One Anchor for All: Unified Multilingual and Multimodal Safety Alignment for LVLMs](https://arxiv.org/abs/2607.27917)
...
### [215] [Meta-Task: Turning Terminal Task Synthesis into a Terminal Task for Scalable Agent Training](https://arxiv.org/abs/2607.27929)
...
### [216] [The Geometric Nature and a Free Proxy for Flow-Matching Uncertainty](https://arxiv.org/abs/2607.27933)
...
### [217] [Shapes from Examples: Foundations of Shape Learning in Recursive SHACL](https://arxiv.org/abs/2607.27934)
...
### [218] [From Scoring to Acting: Outcome-Verified Comparative Self-Distillation for LLM Agents](https://arxiv.org/abs/2607.27937)
...
### [219] [MARS-RA: Rank Aggregation for Credit Assignment via Multimodal Comparisons in Embodied Multi-Agent Cooperation](https://arxiv.org/abs/2607.27967)
...
### [220] [Share the Judge, Learn the Deferral: Where Specialization Helps LLM Evaluation](https://arxiv.org/abs/2607.27984)
*Weining Zhang*
...
### [221] [SKIMIX: Multi-Agent Harness-Time Scaling with Skill Mixture for Dynamic Harness Engineering](https://arxiv.org/abs/2607.27994)
*Jia Luo*
...
### [222] [MMLDSum-LLM: Multimodal Long-Document Summarization with Visual-Alignment and Keyword-Aware](https://arxiv.org/abs/2607.28006)
...
### [223] [MUL-T: Decoding Spatial Cellular Architecture in Multiplexed Tissue Images](https://arxiv.org/abs/2607.28030)
...
### [224] [DataClawEval: A Benchmark for Data Engineering Agents in Real Industrial Harness](https://arxiv.org/abs/2607.28033)
...
### [225] [SKILL-KD: Contrastive Skill Distillation for LLM Agents](https://arxiv.org/abs/2607.28048)
...
### [226] [IndustryForge-27B: A Domain-Enhanced Multimodal Foundation Model for Industrial CAD](https://arxiv.org/abs/2607.28050)
...
### [227] [SemPIC: Learning Semantic Position-Independent KV Caches](https://arxiv.org/abs/2607.28069)
...
### [228] [Echoverse: Deep, Evolving Environments for Training Computer-Use Agents at Scale](https://arxiv.org/abs/2607.28074)
...
### [229] [Group-Reflective Self-Distillation for Agentic Reinforcement Learning](https://arxiv.org/abs/2607.28076)
...
### [230] [Distilling Answer Set Programming Theories from Large Language Models](https://arxiv.org/abs/2607.28086)
...
### [231] [Diversifying Personalized Research Ideation against AI-Induced Homogenization](https://arxiv.org/abs/2607.28087)
...
### [232] [PerturbMap: Cross-Context Transfer of Single-Cell Perturbation Responses](https://arxiv.org/abs/2607.28090)
...
### [233] [An Instrument to Evaluate Governance Proposals: AI Policy Analysis at Scale](https://arxiv.org/abs/2607.28094)
...
### [234] [SciDataSailor: Deep Scientific Data Exploring](https://arxiv.org/abs/2607.28098)
...
### [235] [MIND: Lightweight and Effective Memory Injection Defense for LLM Agents via Intent-Aware Information Bottleneck](https://arxiv.org/abs/2607.28103)
...
### [236] [Beyond Rephrasing: Book-Level Organization Improves Synthetic Textbook Data for Mid-Training](https://arxiv.org/abs/2607.28109)
...
### [237] [BlueprintRepair: Typed Local Edits for Failed Lean Proof Blueprints](https://arxiv.org/abs/2607.28110)
*Ruslan Khrulev*
...
### [238] [ConMem: Contribution-Aware Memory for Long-Horizon Manufacturing Inspection Logs](https://arxiv.org/abs/2607.28126)
...
### [239] [AgenticASR: Refining Speech Recognition in Real-World Scenarios via an Agentic Approach](https://arxiv.org/abs/2607.28175)
...
### [240] [Qwen-UI-Agent Technical Report: Toward Next-Generation Real-World Centric Foundation GUI Agents](https://arxiv.org/abs/2607.28227)
...
### [242] [AI and Authenticity in Islamic Research: A Critical Evaluation of Generative AI Reliability, Hallucination, and Source Fidelity in Quranic, Hadith, and Fiqh Knowledge](https://arxiv.org/abs/2607.28237)
...
### [243] [Operationally Guided Placement-Aware Learning for Industrial Online 3D Bin Packing](https://arxiv.org/abs/2607.28257)
...
### [244] [LLM-Guided Evolutionary Search for Constraint Model Reformulation to Improve Solver Efficiency](https://arxiv.org/abs/2607.28268)
...
### [245] [MemHarness: Memory Is Reconstructed, Not Replayed](https://arxiv.org/abs/2607.28272)
...
### [246] [Tycho: Active Abstraction with Programmatic World Models for ARC-AGI-3](https://arxiv.org/abs/2607.28287)
...
### [247] [One Human, $N$ Agents: Audit-Budget Allocation for LLM Agent Fleets under Miscalibrated, Correlated Confidence](https://arxiv.org/abs/2607.28317)
...
### [248] [PathView-Bench: Can Multimodal Large Language Models Achieve Fine-grained Multiscale Understanding of Pathology Images?](https://arxiv.org/abs/2607.28318)
...
### [249] [Paying for Honesty Without Knowing the Truth: Reputation-Penalty Design for LLM Marketplace Agents](https://arxiv.org/abs/2607.28330)
...
### [250] [Correcting What You Cannot See: Credit Assignment for Perception Distillation in Multimodal Reasoners](https://arxiv.org/abs/2607.28336)
...
### [251] [How Benchmarks Mis-Score Computer-Use Agents](https://arxiv.org/abs/2607.28367)
...
### [252] [HyperClaim: Fine-Grained Cross-Modal Hypergraph Reasoning for Video Misinformation Detection](https://arxiv.org/abs/2607.28375)
...
### [253] [When Specifications Conflict: A Symmetry-Based Framework for Measuring LLM Preferences](https://arxiv.org/abs/2607.28384)
...
### [254] [QuantWAMs: Calibrating at the Right Granularity for World Action Models](https://arxiv.org/abs/2607.28405)
...
### [256] [When Derived Measurements Mislead: Quantifying and Mitigating LLM Over-Trust with Privileged-Modality Reliability Evidence](https://arxiv.org/abs/2607.28421)
...
### [257] [A foundation model of numerical intelligence with cross-disciplinary generalization](https://arxiv.org/abs/2607.28432)
...
### [259] [SVR: Self-Verifying Refinement via Joint Verdict-Confidence Reinforcement Learning for Adaptive Test-Time Compute](https://arxiv.org/abs/2607.28457)
...
### [260] [LeanCSP: A Framework for Certifying Constraint Reformulation and Solving in Lean](https://arxiv.org/abs/2607.28459)
...
### [261] [A report-grounded vision-language foundation model for colonoscopy from 280000 routine reports](https://arxiv.org/abs/2607.28466)
...
### [262] [Towards Autonomous Aircraft Surveillance from Nanosatellites through On-Board Inference and Generative Data Augmentation](https://arxiv.org/abs/2607.28470)
...
### [263] [A Fuzzy Rule-based Neuro-Symbolic Approach for Pipe Severity Prediction in Sewer Networks](https://arxiv.org/abs/2607.28481)
...
### [264] [SCOPE: Supply-Chain Operations through Coupled Policies for End-to-End Coordination](https://arxiv.org/abs/2607.28488)
...
### [265] [InfoOps Bench: A live information operations safety benchmark](https://arxiv.org/abs/2607.28503)
...
### [266] [Selective Credibility-Limited Belief Update](https://arxiv.org/abs/2607.28523)
...
### [267] [MANTA: Multi-Agent Network Topology Adaptation for Self-Evolving Multi-Agent Systems](https://arxiv.org/abs/2607.28527)
...
### [269] [Rethinking Inference-Time Scaling in Local Computer-Use Agents: Failure Modes and Compute Tradeoffs](https://arxiv.org/abs/2607.28573)
...
### [270] [DualG-MRAG: Decoupling Macro-Reasoning and Micro-Matching for Multimodal Retrieval-Augmented Generation](https://arxiv.org/abs/2607.28580)
...
### [271] [AISPA: User-Centric System Prompt Auditing for Large Language Model Applications](https://arxiv.org/abs/2607.28617)
...
### [272] [OwlPath: Lossless Knowledge Compression for LLM Bug Repair](https://arxiv.org/abs/2607.27249)
...
### [273] [Do Context Files Help Coding Agents? A Two-Agent Ablation Study on Real Repositories](https://arxiv.org/abs/2607.27250)
*Prakhar Khatri*
...
### [274] [AgentS4D: Benchmarking Runtime Risks across the Execution Lifecycle of LLM-Based Workspace Agents](https://arxiv.org/abs/2607.27294)
...
### [275] [A Taxonomy of Human-Robot Teamwork Requirements](https://arxiv.org/abs/2607.27302)
...
### [276] [SIGIL: Compiling Agent Skills into Typed Harnesses](https://arxiv.org/abs/2607.27309)
...
### [277] [TrustChain-Review: A Risk-Adaptive Blockchain and Game-Theoretic Framework for Trustworthy AI-Assisted Code Review](https://arxiv.org/abs/2607.27310)
*Mohammad Naserameri*
...
### [278] [PROGRESS: Property-Guided Regression Search for Semantic Falsification](https://arxiv.org/abs/2607.27359)
...
### [279] [From Backlog Items to Security Guidance: Towards Continuous Security Compliance](https://arxiv.org/abs/2607.27374)
...
### [280] [SWE-NFI: Studying and Benchmarking Coding Agents for Non-Functional Improvements](https://arxiv.org/abs/2607.27409)
...
### [281] [LimICE: Integrating LLM into ICE Framework for Efficient Loop Invariant Inference](https://arxiv.org/abs/2607.27606)
...
### [282] [Not as Sweet by Another Name: An Empirical Study of Format Robustness in LLM Document Workflows](https://arxiv.org/abs/2607.27648)
...
### [283] [Can Large Language Models Resolve Real Java Merge Conflicts? An Evaluation with a Calibrated LLM-as-Judge](https://arxiv.org/abs/2607.27674)
*Bowen Shen*
...
### [284] [A comparative analysis of automated techniques for security bug report identification](https://arxiv.org/abs/2607.27893)
*Muhammad Laiq*
...
### [285] [The Case for Vibe Modeling: A Missing Step in AI-Based Trustworthy Software Development](https://arxiv.org/abs/2607.27923)
...
### [286] [Specification-Guided Synthesis of Deadlock-Free Communication Protocol Refinements with Large Language Models](https://arxiv.org/abs/2607.27964)
...
### [287] [Advancing Awkward Arrays for High-Performance CPU and GPU Processing](https://arxiv.org/abs/2607.28145)
...
### [288] [Integrating AI into Requirements Quality Learning in Software Engineering Education: A TPACK-Guided Empirical Study](https://arxiv.org/abs/2607.28176)
...
### [289] [Agentic Metaverse Services: A New As-a-Service Paradigm](https://arxiv.org/abs/2607.28242)
...
### [290] [Agentic Method for Deterministic Validation of Legacy Code Migration](https://arxiv.org/abs/2607.28271)
...
### [291] [From Textual Requirements to Microservice Architectures - A Comprehensive Evaluation of LLM-Based Design Synthesis](https://arxiv.org/abs/2607.28307)
...
### [292] [Structural Validation of LLM-Generated Microservice Decompositions Using Source-Code Dependencies](https://arxiv.org/abs/2607.28331)
...
### [293] [Demystifying Solana Bots: From GitHub Blueprints to On-Chain Fingerprints](https://arxiv.org/abs/2607.28424)
...
### [294] [Emerging Challenges in Threat Modeling for GenAI-Augmented Systems: A View from the Trenches](https://arxiv.org/abs/2607.28431)
...
### [295] [CoGate: Confidence-Gated Co-Decoding for Secure Code Generation](https://arxiv.org/abs/2607.28529)
...
### [296] [PAIChecker: Uncovering and Checking PR-Issue Misalignment in SWE-Bench-Like Benchmarks](https://arxiv.org/abs/2607.28587)
...
### [297] [Change2Task: From Repository Changes to Executable Coding Agent Tasks and Environments](https://arxiv.org/abs/2607.28591)
...
### [298] [ESBT: A Scalable and Deterministic Sequence CRDT for Distributed Collaborative Editing](https://arxiv.org/abs/2607.28101)
...
### [299] [SmartGen: Seamless Disaggregated LLM Inference with Selective KV Cache Transfer](https://arxiv.org/abs/2607.28150)
...
### [300] [A Cloud Continuum Research Infrastructure for Distributed CPS Experimentation](https://arxiv.org/abs/2607.28193)
...
### [301] [Queue-Theoretic Admission Control for Multi-Tenant GPU Clusters](https://arxiv.org/abs/2607.28223)
*Sohan Kunkerkar*
...
### [302] [FAIR-Compute: A Roadmap for Fair and Efficient Allocation of Federated Digital Research Infrastructure](https://arxiv.org/abs/2607.28290)
...
### [303] [A Taxonomy of Performance Metrics for the Distributed Computing Continuum](https://arxiv.org/abs/2607.28407)
...
### [304] [Safe Quotes for Retroactive Liquidity Pools](https://arxiv.org/abs/2607.28522)
*Peter Bro Miltersen*
