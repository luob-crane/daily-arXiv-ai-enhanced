...
### [22] [MVDGC: Joint 3D and 2D Multi-view Pedestrian Detection via Dual Geometric Constraints](https://arxiv.org/abs/2607.00273)
...
### [142] [SmoothAgent: Efficient Long-Horizon LLM-Based Agent Serving with Lookahead Context Engineering](https://arxiv.org/abs/2607.00151)
...
### [143] [Promise-Future Synchronization for Cluster Asynchronous Many-Task Runtimes via MPI One-Sided Communication](https://arxiv.org/abs/2607.00303)
*Mia Reitz*
...
### [144] [CloudyGUI: A Novel Python-based Framework for Auto-Scaling and Cloud Workload Analysis](https://arxiv.org/abs/2607.00455)
...
### [145] [ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving](https://arxiv.org/abs/2607.00466)
...
### [146] [Modeling and Chasing the Energy-Efficiency Sweet Spots in Modern GPUs](https://arxiv.org/abs/2607.00819)
...
### [147] [Next-Generation Agentic Reinforcement Learning Systems Enable Self-Evolving Agents](https://arxiv.org/abs/2607.01120)
...
### [148] [High-order perturbative calculations of nuclear ground states: Automated evaluation of many-body diagrams](https://arxiv.org/abs/2607.00119)
...
### [150] [Astrophysical S-factor Calculation for p-p Fusion Reaction](https://arxiv.org/abs/2607.00487)
...
### [152] [Elastic deuteron-deuteron scattering within Nuclear Lattice Effective Field Theory](https://arxiv.org/abs/2607.00681)
*Helen Meyer,Serdar Elhatisari,Ulf-G. Meißner*
...
Abstract: We report a transport model study of the rapidity even component of dipolar flow, $v_{1}^{\mathrm{even}}$, for identified charged hadrons at mid-rapidity in Au+Au collisions at $\sqrt{s_{NN}} = 27-200$ GeV. The analysis is performed using the AMPT model, with comparisons to HIJING to quantify non-flow contributions. The $v_{1}^{\mathrm{even}}$ of identified hadrons ($π$, $K$, and $p$) shows no significant difference between particles and anti-particles at $\sqrt{s_{NN}} = 200$ GeV. However, a clear splitting between proton and anti-proton $v_{1}^{\mathrm{even}}$ develops with decreasing beam energy, while no corresponding difference is observed for mesons ($π^{\pm}$ and $K^{\pm}$). A comparison of the AMPT string melting and default configurations shows that the splitting arises only in the string melting scenario, where partonic interactions and quark coalescence play a dominant role. These results indicate that the proton-antiproton difference in $v_{1}^{\mathrm{even}}$ is sensitive to baryon transport and early-stage partonic dynamics. Our study highlights the potential of identified-particle $v_{1}^{\mathrm{even}}$ measurements at RHIC Beam Energy Scan energies as a novel probe of baryon stopping and the evolution of the partonic medium.

</details>


### [154] [Purifying one-neutron removal as a probe of single-particle strength](https://arxiv.org/abs/2607.01078)
...
### [155] [Semi-regularised three-body pseudopotential for mean-field and beyond-mean-field calculations](https://arxiv.org/abs/2607.01190)
...
Abstract: We derive the most general form of a local leading-order semi-regularised three-body pseudopotential. This particular form of pseudopotential is developed with the aim of generating contributions to the nuclear energy density functional (EDF) in both the particle-hole and particle-particle channels and, hence, to be usable in mean-field and beyond-mean-field calculations without ambiguities or mathematical difficulties. Once the EDF is obtained, analytical expressions of commonly considered properties of infinite nuclear matter are provided. Finally, the structure of the EDF and the associated mean fields are given for spherically-symmetric systems.
...
### [156] [An SOA-Based Big Data Management Framework for Primary Healthcare Centers in Bahrain](https://arxiv.org/abs/2607.00021)
...
### [157] [Stop Hand-Holding Your Coding Agent: Engineering the Loops that Replace Step-by-Step Prompting](https://arxiv.org/abs/2607.00038)
*Sandeco Macedo*
...
### [158] [Evaluating Hardware Abstraction Layer Concepts for Software Defined Vehicles: Insights into Applicability and Effectiveness](https://arxiv.org/abs/2607.00039)
...
### [159] [ATM: CID-Brokered Pre-Write Admission for Multi-Agent Code Co-Synthesis](https://arxiv.org/abs/2607.00041)
*Eagl Huang*
...
### [160] [A Taxonomy of Single-Turn Textual Prompt Patterns](https://arxiv.org/abs/2607.00043)
...
### [161] [Comparing Large Language Models on Scrum Certification-Style Questions: Accuracy, Stability, and Error Patterns](https://arxiv.org/abs/2607.00048)
...
### [162] [Prompting GPT-5 on Scrum Certification Questions: An Empirical Accuracy Study](https://arxiv.org/abs/2607.00049)
...
### [163] [SWE-Router: Routing in Multi-turn Agentic Software Engineering Tasks](https://arxiv.org/abs/2607.00053)
...
### [164] [A Quantitative Framework for Estimating System Complexity and Cost via Component Interface Analysis](https://arxiv.org/abs/2607.00054)
*Ken Y. Chan*
...
### [166] [Stochastic Connectivity as the Foundation of a Runtime Model for Microservice Availability Analysis](https://arxiv.org/abs/2607.00740)
...
### [167] [The Illusion of Safety: Multi-Tier Verification of AI vs. Human C++ Code](https://arxiv.org/abs/2607.00107)
...
### [168] [Registry-Governed Agent Lifecycle:Completing EDDOps with Evaluation-DrivenRegistration, Promotion, and Retirement on AWS AgentCore](https://arxiv.org/abs/2607.00345)
...
### [169] [BT-APE: A Computationally Light Backtracking Approach to Automatic Prompt Engineering for Requirements Classification](https://arxiv.org/abs/2607.00427)
...
### [170] [Social Popularity of GitHub Projects: A Lifeline or a Liability?](https://arxiv.org/abs/2607.00435)
...
### [171] [Large Language Models for Multi-Lingual Equivalent Mutant Detection: An Extended Empirical Study](https://arxiv.org/abs/2607.00511)
...
### [172] [Auditing Empirical Comparisons in Quantum Software](https://arxiv.org/abs/2607.00516)
...
### [173] [Rise From The Ashes: LLM-based Static Analysis for Deep Learning Framework Bugs](https://arxiv.org/abs/2607.00555)
...
### [174] [A Methodology for Investigating AI Patterns Prevalence in Software Repositories](https://arxiv.org/abs/2607.00558)
...
### [175] [Towards Better Linux Kernel Fault Localization: Leveraging Contrastive Reasoning and Hierarchical Context Analysis](https://arxiv.org/abs/2607.00562)
...
### [176] [SchedCheck: Schedule-Robustness Analysis for Event-Driven Block Programs](https://arxiv.org/abs/2607.00623)
*Yuan Si,Jialu Zhang*
...
### [177] [The Perception and Impact of Non-inclusive Language in Software Artifacts](https://arxiv.org/abs/2607.00626)
...
### [178] [Checked Program Recovery from Execution Video: A Sound Oracle for Untrusted Generators](https://arxiv.org/abs/2607.00635)
*Yuan Si,Jialu Zhang*
...
### [179] [LLVM-Bench: Benchmarking and Advancing Large Language Models for LLVM Compiler Issue Resolution](https://arxiv.org/abs/2607.00700)
...
### [180] [ClarifyCodeBench: Evaluating LLMs on Clarifying Ambiguous Requirements for Code Generation](https://arxiv.org/abs/2607.00711)
...
### [181] [Knowledge-Enhanced Agentic Vulnerability Repair](https://arxiv.org/abs/2607.00820)
...
### [182] [Petrify: Petri-net Based Analysis of Concurrency Properties in Java Bytecode](https://arxiv.org/abs/2607.00830)
...
### [183] [From Registry to Repository: How AI Agent Skills Are Written, Adapted, and Maintained](https://arxiv.org/abs/2607.00911)
...
### [184] [Delta Debugging in the Absence of Test Oracles Through Metamorphic Testing](https://arxiv.org/abs/2607.00929)
...
### [185] [Leveraging LLM-Based Agentic Systems to Generate Quantum Applications for Test Optimization](https://arxiv.org/abs/2607.00939)
...
### [186] [SWE-Doctor: Guiding Software Engineering Agents with Runtime Diagnosis from Multi-Faceted Bug Reproduction Tests](https://arxiv.org/abs/2607.00990)
...
### [187] [Identifying Effective Program Comprehension Strategies through Gaze Transitions over Syntactic Elements](https://arxiv.org/abs/2607.01042)
...
### [188] [AutoRestTest at the SBFT 2026 Tool Competition](https://arxiv.org/abs/2607.01063)
...
### [189] [Cheap Code, Costly Judgment: A Case Study on Governable Agentic Software Engineering](https://arxiv.org/abs/2607.01087)
...
### [190] [A Model-based Testing Technique for Amazon Lex Task-based Chatbots](https://arxiv.org/abs/2607.01094)
...
### [191] [SAGE: Structured Agentic Graph Editing for Software Diagrams](https://arxiv.org/abs/2607.01102)
...
### [192] [Skills Are Not Islands: Measuring Dependency and Risk in Agent Skill Supply Chains](https://arxiv.org/abs/2607.01136)
...
### [193] [Are Performance-Optimization Benchmarks Reliably Measuring Coding Agents?](https://arxiv.org/abs/2607.01211)
...
### [194] [RepoRescue: An Empirical Study of LLM Agents on Whole-Repository Compatibility Rescue](https://arxiv.org/abs/2607.01213)
...
### [195] [Phantom References: Hallucinated Citations That Survive Peer Review at Top-Tier Conferences](https://arxiv.org/abs/2607.00738)
...
### [196] [Grid-Interactive Thermal Management of AI Data Centers via Contextual Distributionally Robust Optimization](https://arxiv.org/abs/2607.00099)
...
### [197] [A Shallow Recurrent Decoder for Dynamic State Estimation with a Limited Number of PMUs in Power Systems](https://arxiv.org/abs/2607.00116)
...
### [198] [Small-signal Stability of a Unified Single-unit Infinite-bus Swing-equation Model for Generators and Inverters](https://arxiv.org/abs/2607.00161)
...
### [199] [Parameterizing Operating-Point-Dependent IBR Using Coherent Operating Regions for Sub-synchronous Oscillation Analysis](https://arxiv.org/abs/2607.00216)
...
### [200] [Communication-Aware and Safety-Aware UAV Control via Predictive Latent Models](https://arxiv.org/abs/2607.00288)
...
### [201] [Queue-Aware Graph Reinforcement Learning for UAV-ISAC-Assisted Maritime Data Collection](https://arxiv.org/abs/2607.00324)
...
### [202] [Sinusoidality Index](https://arxiv.org/abs/2607.00419)
...
### [203] [Mobility Safe Adaptive Reserve Certification for Electric Vehicle Hydrogen Bus and Building Resilience Hubs](https://arxiv.org/abs/2607.00585)
*Yifan Wang*
...
### [204] [Learning-based control of a single-DOF Aero system](https://arxiv.org/abs/2607.00640)
...
### [205] [A Data-Enabled Primal-Dual Approach for Policy Learning with SDP Formulations](https://arxiv.org/abs/2607.00644)
...
### [206] [Investigating Driver Behavior in Complex Traffic Situations While Driving Partially Automated Vehicles](https://arxiv.org/abs/2607.00855)
...
### [207] [Deadline-Aware Electric Vehicles Charging with Distribution Transformer Overload Mitigation](https://arxiv.org/abs/2607.00935)
*B Hari Kiran Reddy*
...
### [208] [TERA: A Unified Taylor Model Enabled Reachability Analysis Framework](https://arxiv.org/abs/2607.01189)
...
### [209] [GPU-Parallel Linearization Error Bounds for Real-Time Robust Optimal Control of Nonlinear and Neural Network Dynamics](https://arxiv.org/abs/2607.01203)
...
### [210] [Distributed Containment of a Compromised Agent through Repulsive Cages](https://arxiv.org/abs/2607.01230)
...
### [211] [Measurement of 80-200 MeV/n $^{16}$O nuclear cross-section on Carbon and Polyethylene targets with the nuclear emulsion detector of the FOOT experiment](https://arxiv.org/abs/2607.00743)
*FOOT Collaboration,Giuliana Galati,Vincenzo Boccia,Andrey Alexandrov,Giovanni Ambrosi,Stefano Argirò,Takashi Asada,Mattia Barbanera,Nazar Bartosik,Giuseppe Battistoni,Alexandre Bigot,Maria Giuseppina Bisogni,Giorgio Butella,Francesca Cavanna,Piergiorgio Cerello,Esther Ciarrocchi,Nicola D'Ambrosio,Giovanni De Lellis,Antonia Di Crescenzo,Benedetto Di Ruzza,Matilde Dondi,Marco Donetti,Yunsheng Dong,Marco Durante,Riccardo Faccini,Veronica Ferrero,Christian Finck,Elisa Fiorina,Marco Francesconi,Matteo Franchini,Gaia Franciosini,Luca Galli,Antonio Iuliano,Keida Kanxheri,Bharat Kharpuse,Aafke Kraan,Adele Lauria,Ernesto Lopez Torrez,Marco Magi,Alice Manna,Michela Marafini,Simone Masci,Maurizio Massa,Christian Massimi,Ilaria Mattei,Sofia Mazzolani,Alberto Mengarelli,Alessio Mereghetti,Riccardo Mirabelli,Andrea Moggi,Maria Cristina Morone,Matteo Morrocchi,Silvia Muraro,Tatsuhiro Naka,Nadia Pastrone,Vincenzo Patera,Francesco Pennazio,Claudia Pisanti,Pisana Placidi,Marco Pullia,Flaminia Quattrini,Sara Rabaglia,Luciano Ramello,Claire-Anne Reidel,Riccardo Ridolfi,Laura Rocchetti,Lucia Sabbatini,Lucia Salvi,Claudio Sanelli,Alessio Sarti,Osamu Sato,Simone Savazzi,Angelo Schiavi,Christoph Schuy,Emanuele Scifoni,Leonello Servoli,Gianluigi Silvestre,Mario Sitta,Benedetto Spadavecchia,Roberto Spighi,Eleuterio Spiriti,Luana Testa,Valeri Tioukov,Sandro Tomassini,Francesco Tommasino,Marco Toppi,Giacomo Traini,Antonio Trigilio,Giacomo Ubaldi,Sara Valentinetti,Marie Vanstalle,Mauro Villa,Uli Weber,Roberto Zarrella,Antonio Zoccoli,Maria Cristina Montesi*
...
### [244] [From "Strings" to "Things" for Personal Knowledge Graphs: Evaluating LLM Triple Extraction for Recommendation Systems](https://arxiv.org/abs/2607.00003)
...
### [245] [Why Advanced Encoders Lag on Sparse Retrieval? The Answer and an Approach to Bridging Vocabulary Gaps](https://arxiv.org/abs/2607.00004)
...
### [246] [Topological Void Analysis A Mathematical Framework for Systematic Technical Innovation Discovery in Knowledge Spaces](https://arxiv.org/abs/2607.00005)
*Kris Pan*
...
### [247] [BaRA: BFS-and-Reflection Web Data Collection Agent](https://arxiv.org/abs/2607.00007)
...
### [248] [SchemaRAG: Dynamic Large Schema Reduction for LLM-driven Structured Information Extraction](https://arxiv.org/abs/2607.00008)
...
### [249] [Prompt Optimization for User Simulation in Conversational Recommender Systems: A Multi-Objective Framework](https://arxiv.org/abs/2607.00010)
...
### [250] [SkillSelect-Serve: Budget-Controllable and QoS-Aware Skill Service Recommendation and Composition for Small LLM Agents](https://arxiv.org/abs/2607.00011)
...
### [251] [PRA-RAG: Provably Robust Aggregation in Retrieval-Augmented Generation against Retrieval Corruption](https://arxiv.org/abs/2607.00012)
...
### [252] [GRACE-RAG: Governed Retrieval Architecture for Canonical Evidence Synthesis, Enabling Lightweight Deployment in Closed-Domain Institutional Settings](https://arxiv.org/abs/2607.00013)
...
### [253] [Libra: Training the Environment for Agentic Information Retrieval](https://arxiv.org/abs/2607.00016)
...
### [254] [Learning User-Aware Recall: Personalized Retrieval in Long-Term Conversational Memory](https://arxiv.org/abs/2607.00017)
...
### [255] [Aligning Sentence Embeddings to Human Concepts via Sparse Autoencoders](https://arxiv.org/abs/2607.00023)
...
### [256] [AGE: Adaptive-masking for Graph Embedding in Graph Retrieval-Augmented Generation](https://arxiv.org/abs/2607.00052)
...
### [257] [Attribute-Prompted Kernel Hashing for Unsupervised Data-Efficient Cross-Modal Retrieval](https://arxiv.org/abs/2607.00379)
...
### [258] [Real-Time Hard Negative Sampling via LLM-based Clustering for Large-Scale Two-Tower Retrieval](https://arxiv.org/abs/2607.00448)
...
### [259] [When RAG Meets Query Planning: Logical Query Trees for Resolving Exploratory Reasoning Problems](https://arxiv.org/abs/2607.00508)
...
### [260] [As It Was: Aligning LLM Search Evaluation with Historical User Preferences](https://arxiv.org/abs/2607.01040)
...
### [261] [MemSyco-Bench: Benchmarking Sycophancy in Agent Memory](https://arxiv.org/abs/2607.01071)
...
### [262] [Trie-based Experiment Plans for Efficient IR Pipeline Experiments](https://arxiv.org/abs/2607.01162)
...
### [263] [Diffusion-GR2: Diffusion Generative Reasoning Re-ranker](https://arxiv.org/abs/2607.01170)
