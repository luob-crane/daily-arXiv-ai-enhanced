...
### [79] [The Nature of the Chemonuclear Reaction](https://arxiv.org/abs/2607.18331)
...
Abstract: Mirror charge radii can constrain neutron skins only if nuclear isospin-symmetry breaking beyond the Coulomb interaction is controlled. We present a differential Skyrme energy-density-functional analysis in which mirror displacement energies (MDEs) and mirror charge-radius differences are generated by the same class-III charge-symmetry-breaking (CSB) functional. Starting from self-consistent Coulomb-only SLy4 and SkM* baselines, we map Coulomb-subtracted MDE residuals onto volume and surface-gradient CSB terms. The MDEs determine the nearly degenerate volume-surface direction, while the measured anchor radii select the point on that direction used for target predictions, without introducing radius-specific parameters. Measured pairs $^{34}$Ar-$^{34}$S, $^{36}$Ca-$^{36}$S, $^{38}$Ca-$^{38}$Ar, and $^{54}$Ni-$^{54}$Fe form compact surface-gradient-like response classes, with $λ_B=1.32\pm0.04~\mathrm{fm}^{-2}$ for SLy4 and $1.20\pm0.05~\mathrm{fm}^{-2}$ for SkM*. MDEs therefore constrain mainly the effective combination $t_0^{\mathrm{III}}-λ_{\mathrm{cl}}C_Δ^{\mathrm{III}}$, rather than the two couplings separately. A joint volume-plus-surface-gradient fit gives MDE and $ΔR_{\rm ch}^{\rm mirr}$ RMS residuals of $0.0529$ MeV and $0.0031$ fm in SLy4; SkM* recovers the response class but gives a larger $ΔR_{\rm ch}^{\rm mirr}$ residual. Calibrated response changes proton-rich mirror skins at the $10^{-2}$ fm level and yields charge radius predictions for $^{40}$Ti, $^{42}$Ti, $^{46}$Cr, and $^{50}$Fe, with an SLy4 - SkM* spread of up to $0.021$ fm. Surface-gradient-sensitive CSB corrections must therefore be quantified before mirror charge-radius differences are used as clean neutron-skin or symmetry-energy probes. The agreement of SLy4 and SkM* in the response-class assignment is more robust than their absolute radius corrections, which remain EDF dependent.

</details>


### [82] [Nonlinear collective flow reveals the breakdown of quadrupole--hexadecapole scaling in heavy ion collisions](https://arxiv.org/abs/2607.18752)
...
### [83] [Quarkyonic Stars with Strangeness](https://arxiv.org/abs/2607.19220)
...
### [84] [Mapping parametric error profiles onto nuclear structure configurations in deformed proton radioactivity](https://arxiv.org/abs/2607.18911)
*Jizheng Bo*
...
### [86] [Topology-Aware Tokenization for Generative Recommendation](https://arxiv.org/abs/2607.18600)
...
### [87] [AutoIndex: Learning Representation Programs for Retrieval](https://arxiv.org/abs/2607.18603)
...
### [88] [Mitigating Matthew Effect: Multi-Hypergraph Boosted Multi-Interest Self-Supervised Learning for Conversational Recommendation](https://arxiv.org/abs/2607.18609)
...
### [89] [PLAID-PRF: Pseudo-Relevance Feedback with Centroid-like Tokens in PLAID](https://arxiv.org/abs/2607.18626)
...
### [90] [An Epistemic Position-Based Click Model: From Interactions to Epistemic Distributions of Relevance and Bias](https://arxiv.org/abs/2607.18712)
...
### [91] [RAGAL: A Frugal, Fully Local Retrieval-Augmented Assistant for Technical Support at a Government Agency](https://arxiv.org/abs/2607.18756)
*Dan Musetoiu*
...
### [92] [Beyond Noisy Signals: Dual-Level Denoising for Multi-modal Sequential Recommendation](https://arxiv.org/abs/2607.18786)
...
### [93] [TSGR: Taobao Search Generative Retrieval](https://arxiv.org/abs/2607.18796)
...
### [94] [Answer-Reconstruction Search Density: Measuring the Query and Source Work Compressed by Conversational Answers](https://arxiv.org/abs/2607.18904)
*Benjamin Tannenbaum*
...
### [95] [Spectral Biclustering-Driven Scalability for Post-Hoc Explainability in Recommender Systems](https://arxiv.org/abs/2607.19189)
...
### [96] [PAGE-RAG: Evidence-Grounded Adaptive Graph Retrieval for Long-Document Question Answering](https://arxiv.org/abs/2607.19301)
...
### [97] [SysAdmin: Measuring Instrumental Power-Seeking in Frontier AI](https://arxiv.org/abs/2607.18239)
...
### [98] [Calibrated Selective Fact-Checking via Evidence Chain Evaluation](https://arxiv.org/abs/2607.18240)
*Dekun Yang*
...
### [99] [BatchDAG: LLM-Planned Execution Graphs for Scalable Ad-Hoc Analysis Over Enterprise Data](https://arxiv.org/abs/2607.18241)
*Anupreet Walia*
...
### [100] [AI Tool Discovery at Scale: All You Need is DNS](https://arxiv.org/abs/2607.18242)
...
### [101] [From Agent Failure Paths to Quantified Residual Risk: A Compositional Framework for Resilient Agentic AI](https://arxiv.org/abs/2607.18243)
...
### [102] [SAAG: Structured Agent Assessment and Grounding](https://arxiv.org/abs/2607.18245)
...
### [103] [Phionyx: A Deterministic AI Runtime Architecture with Structured State Management and Pre-Response Governance](https://arxiv.org/abs/2607.18246)
*Ali Toygar Abak*
...
### [104] [Integro-differential equations in angular stabilization of drone motion by distributed feedback control](https://arxiv.org/abs/2607.18251)
...
### [105] [MILP-Evo: Closed-Loop Fully Automatic Design of MILP Solvers](https://arxiv.org/abs/2607.18252)
...
### [106] [Beyond Accuracy and Cost: Latency-Aware LLM Query Routing for Dynamic Workloads](https://arxiv.org/abs/2607.18253)
...
### [107] [Cross-Dialect Generalization Without Retraining: Benchmarks and Evaluation of Schema-Derived Constrained Decoding for MLIR](https://arxiv.org/abs/2607.18254)
*Plawan Kumar Rath*
...
### [108] [Semantic Cooperative Games for Contribution Attribution in LLM-Based Multi-Agent Systems](https://arxiv.org/abs/2607.18255)
...
### [110] [PEARL: Solver-in-the-Loop Interactive Optimization Modeling from Natural Language](https://arxiv.org/abs/2607.18256)
...
### [112] [Engineering Trustworthy Agentic AI for Critical Systems](https://arxiv.org/abs/2607.18548)
...
### [113] [S2T-RLHF: Hierarchical Credit Assignment for Stable Preference-Based RLHF](https://arxiv.org/abs/2607.18258)
...
### [114] [Probabilistic Concept-Aware Steering for Trustworthy LLM Inference](https://arxiv.org/abs/2607.18259)
...
### [115] [FindStatBench: Evaluating Large Language Models on Combinatorial Code Synthesis](https://arxiv.org/abs/2607.18260)
*Soham Dan*
...
### [116] [When JSON Is Not Enough: Semantic Reliability of Schema-Constrained LLM Ordering Agents](https://arxiv.org/abs/2607.18261)
*Yin Li*
...
### [117] [ProbSPARQL: Querying Knowledge Graphs with Multi-dimensional, Uncertain Numeric Data](https://arxiv.org/abs/2607.18262)
...
### [118] [Position: AI/ML Deepfake Research is Misaligned with AI-Generated Non-Consensual Intimate Imagery (AIG-NCII)](https://arxiv.org/abs/2607.18263)
...
### [119] [MUX: Continuous Reasoning via Multiplexed Tokens](https://arxiv.org/abs/2607.18264)
...
### [120] [State Compression in Two-Agent LLM Relays: A Closed-World Study of Constraint Preservation](https://arxiv.org/abs/2607.18265)
...
### [121] [Structured Synthetic Reasoning Data for Arithmetic Fine-Tuning of Small Language Models](https://arxiv.org/abs/2607.18266)
...
### [122] [Fence: Specialized SLM Guardrails for LLM Applications](https://arxiv.org/abs/2607.18268)
...
### [123] [Wisdom of LLM Crowds: Aggregation and Contamination in Language Model Ensembles](https://arxiv.org/abs/2607.18269)
*Igor Douven*
...
### [124] [Trajectory-Aware Clinical Risk Prediction via Severity-Grounded Knowledge Graphs and Retrieval-Augmented Generation](https://arxiv.org/abs/2607.18270)
...
### [125] [Using LLMs for Explainable, Data-Driven Insight Generation from Time Series](https://arxiv.org/abs/2607.18271)
...
### [126] [Deep Reinforcement Learning to Master the Asymmetric Strategy of Baghchal](https://arxiv.org/abs/2607.18296)
...
### [127] [Operational Hallucination and Safety Drift in AI Agents](https://arxiv.org/abs/2607.18366)
...
### [128] [AlayaWorld: Interactive Long-Horizon World Modeling -- Full Technical Report](https://arxiv.org/abs/2607.18367)
...
### [129] [Neuro-Symbolic Meta-Policies for Temporal Knowledge-Graph Memory under Partial Observability](https://arxiv.org/abs/2607.18368)
...
### [130] [MAGE: Human-Like Macro Placement via Agentic Multimodal Reasoning](https://arxiv.org/abs/2607.18536)
...
### [131] [Attacking Graph Foundation Models Through Their Shared Representation](https://arxiv.org/abs/2607.18567)
...
### [132] [When Does Machine Learning Beat Value Sorting? A Three-Dataset Diagnostic of Exposure-Weighted Shipment Prioritization](https://arxiv.org/abs/2607.18573)
*Jize Li*
...
### [133] [SciHazard: A Benchmark for Measuring Scientific Safety Risks with Decomposed Harm Scoring](https://arxiv.org/abs/2607.18665)
...
### [134] [Semantic Primes as Explanans for Emotion in Large Language Models](https://arxiv.org/abs/2607.18691)
*Frank Xing*
...
### [135] [Do AI-Native Biotechs Need Departments? Benchmarking Company World Models for AI-Driven Drug Development](https://arxiv.org/abs/2607.18696)
*Yinan Wang*
...
### [136] [DWM: Separating World Effects from Actions in Latent World Models](https://arxiv.org/abs/2607.18715)
...
### [137] [One Rewrite to Fix Them All? Type-Aware Repair Allocation for Text-to-Image Prompt Optimization](https://arxiv.org/abs/2607.18724)
...
### [138] [AgentDebugX: An Open-Source Toolkit for Failure Observability, Attribution, and Recovery in LLM Agents](https://arxiv.org/abs/2607.18754)
...
### [139] [SkillSight: Seeing Through Shared Descriptions for Accurate Skill Retrieval](https://arxiv.org/abs/2607.18785)
...
### [140] [AI Tour Meeting: Group Travel Planning by LLM Agents](https://arxiv.org/abs/2607.18806)
*Daisuke Kikuta*
...
### [141] [Evaluating medical AI under missing information: same-provider judges and human raters change apparent safety](https://arxiv.org/abs/2607.18828)
*Koyar Afrasyab*
...
### [142] [PhoenixRepair: Rethinking Repair Strategy Exploration in Software Agents](https://arxiv.org/abs/2607.18859)
...
### [143] [NaviAIS: A Scenario-Level Vessel Trajectory Prediction Dataset withVectorized Lane Priors and the NaviLane Forecasting Framework](https://arxiv.org/abs/2607.18887)
...
### [144] [Black-Mamba: Biologically-Inspired Leaky Accumulation for Conceptual Knowledge under Distribution Drift](https://arxiv.org/abs/2607.18899)
...
### [145] [Enhancing Transformer-based Routing by Encoding Distance via Relative Positional Encoding](https://arxiv.org/abs/2607.18909)
...
### [146] [OntoBook: Ontology-Grounded Synthetic Textbooks for Medical Encoder Pretraining](https://arxiv.org/abs/2607.18927)
...
### [147] [What General Intelligence Requires: Non-Reducible Constraints Across Levels of Description](https://arxiv.org/abs/2607.18943)
*Subhomoy Bakshi*
...
### [148] [From Dependency to Compositionality: A Neurosymbolic Lifting of LLM Outputs via Combinatory Categorial Grammar](https://arxiv.org/abs/2607.18961)
*Remo Pareschi*
...
### [149] [Measuring Reward-Seeking via Contrastive Belief Updates](https://arxiv.org/abs/2607.18966)
...
### [150] [Mi-Memory: A Lifecycle Memory Framework for Personal AI](https://arxiv.org/abs/2607.18975)
...
### [151] [Fishing Out Free Riders: Shapley-Based Reward Attribution for Parallel Reasoning via Reinforcement Learning](https://arxiv.org/abs/2607.18979)
...
### [152] [Athena-Brain Technical Report: An Efficient Robot Brain for General Intelligence and Embodied Interactio](https://arxiv.org/abs/2607.18985)
...
### [153] [Vector-Bench: Can Models Surgically Edit SVG Code?](https://arxiv.org/abs/2607.19056)
...
### [154] [Quality Action Assurance: Multimodal Verification of Examiner Claims in VR OSCEs](https://arxiv.org/abs/2607.19063)
...
### [155] [On the Effectiveness of Pretraining for Graph Combinatorial Optimization](https://arxiv.org/abs/2607.19072)
...
### [156] [Supra Cognitive Modes: A Routed Architecture for Agent Memory](https://arxiv.org/abs/2607.19096)
...
### [157] [OpenRTAG: A Comprehensive Benchmark for Robust Text-Attributed Graph Learning under Data Quality Degradation](https://arxiv.org/abs/2607.19108)
...
### [158] [Comparative Study of Multi-Agent Actor-Critic Algorithms in Parameterized Action Reinforcement Learning](https://arxiv.org/abs/2607.19117)
...
### [159] [BioSecBench-Surveillance: A Verifiable Benchmark for AI Agents in Pathogen Genomic Surveillance](https://arxiv.org/abs/2607.19262)
...
### [161] [ResearchArena: Evaluating Sabotage and Monitoring in Automated AI R&D](https://arxiv.org/abs/2607.19321)
...
### [162] [Associative Emotional Learning in Convolutional Neural Networks](https://arxiv.org/abs/2607.19327)
...
### [163] [Agents in the Wild: Where Research Meets Deployment](https://arxiv.org/abs/2607.19336)
...
### [164] [CodeRescue: Budget-Calibrated Recovery Routing for Coding Agents](https://arxiv.org/abs/2607.19338)
...
### [165] [Binding Drift in Multi-Step Tool-Augmented Agents](https://arxiv.org/abs/2607.18316)
...
### [166] [A Decision-Centered Reference Architecture for Trustworthy Agentic Commerce](https://arxiv.org/abs/2607.18347)
*Dimitrios S. Sfiris*
...
### [167] [CODENS: Transforming Code Changes into Living, Accessible, and Queryable Documentation](https://arxiv.org/abs/2607.18356)
...
### [168] [Beyond Resolved Rate: A Non-Functional Quality Study](https://arxiv.org/abs/2607.18462)
...
### [169] [Semantic Drift in Bug Resolution: How Behavioral Signals Propagate from Reports to Tests and Patches](https://arxiv.org/abs/2607.18550)
...
### [170] [LM2Alloy: Investigating LLM-Generated Formal Specifications for Automated Test Derivation in Production Software](https://arxiv.org/abs/2607.18555)
...
### [171] [Provably Lossless Acceleration of DNN Mutation Testing via Memoization](https://arxiv.org/abs/2607.18582)
...
### [172] [LLM-Based Invariant Testing for Software Functional Bugs](https://arxiv.org/abs/2607.18711)
...
### [173] [Beyond Text Editing: Algebraic Manipulation of Source Code](https://arxiv.org/abs/2607.18742)
*Kevin Pulo*
...
### [174] [TrapHunter: Exposing Covert Pathways in Trap Token Contracts](https://arxiv.org/abs/2607.18753)
...
### [175] [TraceDev: A Traceability-Driven Multi-agent Framework for Requirement-to-Code Development](https://arxiv.org/abs/2607.18886)
...
### [176] [Skillware: A Software Ontology and Engineering Lifecycle for Persistent Behavioral Artifacts](https://arxiv.org/abs/2607.18970)
...
### [177] [From Collaboration to Regulation: Characterizing Governance Practice in Three Deep Learning Open Source Communities](https://arxiv.org/abs/2607.19022)
...
### [178] [SciCodePile: A 128GB Corpus and Executable Benchmark for Challenging Scientific Code Generation](https://arxiv.org/abs/2607.19104)
...
### [179] [EmbeddedKittens: An Evaluation of Code Embeddings for Scratch](https://arxiv.org/abs/2607.19291)
...
### [180] [Negative-parity high-spin structure of 105Pd](https://arxiv.org/abs/2607.18953)
...
### [181] [Learnable Sequential Memory in Coupled Oscillator Networks](https://arxiv.org/abs/2607.18439)
...
### [182] [Large-Signal Stability Analysis of Optimization-Based Secondary Control for Distributed Energy Resources](https://arxiv.org/abs/2607.18500)
...
### [183] [Integrity-Gated Eco-CACC: Epistemic Admissibility for Cooperative Driving at Signalized Intersections](https://arxiv.org/abs/2607.18565)
...
### [184] [Stochastic Capacity Accreditation: Incentivizing Resource Adequacy under Weather Uncertainty](https://arxiv.org/abs/2607.18653)
...
### [185] [Rethinking Joint UAV Placement and Beamforming: A Correlation-Aware Geometric Approach](https://arxiv.org/abs/2607.18668)
...
### [186] [Aggregation of Evolutionary Game Dynamics on Large-Scale Weighted Networks](https://arxiv.org/abs/2607.18776)
*Zhiru Wang,Bin Wu*
...
### [187] [Bifurcation Analysis of Sub-Synchronous Oscillations Related to Grid-Forming Converter Inner Controllers](https://arxiv.org/abs/2607.18894)
...
### [188] [Forecast-Assisted Deep Reinforcement Learning for Energy Management of Hydrogen-Enabled Community Microgrids](https://arxiv.org/abs/2607.18903)
...
### [189] [How network perturbations distort agreement trajectories in LTI multi-agent systems](https://arxiv.org/abs/2607.18913)
...
### [190] [Online sparse observers for cyber-physical systems under sensor bias](https://arxiv.org/abs/2607.18951)
...
### [191] [STL-GCS: A Planner-Controller Framework for Signal Temporal Logic via Graphs of Time-varying Convex Sets](https://arxiv.org/abs/2607.19196)
...
### [192] [Model-Agnostic Meta Learning for Differentiable MPC](https://arxiv.org/abs/2607.19271)
...
### [193] [Dataset on residential electricity load profiles in Switzerland](https://arxiv.org/abs/2607.19294)
...
### [194] [Predictive RTO for CoAP using Lightweight Support Vector Regression in Internet of Things](https://arxiv.org/abs/2607.18273)
...
### [195] [What Governs Decode Throughput in Absolute-Offset GPU LZ77? A Work-Granularity Mechanism and an Encode-Time Min-Match-Length Lever](https://arxiv.org/abs/2607.18541)
*Yakiv Shavidze*
...
### [196] [Searching for Plans You Can Actually Build: A Realizability-Aware Full-Space Optimizer for MoE Training and Serving](https://arxiv.org/abs/2607.18631)
*Quan Yuan,Jie Zhao*
...
### [197] [Unstructured Hydrodynamics on Spatial Dataflow Architectures: A Joint Code and Data Decomposition Approach](https://arxiv.org/abs/2607.18650)
...
### [198] [Mapping Without Graphs: Learning Coherence Traffic for Task Placement](https://arxiv.org/abs/2607.18879)
...
### [199] [A User-oriented Portable, Reproducible, and Scalable Software Ecosystem](https://arxiv.org/abs/2607.18929)
...
### [200] [InstantInfer: Enabling Fast LLM Cold Start with Communicating Finite Automata](https://arxiv.org/abs/2607.18957)
...
### [201] [Enabling Multi-Dimensional Distributed Trace Comparison with Contrast](https://arxiv.org/abs/2607.19102)
...
### [202] [A Scalable Pattern Mining Workflow for Interpretable Machine Log Analysis in High-Performance Computing Environments](https://arxiv.org/abs/2607.19143)
...
### [203] [Coherence in Control: Bridging Many-Core Mapping and Routing through Cost Unification](https://arxiv.org/abs/2607.19158)
...
### [204] [ARBITER: Guarded Agentic Control for SLO-Oriented Kubernetes Remediation](https://arxiv.org/abs/2607.19182)
...
### [205] [Keeping the Cache Warm Pays: Keepalive Economics for Agentic Workloads](https://arxiv.org/abs/2607.19214)
*Maxim Khailo*
