...
### [19] [No Pedestrian Left Behind: Real-Time Detection and Tracking of Vulnerable Road Users for Adaptive Traffic Signal Control](https://arxiv.org/abs/2604.25887)
...
### [69] [SWE-QA: A Dataset and Benchmark for Complex Code Understanding](https://arxiv.org/abs/2604.24814)
...
### [70] [Programming with Data: Test-Driven Data Engineering for Self-Improving LLMs from Raw Corpora](https://arxiv.org/abs/2604.24819)
...
### [71] [A systematic literature Review for Transformer-based Software Vulnerability detection](https://arxiv.org/abs/2604.24822)
...
### [72] [FGDM: Reasoning Aware Multi-Agentic Framework for Software Bug Detection using Chain of Thought and Tree of Thought Prompting](https://arxiv.org/abs/2604.24831)
...
### [73] [Supporting Belonging in Software Engineering Through Role Models Exposure](https://arxiv.org/abs/2604.25099)
...
### [74] [R$^3$-SQL: Ranking Reward and Resampling for Text-to-SQL](https://arxiv.org/abs/2604.25325)
...
### [75] [Commit-Aware Learning-Based Test Case Prioritization for Continuous Integration](https://arxiv.org/abs/2604.25363)
...
### [76] [CoRE: A Fine-Grained Code Reasoning Benchmark Beyond Output Prediction](https://arxiv.org/abs/2604.25399)
...
### [77] [Recommending Usability Improvements with Multimodal Large Language Models](https://arxiv.org/abs/2604.25420)
...
### [78] [AI as Consumer and Participant: A Co-Design Agenda for MBSE Substrates and Methodology](https://arxiv.org/abs/2604.25526)
*Siyuan Ji*
...
### [79] [An Empirical Analysis of Mobile Energy Consumption Across User Configurations](https://arxiv.org/abs/2604.25587)
*Wellington Oliveira*
...
### [80] [PLMGH: What Matters in PLM-GNN Hybrids for Code Classification and Vulnerability Detection](https://arxiv.org/abs/2604.25599)
...
### [81] [Using Large Language Models for Black-Box Testing of FMU-Based Simulations](https://arxiv.org/abs/2604.25650)
...
### [82] [Spreadsheet Modeling Experiments Using GPTs on Small Problem Statements and the Wall Task](https://arxiv.org/abs/2604.25689)
...
### [83] [Bug-Report-Driven Fault Localization: Industrial Benchmarking and Lesson Learned at ABB Robotics](https://arxiv.org/abs/2604.25700)
...
### [84] [Learning Generalizable Multimodal Representations for Software Vulnerability Detection](https://arxiv.org/abs/2604.25711)
...
### [85] [Can Code Evaluation Metrics Detect Code Plagiarism?](https://arxiv.org/abs/2604.25778)
...
### [86] [SAFEdit: Does Multi-Agent Decomposition Resolve the Reliability Challenges of Instructed Code Editing?](https://arxiv.org/abs/2604.25737)
...
### [87] [Scenario-based System Testing for Distributed Robotics Applications](https://arxiv.org/abs/2604.25772)
...
### [88] [Key Developer Roles and Organizational Coupling in Microservices: A Longitudinal Analysis](https://arxiv.org/abs/2604.25804)
...
### [89] [Does social identity matter in software engineering? Assessing the case of research software engineers](https://arxiv.org/abs/2604.25831)
...
### [90] [RESTestBench: A Benchmark for Evaluating the Effectiveness of LLM-Generated REST API Test Cases from NL Requirements](https://arxiv.org/abs/2604.25862)
...
### [91] [From Threads to Trajectories: A Multi-LLM Pipeline for Community Knowledge Extraction from GitHub Issue Discussions](https://arxiv.org/abs/2604.25880)
...
### [92] [Carbon-Taxed Transformers: A Green Compression Pipeline for Overgrown Language Models](https://arxiv.org/abs/2604.25903)
...
### [93] [Large amplification of the isospin-dependence of proton emitting source size in radioactive heavy-ion collisions: a signal of n-p correlation](https://arxiv.org/abs/2604.25107)
...
### [94] [Chapman-Enskog calculation of the shear viscosity of quark-gluon plasma including all $2\leftrightarrow 2$ scatterings at finite temperature](https://arxiv.org/abs/2604.25059)
...
### [95] [Effect of neutron-proton asymmetry on the $^3$H clustering in Boron isotopes](https://arxiv.org/abs/2604.25104)
...
### [96] [Coulomb Effects and Wigner-SU(4) Symmetry in He-3 Charge and Magnetic Properties](https://arxiv.org/abs/2604.25221)
*Xincheng Lin*
...
Abstract: We propose a neural-network-based variational framework for nuclear Density Functional Theory based on the extended Thomas--Fermi (ETF) model, in which proton and neutron number densities are represented by multilayer perceptrons and determined by direct minimization of a Skyrme-type energy density functional. We clarify the mathematical connection to the conventional Euler--Lagrange formulation, showing that stationarity in parameter space corresponds to a projected Euler--Lagrange condition on the neural-network trial-density manifold. The basic validity of the framework is examined through three sets of calculations: a Woods--Saxon potential benchmark, ground-state calculations of finite nuclei ($^{40}$Ca, $^{90}$Zr, and $^{208}$Pb), and nuclear pasta phases. The binding energies of finite nuclei agree with existing ETF calculations to within $0.5\%$, and representative pasta structures including spheres, rods, and slabs are reproduced. We also find that single-precision arithmetic yields results comparable to double precision, suggesting that the present framework is well suited to GPU environments in which low-precision computation is advantageous.

</details>


### [99] [Exact emulation of few-body systems at low cost](https://arxiv.org/abs/2604.25792)
...
### [100] [Spark Policy Toolkit: Semantic Contracts and Scalable Execution for Policy Learning in Spark](https://arxiv.org/abs/2604.25061)
*Zeyu Bai*
...
### [101] [CacheFlow: Efficient LLM Serving with 3D-Parallel KV Cache Restoration](https://arxiv.org/abs/2604.25080)
...
### [102] [Adaptive Management of Microservices in Dynamic Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2604.25222)
...
### [103] [CUDA Kernel Optimization and Counter-Free Performance Analysis for Depthwise Convolution in Cloud Environments](https://arxiv.org/abs/2604.25422)
...
### [104] [Economical and ecological impact of sector coupling applied to computing clusters](https://arxiv.org/abs/2604.25540)
...
### [105] [Volitional Multiagent Atomic Transactions: Describing People and their Machines](https://arxiv.org/abs/2604.25596)
...
### [106] [A contemporary science map through the lens of IEEE and ACM periodicals](https://arxiv.org/abs/2604.25487)
...
### [107] [Versioned Late Materialization for Ultra-Long Sequence Training in Recommendation Systems at Scale](https://arxiv.org/abs/2604.24806)
...
### [108] [Offline Evaluation Measures of Fairness in Recommender Systems](https://arxiv.org/abs/2604.25032)
...
### [109] [UnIte: Uncertainty-based Iterative Document Sampling for Domain Adaptation in Information Retrieval](https://arxiv.org/abs/2604.25142)
...
### [110] [From Local Indices to Global Identifiers: Generative Reranking for Recommender Systems via Global Action Space](https://arxiv.org/abs/2604.25291)
...
### [111] [Stop Using the Wilcoxon Test: Myth, Misconception and Misuse in IR Research](https://arxiv.org/abs/2604.25349)
*Julián Urbano*
...
### [112] [GeoSearch: Augmenting Worldwide Geolocalization with Web-Scale Reverse Image Search and Image Matching](https://arxiv.org/abs/2604.25390)
...
### [113] [The Attention Market: Interpreting Online Fair Re-ranking as Manifold Optimization under Walrasian Equilibrium](https://arxiv.org/abs/2604.25577)
...
### [114] [Health System Scale Semantic Search Across Unstructured Clinical Notes](https://arxiv.org/abs/2604.25605)
...
### [115] [K-CARE: Knowledge-driven Symmetrical Contextual Anchoring and Analogical Prototype Reasoning for E-commerce Relevance](https://arxiv.org/abs/2604.25683)
...
### [116] [From Citation Selection to Citation Absorption: A Measurement Framework for Generative Engine Optimization Across AI Search Platforms](https://arxiv.org/abs/2604.25707)
...
### [117] [Personalized Multi-Interest Modeling for Cross-Domain Recommendation to Cold-Start Users](https://arxiv.org/abs/2604.25732)
...
### [118] [Harmonizing Generative Retrieval and Ranking in Chain-of-Recommendation](https://arxiv.org/abs/2604.25787)
*Yu Liu,Jiangxia Cao*
...
### [121] [Co-Director: Agentic Generative Video Storytelling](https://arxiv.org/abs/2604.24842)
...
### [122] [Latent Agents: A Post-Training Procedure for Internalized Multi-Agent Debate](https://arxiv.org/abs/2604.24881)
...
### [123] [S-SONDO: Self-Supervised Knowledge Distillation for General Audio Foundation Models](https://arxiv.org/abs/2604.24933)
...
### [124] [Adaptive Prompt Embedding Optimization for LLM Jailbreaking](https://arxiv.org/abs/2604.24983)
...
### [125] [Assessing Y-Axis Influence: Bias in Multimodal Language Models on Chart-to-Table Translation](https://arxiv.org/abs/2604.24987)
...
### [126] [Sparse Personalized Text Generation with Multi-Trajectory Reasoning](https://arxiv.org/abs/2604.24996)
...
### [127] [Toward a Science of Intent: Closure Gaps and Delegation Envelopes for Open-World AI Agents](https://arxiv.org/abs/2604.25000)
...
### [128] [Leverage Laws: A Per-Task Framework for Human-Agent Collaboration](https://arxiv.org/abs/2604.25040)
*Stan Loosmore*
...
### [129] [Evaluating Risks in Weak-to-Strong Alignment: A Bias-Variance Perspective](https://arxiv.org/abs/2604.25077)
...
### [130] [Cooperate to Compete: Strategic Coordination in Multi-Agent Conquest](https://arxiv.org/abs/2604.25088)
...
### [131] [Doing More With Less: Revisiting the Effectiveness of LLM Pruning for Test-Time Scaling](https://arxiv.org/abs/2604.25098)
...
### [132] [Semantic Layers for Reliable LLM-Powered Data Analytics: A Paired Benchmark of Accuracy and Hallucination Across Three Frontier Models](https://arxiv.org/abs/2604.25149)
...
### [133] [Training Transformers as a Universal Computer](https://arxiv.org/abs/2604.25166)
...
### [134] [From Insight to Action: A Novel Framework for Interpretability-Guided Data Selection in Large Language Models](https://arxiv.org/abs/2604.25167)
...
### [135] [DATAREEL: Automated Data-Driven Video Story Generation with Animations](https://arxiv.org/abs/2604.25220)
...
### [136] [ValueAlpha: Agreement-Gated Stress Testing of LLM-Judged Investment Rationales Before Returns Are Observable](https://arxiv.org/abs/2604.25224)
...
### [137] [Action-Aware Generative Sequence Modeling for Short Video Recommendation](https://arxiv.org/abs/2604.25834)
...
### [138] [AutoResearchBench: Benchmarking AI Agents on Complex Scientific Literature Discovery](https://arxiv.org/abs/2604.25256)
...
### [139] [Plausible but Wrong: A case study on Agentic Failures in Astrophysical Workflows](https://arxiv.org/abs/2604.25345)
...
### [140] [Multi-action Tangled Program Graphs for Multi-task Reinforcement Learning with Continuous Control](https://arxiv.org/abs/2604.25369)
...
### [141] [JURY-RL: Votes Propose, Proofs Dispose for Label-Free RLVR](https://arxiv.org/abs/2604.25419)
...
### [142] [PI-TTA: Physics-Informed Source-Free Test-Time Adaptation for Robust Human Activity Recognition on Mobile Devices](https://arxiv.org/abs/2604.25435)
...
### [143] [SciEval: A Benchmark for Automatic Evaluation of K-12 Science Instructional Materials](https://arxiv.org/abs/2604.25472)
...
### [144] [Improving Zero-Shot Offline RL via Behavioral Task Sampling](https://arxiv.org/abs/2604.25496)
...
### [145] [PHISHREV: A Hybrid Machine Learning and Post-Hoc Non-monotonic Reasoning Framework for Context-Aware Phishing Website Classification](https://arxiv.org/abs/2604.25512)
...
### [146] [Automated Adversarial Collaboration for Advancing Theory Building in the Cognitive Sciences](https://arxiv.org/abs/2604.25521)
...
### [147] [Sample-efficient Neuro-symbolic Proximal Policy Optimization](https://arxiv.org/abs/2604.25534)
...
### [148] [DualFact+: A Multimodal Fact Verification Framework for Procedural Video Understanding](https://arxiv.org/abs/2604.25584)
...
### [149] [OxyGent: Making Multi-Agent Systems Modular, Observable, and Evolvable via Oxy Abstraction](https://arxiv.org/abs/2604.25602)
...
### [150] [The Nonverbal Syntax Framework: An Evidence-Based Tiered System for Inferring Learner States from Observable Behavioral Cues](https://arxiv.org/abs/2604.25612)
...
### [151] [HotComment: A Benchmark for Evaluating Popularity of Online Comments](https://arxiv.org/abs/2604.25614)
...
### [152] [Think Before You Act -- A Neurocognitive Governance Model for Autonomous AI Agents](https://arxiv.org/abs/2604.25684)
...
### [153] [RADD: Retrieval-Augmented Discrete Diffusion for Multi-Modal Knowledge Graph Completion](https://arxiv.org/abs/2604.25693)
*Guanglin Niu,Bo Li*
...
### [154] [Scalable Inference Architectures for Compound AI Systems: A Production Deployment Study](https://arxiv.org/abs/2604.25724)
...
### [155] [Toward Scalable Terminal Task Synthesis via Skill Graphs](https://arxiv.org/abs/2604.25727)
...
### [156] [QAROO: AI-Driven Online Task Offloading for Energy-Efficient and Sustainable MEC Networks](https://arxiv.org/abs/2604.25740)
...
### [157] [StratFormer: Adaptive Opponent Modeling and Exploitation in Imperfect-Information Games](https://arxiv.org/abs/2604.25796)
...
### [158] [TrialCalibre: A Fully Automated Causal Engine for RCT Benchmarking and Observational Trial Calibration](https://arxiv.org/abs/2604.25832)
...
### [159] [Semi-Markov Reinforcement Learning for City-Scale EV Ride-Hailing with Feasibility-Guaranteed Actions](https://arxiv.org/abs/2604.25848)
...
### [160] [ADEMA: A Knowledge-State Orchestration Architecture for Long-Horizon Knowledge Synthesis with LLMAgents](https://arxiv.org/abs/2604.25849)
...
### [161] [Recursive Multi-Agent Systems](https://arxiv.org/abs/2604.25917)
...
### [162] [Stochastic and Dynamic Fundamental Diagram for Mixed Traffic](https://arxiv.org/abs/2604.24771)
...
### [163] [A Quantitative Framework for Navigating Controller Design Tradeoffs under Computational Constraints](https://arxiv.org/abs/2604.24897)
...
### [164] [Interval Observer Design Using Observability Decomposition for Detectable Linear Systems](https://arxiv.org/abs/2604.24939)
...
### [165] [A Class AAA Solar Testbed for Reproducible Long-Term Characterization of Energy-Harvesting Systems](https://arxiv.org/abs/2604.24950)
...
### [166] [A Novel Two-Step Approach for Reactive Power Demand Calculation Using Integrated Voltage Stability Analysis](https://arxiv.org/abs/2604.25016)
...
### [167] [On Distributed Control of Continuum Swarms: Local Controllers as Differential Operators](https://arxiv.org/abs/2604.25187)
...
### [168] [Behaviour-aware Hybrid Architecture for Trust-driven Transmissions](https://arxiv.org/abs/2604.25201)
...
### [169] [Distributed adaptive estimation for stochastic large regression models](https://arxiv.org/abs/2604.25468)
...
### [170] [Complex-Vector Power and Cross-Phase Unbalance in Three-Phase Systems](https://arxiv.org/abs/2604.25473)
...
### [171] [Multi-layer barrier adaptation of the discrete-time super-twisting controller](https://arxiv.org/abs/2604.25527)
...
### [172] [Local Shifted Passivity Analysis of the Single-Machine Infinite-Bus System](https://arxiv.org/abs/2604.25738)
*Xinyuan Jiang*
...
### [173] [Backstepping Observer for the Quasilinear Heat Equation with Linear Design Gains: Beyond Local Stability](https://arxiv.org/abs/2604.25815)
