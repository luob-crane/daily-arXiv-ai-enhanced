...
### [3] [TrOCR for Medieval HTR: A Systematic Ablation Study with Cross-Dataset Validation](https://arxiv.org/abs/2606.24302)
...
### [105] [Counting Trees from Satellite Imagery with Noisy Supervision](https://arxiv.org/abs/2606.24786)
...
### [106] [IV-CoT: Implicit Visual Chain-of-Thought for Structure-Aware Text-to-Image Generation](https://arxiv.org/abs/2606.24849)
...
### [107] [Pocket-SLAM: Rendering-Area-Aware Pruning for Memory-Efficient 3DGS-SLAM](https://arxiv.org/abs/2606.24796)
...
### [108] [FLUX3D: High-Fidelity 3D Gaussian Generation with Diffusion-Aligned Sparse Representation](https://arxiv.org/abs/2606.24874)
...
### [117] [Measurements of Bremsstrahlung-Averaged Cross Sections for Reactions on Natural Nickel Targets at Eendpoint = 40MeV](https://arxiv.org/abs/2606.23966)
...
Abstract: Bremsstrahlung activation measurements were performed to study the production of $^{57}\mathrm{Ni}$, $^{56}\mathrm{Ni}$, $^{58}\mathrm{Co}$, $^{57}\mathrm{Co}$, $^{56}\mathrm{Co}$, and $^{55}\mathrm{Co}$ from natural nickel targets irradiated with photons generated by \SI{40}{MeV} electrons incident on a tantalum converter. Bremsstrahlung spectra were modeled using MCNP6.3\texttrademark{} and experimentally validated through activation of natural tin. Bremsstrahlung-averaged cross sections were extracted from end-of-irradiation activities, yielding $\langleσ\rangle = 8.983~\pm~0.028$~mb for $^{58}\mathrm{Ni}(γ,n)^{57}\mathrm{Ni}$, $0.248~\pm~0.025$~mb for $^{58}\mathrm{Ni}(γ,2n)^{56}\mathrm{Ni}$, $0.704~\pm~0.218$~mb for $^{nat}\mathrm{Ni}(γ,pxn)^{58}\mathrm{Co}$, $9.192~\pm~0.386$~mb for $^{58}\mathrm{Ni}(γ,p)^{57}\mathrm{Co}$, and $2.239~\pm~0.355$~mb for $^{58}\mathrm{Ni}(γ,pn)^{56}\mathrm{Co}$. A $90\%$ confidence-level upper limit of $\langleσ\rangle < 0.021$~mb is established for the $^{58}\mathrm{Ni}(γ,p2n)^{55}\mathrm{Co}$ channel. Comparison with JENDL-5 evaluations and prior studies indicates channel-dependent agreement, with residual discrepancies observed for selected charged-particle emission reactions. In particular, the measured $^{58}\mathrm{Ni}(γ,p)^{57}\mathrm{Co}$ cross section exceeds the JENDL-5 prediction by approximately a factor of two, whereas TALYS-2.2 calculations reproduce the experimental value, suggesting an underestimation of the $(γ,p)$ channel strength in JENDL-5 under bremsstrahlung conditions. For the $^{58}\mathrm{Ni}(γ,pn)^{56}\mathrm{Co}$ channel, both TALYS-2.2 and JENDL-5 predictions are in reasonable agreement, while the present measurement is higher by approximately a factor of two, though with larger associated uncertainty.
...
### [118] [As above, so below: assessing extremeness of the neutron-star equation of state based on the unstable branch](https://arxiv.org/abs/2606.23929)
...
### [119] [Understanding the Intermittency Signal in RHIC-STAR Data through Modeling](https://arxiv.org/abs/2606.24436)
...
### [121] [Rethinking the green power grid for stability, not just for climate](https://arxiv.org/abs/2606.23805)
...
### [122] [DISPCA : A hybrid iterative-sequential approach for the identification of errors-in-variables model of linear DAE systems](https://arxiv.org/abs/2606.23886)
...
### [123] [Welfarist Control Design -- How to fulfill the societal mandate in multi-agent control?](https://arxiv.org/abs/2606.23931)
...
### [124] [Flow-Corrected Thompson Sampling for Non-Stationary Contextual Bandits](https://arxiv.org/abs/2606.23933)
...
### [125] [Resilient Substation Design for 500 Year Storm Events Current State of the Art and Challenges for Floodplain Management and Infrastructure Hardening](https://arxiv.org/abs/2606.24065)
...
### [126] [Safe Packetized Control for Stochastic Constrained Networked Systems](https://arxiv.org/abs/2606.24148)
...
### [127] [From Stabilizing Regions to Certified Controllers: Closing the Selection Gap in Unified PID/PI Analysis for Time-Delay Plants](https://arxiv.org/abs/2606.24202)
*Senol Gulgonul*
...
### [128] [Control Based Enhanced Regenerative Modes for Hydraulic Multi-Actuator Systems](https://arxiv.org/abs/2606.24284)
...
### [129] [Data-Driven Robust MPC for Unknown Nonlinear Systems via Set-Membership Learning](https://arxiv.org/abs/2606.24316)
...
### [130] [An Integer Linear Programming Approach for Maximum Power Extraction from Solar PV Plants under Partial Shading](https://arxiv.org/abs/2606.24342)
...
### [131] [Multiplayer Reach-Avoid Differential Games with Defender-Side Information Delay](https://arxiv.org/abs/2606.24542)
...
### [132] [CONDUCTOR: An LLM-Orchestrated Digital Twin for Uncertainty-Aware Distribution Grid Operations](https://arxiv.org/abs/2606.24609)
...
### [133] [Human-Robot Shared Control for Humanized End-Effector Teleoperation](https://arxiv.org/abs/2606.24629)
...
### [134] [Multi-Worker Assembly Line Rebalancing with Relevance-Guided Configuration Preservation](https://arxiv.org/abs/2606.24680)
...
### [135] [RIFT-Bench: Dynamic Red-teaming For Agentic AI Systems](https://arxiv.org/abs/2606.23927)
...
### [136] [Exploring Academic Influence of Algorithms by Co-occurrence Network Based on Full-text of Academic Papers](https://arxiv.org/abs/2606.24099)
...
### [137] [Neuro-Symbolic Drive: Rule-Grounded Faithful Reasoning for Driving VLAs](https://arxiv.org/abs/2606.23938)
...
### [138] [Critique of Agent Model](https://arxiv.org/abs/2606.23991)
...
### [139] [Safe and Generalizable Hierarchical Multi-Agent RL via Constraint Manifold Control](https://arxiv.org/abs/2606.24010)
...
### [140] [Reinforcement Learning Towards Broadly and Persistently Beneficial Models](https://arxiv.org/abs/2606.24014)
...
### [141] [Can Language Model Agents be Helpful Circuit Explainers in Mechanistic Interpretability?](https://arxiv.org/abs/2606.24026)
...
### [142] [Breaking the Filter Bubble: A Semantic Pareto-DQN Framework for Multi-Objective Recommendation](https://arxiv.org/abs/2606.24042)
...
### [143] [Ensemble Feature Selection and Harris Hawks Optimization for Explainable Mental Health Risk Prediction in Female Sex Workers](https://arxiv.org/abs/2606.24047)
...
### [144] [Beyond Trajectory Imitation: Strategy-Guided Policy Optimization for LLM Reasoning](https://arxiv.org/abs/2606.24064)
...
### [145] [ReMMD: Realistic Multilingual Multi-Image Agentic Verification for Multimodal Misinformation Detection](https://arxiv.org/abs/2606.24112)
...
### [146] [VeryTrace: Verifying Reasoning Traces through Compilable Formalism and Structured Verification](https://arxiv.org/abs/2606.24124)
...
### [147] [OmniPath: A Multi-Modal Agentic Framework for Auditing Wheelchair Accessibility](https://arxiv.org/abs/2606.24129)
...
### [148] [Accelerating Disaggregated RL for Visual Generative LLMs with Diffusion-Based Parallelism and Trainer-Assisted Generation](https://arxiv.org/abs/2606.24369)
...
### [149] [T2D-Bench: Evidence-Gated Evaluation of LLM Outputs for Type 2 Diabetes Using a Multi-Layer Clinical-Lifestyle Knowledge Graph](https://arxiv.org/abs/2606.24145)
...
### [150] [The Geometry Behind Diffusion and Flow Matching: Gradient Flows and Geodesics in Wasserstein Space](https://arxiv.org/abs/2606.24157)
...
### [151] [An Introduction to Causal Reinforcement Learning](https://arxiv.org/abs/2606.24160)
...
### [152] [Data Scale, Not Latency, Shapes Cross-Lingual Encoder Transfer in Streaming ASR](https://arxiv.org/abs/2606.24169)
*Nenad Banfic*
...
### [153] [Navigating User Behavior toward Personalized Multimodal Generation](https://arxiv.org/abs/2606.24196)
...
### [154] [Exploring the relationship between human-centric AI and firm idiosyncratic risks](https://arxiv.org/abs/2606.24224)
...
### [155] [FlowR2A: Learning Reward-to-Action Distribution for Multimodal Driving Planning](https://arxiv.org/abs/2606.24231)
...
### [156] [SP-Mind: An Autonomous Reasoning Agent for Spatial Proteomics Analysis](https://arxiv.org/abs/2606.24235)
...
### [157] [Towards Federated Long-Tailed Graph Learning: An Energy-Guided Dual Decoupling Approach](https://arxiv.org/abs/2606.24237)
...
### [158] [Probing the Misaligned Thinking Process of Language Models](https://arxiv.org/abs/2606.24251)
...
### [159] [Tractable Reasoning and Conjunctive Query Answering for Defeasible DL-Lite under Rational Closure](https://arxiv.org/abs/2606.24279)
...
### [160] [LemonHarness Technical Report](https://arxiv.org/abs/2606.24311)
...
### [161] [Prob-BBDM: a Probabilistic Brownian Bridge Diffusion Model for MRI sequence image-to-image translation](https://arxiv.org/abs/2606.24313)
...
### [162] [MVG-KAN: Multi-View Geo-Wind Guided KAN for PM$_{2.5}$ Forecasting](https://arxiv.org/abs/2606.24347)
...
### [163] [When Helpfulness Overrides Causal Caution: Context-Dependent Suppression and Recovery in LLMs](https://arxiv.org/abs/2606.24370)
*Hiroshi Okumura*
...
### [164] [PHANTOM: A Large-Scale Dataset of Multimodal Adversarial Attacks for Vision-Language Models](https://arxiv.org/abs/2606.24388)
...
### [165] [Age of LLM: A Strategic 1v1 Benchmark for Reasoning, Diplomacy and Reliability of Large Language Models under Fog of War](https://arxiv.org/abs/2606.24391)
*Arnaud Ricci*
...
### [166] [ATRIA: Adaptive Traceable ECG Reporting with Iterative Agents](https://arxiv.org/abs/2606.24392)
...
### [167] [Cycle-Consistent Neural Explanation of Formal Verification Certificates](https://arxiv.org/abs/2606.24414)
...
### [168] [Agentic AI for Bilevel Long-Term Optimization of Policy-Driven Physical Layer Systems](https://arxiv.org/abs/2606.24416)
...
### [169] [Can Aggregate Invariants Accelerate Continuous Subgraph Matching? Limits, Laws, and a Dynamic Spectral Index](https://arxiv.org/abs/2606.24421)
...
### [170] [ReM-MoA: Reasoning Memory Sustains Mixture-of-Agents Scaling](https://arxiv.org/abs/2606.24437)
...
### [171] [Bayesian control for coding agents](https://arxiv.org/abs/2606.24453)
...
### [172] [CompressKV: Semantic-Retrieval-Guided KV-Cache Compression for Resource-Efficient Long-Context LLM Inference](https://arxiv.org/abs/2606.24467)
...
### [173] [The Latent Bridge: A Continuous Slow-Fast Channel for Real-Time Game Agents](https://arxiv.org/abs/2606.24470)
*Bojie Li,Noah Shi*
...
### [174] [On the Smallness of the Large Language Models Scaling Exponents](https://arxiv.org/abs/2606.24504)
...
### [175] [A specialized reasoning large language model for accelerating rare disease diagnosis: a randomized AI physician assistance trial](https://arxiv.org/abs/2606.24510)
...
### [176] [Reinforcement Learning for Computer-Use Agents with Autonomous Evaluation](https://arxiv.org/abs/2606.24515)
...
### [177] [Governed Shared Memory for Multi-Agent LLM Systems](https://arxiv.org/abs/2606.24535)
...
### [178] [GUI vs. CLI: Execution Bottlenecks in Screen-Only and Skill-Mediated Computer-Use Agents](https://arxiv.org/abs/2606.24551)
...
### [179] [Quant Convergence: Bridging Classical Value Investing and Modern Factor Models for Systematic Equity Selection](https://arxiv.org/abs/2606.24575)
...
### [180] [LLMs Prompted for Legal Context Object More: Overrefusal from Small On-Premises LLMs in Criminal Legal Context](https://arxiv.org/abs/2606.24585)
...
### [181] [AdversaBench: Automated LLM Red-Teaming with Multi-Judge Confirmation and Cross-Model Transferability](https://arxiv.org/abs/2606.24589)
*Khanak Khandelwal*
...
### [182] [ASALT: Adaptive State Alignment for Lateral Transfer in Multi-agent Reinforcement Learning](https://arxiv.org/abs/2606.24601)
...
### [183] [Uncertainty-Aware Longitudinal Forecasting of Alzheimer's Disease Progression Using Deep Learning](https://arxiv.org/abs/2606.24604)
...
### [184] [ScaleToT: Generalizing Structured LLM Reasoning for Billion-Scale Low-Activity User Modeling](https://arxiv.org/abs/2606.24605)
...
### [185] [AI Tokenomics: The Economics of Tokens, Computation, and Pricing in Foundation Models](https://arxiv.org/abs/2606.24616)
*Quanyan Zhu*
...
### [186] [Abstractions of Queries in Ontology-Based Data Access](https://arxiv.org/abs/2606.24618)
...
### [187] [When CQs Go Wrong: Challenges in CQ Verification with OE-Assist](https://arxiv.org/abs/2606.24619)
...
### [188] [Themis: An explainable AI-enabled framework for Reinforcement Learning with Human Feedback](https://arxiv.org/abs/2606.24622)
...
### [189] [SAFARI: Scaling Long Horizon Agentic Fault Attribution via Active Investigation](https://arxiv.org/abs/2606.24626)
...
### [190] [CineCap: Structured Reasoning with Spatio-Temporal Anchors for Cinematographic Video Captioning](https://arxiv.org/abs/2606.24636)
...
### [191] [LaGO: Latent Action Guidance for Online Reinforcement Learning](https://arxiv.org/abs/2606.24669)
...
### [192] [Cost-Optimal Decision Diagrams for Stochastic Boolean Function Evaluation](https://arxiv.org/abs/2606.24672)
...
### [193] [Decentralised AI Training and Inference with BlockTrain](https://arxiv.org/abs/2606.24722)
*Peter Toth*
...
### [194] [Scaling Laws for Task-Specific LLM Distillation](https://arxiv.org/abs/2606.24747)
...
### [195] [Can Scale Save Us From Plasticity Loss in Large Language Models?](https://arxiv.org/abs/2606.24752)
...
### [196] [BluTrain: A C++/CUDA Framework for AI Systems](https://arxiv.org/abs/2606.24780)
...
### [198] [Solving Inverse Problems of Chaotic Systems with Bidirectional Conditional Flow Matching](https://arxiv.org/abs/2606.24824)
...
### [199] [Difference-Making without Making a Difference](https://arxiv.org/abs/2606.24832)
*Sander Beckers*
...
### [200] [Accuracy and Satisfaction in Multi-Turn LLM Dialogues for NFR Assessment](https://arxiv.org/abs/2606.24834)
...
### [201] [Grading the Grader: Lessons from Evaluating an Agentic Data Analysis System](https://arxiv.org/abs/2606.24839)
...
### [202] [Matching Tasks to Objectives: Fine-Tuning and Prompt-Tuning Strategies for Encoder-Decoder Pre-trained Language Models](https://arxiv.org/abs/2606.24841)
...
### [203] [World Models in Pieces: Structural Certification for General Agents](https://arxiv.org/abs/2606.24842)
...
### [204] [OpenThoughts-Agent: Data Recipes for Agentic Models](https://arxiv.org/abs/2606.24855)
...
### [205] [Memory Layouts for GPU-Data Transfer Buffering in SPH](https://arxiv.org/abs/2606.23891)
...
### [206] [An Efficient Construction of Completely Independent Spanning Trees in Dense Gaussian Networks](https://arxiv.org/abs/2606.23935)
...
### [207] [The Serialized Bridge: Understanding and Recovering LLM Serving Performance under Blackwell GPU Confidential Computing](https://arxiv.org/abs/2606.23969)
*Hang Yin,Kevin Wang*
...
### [208] [Hash Table Design for RDMA:Challenges and Opportunities](https://arxiv.org/abs/2606.24073)
...
### [209] [Aquifer: Hierarchical Memory Pooling with CXL and RDMA for MicroVM Snapshots](https://arxiv.org/abs/2606.24079)
...
### [210] [Semi-asynchronous Federated Learning in Flower: Framework Extension and Performance Assessment](https://arxiv.org/abs/2606.24230)
...
### [211] [Semantic Lock: Synchronization Based on the Analysis of the Operation Conflict Graph](https://arxiv.org/abs/2606.24250)
...
### [212] [BiJuTy: An Interactive HPC-Aware Big Data Cluster Lifecycle Manager and Performance Assessment Utility for JupyterHub](https://arxiv.org/abs/2606.24412)
...
### [213] [cuSBF: A Minimizer-Aware Bloom Filter for Genomic Sequence Data on Modern GPUs](https://arxiv.org/abs/2606.24417)
...
### [214] [CrossPool: Efficient Multi-LLM Serving for Cold MoE Models through KV-Cache and Weight Disaggregation](https://arxiv.org/abs/2606.24506)
...
### [215] [Unified Position-Invariant Random Access Through Two Compression Layers via Absolute-Offset Coordinates: A Bit-Perfect Device-Resident Proof](https://arxiv.org/abs/2606.24531)
*Yakiv Shavidze*
...
### [216] [Solvability of Approximate Agreement on Graphs and Simplicial Complexes](https://arxiv.org/abs/2606.24666)
...
### [217] [A Natively Blocked, Device-Resident Algebraic Multigrid GPU Path in PETSc](https://arxiv.org/abs/2606.24748)
*Mark F. Adams*
...
### [218] [Beyond the Autoregressive Horizon: A Comprehensive Survey of Diffusion Models, World Modelling, and State Space Models for Code](https://arxiv.org/abs/2606.23690)
...
### [219] [From Heuristics to Transformers: A Comprehensive Survey of Type Inference from Stripped Binaries](https://arxiv.org/abs/2606.23692)
...
### [220] [Privacy Engineering: A Systematic Literature Review](https://arxiv.org/abs/2606.23696)
...
### [221] [SemChunk-C: Semantic Segmentation for C Code](https://arxiv.org/abs/2606.23697)
...
### [222] [A Unified Framework for Runtime Verification and Model-Based Diagnosis in LOLA](https://arxiv.org/abs/2606.23720)
...
### [223] [ESAA-Conversational: An Event-Sourced Memory Layer for Continuity, Handoff, and Curation Across Heterogeneous LLM Coding Agents](https://arxiv.org/abs/2606.23752)
...
### [224] [From Task-Guided Conversational Graphs to Goal-Oriented Dialogue Runtimes](https://arxiv.org/abs/2606.23797)
...
### [225] [JupOtter: Cell-Level Bug Detection in Jupyter Notebooks](https://arxiv.org/abs/2606.23877)
...
### [226] [Domain-Driven Design in Practice: A Mining Study of Maintenance and Evolution in Open-Source Repositories](https://arxiv.org/abs/2606.23984)
...
### [227] [Collaborative and AI-Supported Requirements Elicitation: An Empirical Study](https://arxiv.org/abs/2606.24060)
...
### [228] [Agon: An Autonomous Large-Scale Omnidisciplinary Research System Built on Prompt Economy](https://arxiv.org/abs/2606.24177)
...
### [229] [AutoSpec: Safety Rule Evolution for LLM Agents via Inductive Logic Programming](https://arxiv.org/abs/2606.24245)
...
### [230] [Architecting Hybrid Quantum-Classical Software Systems: Exploration of the Design Trade-off Space with Quantitative Guarantees](https://arxiv.org/abs/2606.24260)
...
### [231] [Detecting AI Coding Agents in Open Source: A Validated Multi-Method Census of 180 Million Repositories](https://arxiv.org/abs/2606.24429)
...
### [232] [Agentic Generation of AST Transformation Rules for Fixing Breaking Updates](https://arxiv.org/abs/2606.24446)
...
### [233] [Toward Self-Evolution-Ready Workflow Harnesses: A Reversible Migration Path and Convertibility Taxonomy for Expert LLM Pipelines](https://arxiv.org/abs/2606.24598)
...
### [234] [Automated Summarization of Software Documents: An LLM-based Multi-Agent Approach](https://arxiv.org/abs/2606.24689)
...
### [235] [Bit-Precise Conformance Testing of Simulink Model Checkers](https://arxiv.org/abs/2606.24719)
...
### [236] [Two-Level vs. Multi-Level Modelling: An Empirical Study of Cascading Maintenance Burden](https://arxiv.org/abs/2606.24721)
...
### [237] [MANGO: Automated Multi-Agent Test Oracle Generation for Vision-Language-Action Models](https://arxiv.org/abs/2606.24815)
...
### [238] [EvidenceLens: A Claim-Evidence Matrix for Auditing Financial Question Answering](https://arxiv.org/abs/2606.23724)
...
### [239] [INSPIRE: Intent-aware Neural Sponsored Product Retrieval for E-commerce](https://arxiv.org/abs/2606.23889)
...
### [240] [Scaling Dense Retrieval with LLM-Annotated Training Data: Structured Mining and Progressive Curriculum for E-Commerce Sponsored Search](https://arxiv.org/abs/2606.23911)
...
### [241] [Unified Multi-Task Relevance Modeling for E-Commerce: Comparing Task Routing Architectures Across LLMs and Cross-Encoders](https://arxiv.org/abs/2606.23919)
...
### [242] [ChartWalker: Benchmarking the Cross-Chart RAG Task](https://arxiv.org/abs/2606.23997)
...
### [243] [Dialogue to Discovery: Attribute-Aware Preference Elicitation for Conversational Product Search Assistants](https://arxiv.org/abs/2606.24194)
...
### [244] [PETRA: Transforming Web Text for Petroleum-Engineering Domain Adaptation](https://arxiv.org/abs/2606.24346)
...
### [245] [Is Higher Team Gender Diversity Correlated with Better Scientific Impact?](https://arxiv.org/abs/2606.24098)
