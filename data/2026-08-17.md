...
### [68] [Do AI chatbots find what experts would? Effects of model, user role, and sample size on study retrieval for medical questions](https://arxiv.org/abs/2608.13786)
...
### [69] [AdsWorldEngine: A Self-Evolving Conversational Advertising Agent through Orchestrator and Tool Coevolution](https://arxiv.org/abs/2608.13833)
...
### [70] [Predicting Custom-Feed Returns for New Bluesky Posts: A Prospective Study](https://arxiv.org/abs/2608.13874)
...
### [71] [How retriever redundancy and diversity impact RAG effectiveness](https://arxiv.org/abs/2608.13956)
...
### [72] [EchoRec: Multi-Item Prediction-Empowered Generative Recommendation via Cycle-Consistent Preference Alignment](https://arxiv.org/abs/2608.14011)
...
### [73] [HAM-RAG: Hierarchy-Aware Multimodal RAG for Structure-Faithful Interleaved Generation](https://arxiv.org/abs/2608.14032)
...
### [74] [TenderKG](https://arxiv.org/abs/2608.14066)
...
### [75] [MACS: A Hybrid Multi-Agent Framework for Reliable Conversational E-Commerce Recommendation](https://arxiv.org/abs/2608.14068)
...
### [76] [PriCoRec: A Privacy-Aware Cloud-Device Collaborative Framework for Ad Recommendation under Feature Constraints](https://arxiv.org/abs/2608.14429)
...
### [77] [Role of the $δ$ Meson in Softening the Symmetry Energy within the DDRHF Model](https://arxiv.org/abs/2608.13902)
...
### [78] [Bayesian inference of event-by-event collision geometry from charged-particle multiplicity in heavy-ion collisions](https://arxiv.org/abs/2608.14045)
...
### [79] [Neural network maximum entropy framework for distribution reconstruction in heavy-ion collisions](https://arxiv.org/abs/2608.14056)
...
### [80] [Enhancement of alpha-decay by positive hexadecapole deformation](https://arxiv.org/abs/2608.14202)
...
### [82] [Balancing Workload Performance and Slurm Stress: Four Nextflow Deployment Strategies](https://arxiv.org/abs/2608.13824)
...
### [83] [Could Model Partitioning Make Federated Learning More Sustainable?](https://arxiv.org/abs/2608.14242)
...
### [84] [Large-scale workflow placement in serverless computing using integer nonlinear programming](https://arxiv.org/abs/2608.14427)
...
### [85] [Validating LLM-Modernized Scientific Software Through Differential Fault Injection](https://arxiv.org/abs/2608.14527)
...
### [86] [Consistent Model Chasing Is Minimax Optimal: The Exact Value of Scalar Adversarial Adaptive Control under Large Parametric Uncertainty](https://arxiv.org/abs/2608.13651)
*Dimitar Ho*
...
### [87] [Control Barrier--Value Functions under Partial Observability: Safety Guarantees via Conformal Prediction](https://arxiv.org/abs/2608.13819)
...
### [88] [Hierarchical Sensor-Spoofing Defence Framework for Networked DC Microgrids via Cyber-Physical Coordination](https://arxiv.org/abs/2608.13823)
...
### [89] [Real-Time In-Domain Congestion Control for the LWR Traffic Model via Control Barrier Functions](https://arxiv.org/abs/2608.13841)
...
### [90] [Feedback-Guided DNN-Based Controller Fusion for Robust Fixed-Parameter Active Noise Control](https://arxiv.org/abs/2608.14061)
...
### [91] [A Temporal Barrier Framework for Collision Avoidance in Multi-Agent Autonomous Aerial Vehicles](https://arxiv.org/abs/2608.14239)
...
### [92] [Diagonalizable Directed Laplacians by Positive Arc-Weight Design for Master Stability Analysis](https://arxiv.org/abs/2608.14439)
...
### [93] [Optimal Scheduling of Road Maintenance Jobs Considering Impact on Traffic Flows](https://arxiv.org/abs/2608.14491)
...
### [94] [Fine-Tuning Qwen3-27B for C-to-Rust Code Translation: A Three-Stage Curriculum of Pretraining, Debugging-Aware SFT, and Task-Specific SFT](https://arxiv.org/abs/2608.13681)
...
### [95] [Building AI-Intensive Software with AI: Early Results and a Cautionary Tale on Measuring Development Cost](https://arxiv.org/abs/2608.13730)
...
### [97] [Engineering Reliable Coding Agents: Evaluating and Operating the System Around the Model](https://arxiv.org/abs/2608.13867)
*Stephanie Jarmak*
...
### [98] [Engineering Signals of Human-AI Collaboration in the Agentic Coding Era: A Longitudinal Analysis of 33,228 Pull Requests from vLLM and SGLang with Implications for Biomedical AI Agents and Bioinformatics Pipeline Developmen](https://arxiv.org/abs/2608.13884)
...
### [99] [Rethinking Automated Program Repair: The Impact of Bug Complexity, Fault Localization, and LLM Cost-efficiency](https://arxiv.org/abs/2608.14065)
...
### [100] [DepWareTrans: Dependency-Aware Incremental Repository Migration across Co-executable Languages](https://arxiv.org/abs/2608.14128)
...
### [101] [LegacyWorld: Atomicity-Aware Evaluation of GUI Agents for Legacy Workflows](https://arxiv.org/abs/2608.14131)
...
### [102] [Breaking Models to Test the Judge: A Mutation Testing Approach for Semantic Evaluators of Domain Class Diagrams](https://arxiv.org/abs/2608.14315)
...
### [103] [ATLAS: Discovering Agent Strategies through LLM-Guided Abstraction and Automata Learning](https://arxiv.org/abs/2608.14352)
...
### [104] [A dataset of article processing charges from 14 scholarly publishers, 2019-2025](https://arxiv.org/abs/2608.14116)
*Lisa Matthias,Diego Chavarro,Eric Schares,Juan Pablo Alperin,Margaret Rose,Molly Frost,Flavia Camargo,Jonas Höfting,Leigh-Ann Butler,Nina Schönfelder,Stefanie Haustein*
...
### [105] [Observing the effects of numbers of valence nucleons on $0_{gs}^+ \rightarrow 2_1^+$ transitions in deformed nuclei by comparing proton and neutron transition matrix elements](https://arxiv.org/abs/2608.13893)
...
### [106] [Extraction of Neutron-Skin Parameters in Zr+Zr and Ru+Ru Collisions at $\sqrt{s_{\text{NN}}}$ = 200 GeV](https://arxiv.org/abs/2608.13935)
...
### [107] [Inducing Reward-Free Judging Rubrics that Reduce Over-Crediting in Agent Evaluation](https://arxiv.org/abs/2608.13564)
...
### [108] [Depth-Aware Sensitivity Analysis of Mixture-of-Experts Models via Magnitude-Based Expert Masking](https://arxiv.org/abs/2608.13565)
...
### [112] [A Pathway to General-Purpose Scientific AI: Multimodal Comprehension of Scientific Images](https://arxiv.org/abs/2608.14075)
...
### [120] [Sensor-Driven Mission Synthesis for UAV/UGV Swarms: A TB-CSPN Coordination Architecture with Hardware-Enforced Safety](https://arxiv.org/abs/2608.14306)
...
### [121] [Evaluating Agentic Learning Harness Capabilities Without Labels via the Scaling Hypothesis](https://arxiv.org/abs/2608.13608)
...
### [122] [Content Depth Matters in Short-Video Recommendation: Rethinking the Attention Economy](https://arxiv.org/abs/2608.13990)
...
### [123] [SemPlan: Benchmarking Structured Semantic Planning for LLM-Based Queries over Enterprise Data](https://arxiv.org/abs/2608.13612)
...
### [124] [Residual Dominance as a Structural Account of Last-Item Reliance in Causal Self-Attention Recommenders](https://arxiv.org/abs/2608.14021)
...
### [127] [Algorithm Design and Physician Liability](https://arxiv.org/abs/2608.13618)
...
### [149] [Simulation-Driven Vehicular Traffic Data Augmentation: Extending Sensor Coverage Through Virtual Sensing](https://arxiv.org/abs/2608.13993)
...
### [150] [Buy the Rumor, Sell the News: When Is News Priced In?](https://arxiv.org/abs/2608.14014)
...
### [184] [LLMs Don't Pay for the Jump](https://arxiv.org/abs/2608.14397)
...
### [193] [Split the Labor: Separating Evidence Interpretation from Decision Aggregation](https://arxiv.org/abs/2608.14509)
*Zhelun Wu*
...
### [194] [Participatory Moral AI Is Not Neutral: The Invisible Hand of Developers](https://arxiv.org/abs/2608.14522)
...
### [195] [Handover of In-Context Learning State Across Session Boundaries](https://arxiv.org/abs/2608.14528)
