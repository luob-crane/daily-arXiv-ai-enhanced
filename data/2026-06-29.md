...
### [35] [Improving Adversarial Robustness via Activation Amplification and Attenuation](https://arxiv.org/abs/2606.27784)
...
### [38] [Hippocampus-DETR: An Explicit Memory Object Detection Framework Based on Hippocampus Modeling](https://arxiv.org/abs/2606.27831)
...
### [50] [TRUST: Efficient Abdominal Trauma Recognition via Image-to-Ultrasound-Video Transfer Learning](https://arxiv.org/abs/2606.27777)
...
### [52] [MindFlow: Harmonizing Cognitive Semantics and Acoustic Dynamics for Facial Animation Generation in Dyadic Conversations](https://arxiv.org/abs/2606.27779)
...
### [55] [Text as Illumination: Spatial Contrastive Retinex Learning for Language-guided Medical Image Segmentation](https://arxiv.org/abs/2606.27794)
...
### [57] [Scalable and Differentiable Point-Cloud Registration Using Maximum Mean Discrepancy](https://arxiv.org/abs/2606.27818)
...
### [58] [BiDeMem: Bidirectional Degradation Memory for Explainable Image Restoration](https://arxiv.org/abs/2606.28112)
...
### [59] [Video-MME-Logical: A Controlled Diagnostic Benchmark for Video Temporal-Logical Reasoning](https://arxiv.org/abs/2606.27828)
...
### [60] [PhysisForcing: Physics Reinforced World Simulator for Robotic Manipulation](https://arxiv.org/abs/2606.28128)
...
### [91] [Multiplicity dependence of the size of the common hadron emission source in pp collisions at the LHC](https://arxiv.org/abs/2606.28098)
*ALICE Collaboration*
...
### [92] [CalBrief: A Pilot Diagnostic Benchmark for Evidence-Calibrated Scientific Briefing with Large Language Models](https://arxiv.org/abs/2606.27383)
...
### [93] [A General Pipeline for Digesting Scientific Literature into a Shared Scientific Knowledge Base](https://arxiv.org/abs/2606.27384)
*Charles T. Black*
...
### [94] [Agentic Publication Protocol: An Attempt to Modernize Scientific Publication](https://arxiv.org/abs/2606.27386)
...
### [95] [Forecasting Technological Directions in Wireless Networks and Mobile Computing via AutoML Framework](https://arxiv.org/abs/2606.27394)
...
### [96] [How is Latin America engaging with responsible metrics? A systematic review comparing regional and global scientific production](https://arxiv.org/abs/2606.27395)
*Daniela Oyarzún-Cristi,Álvaro Cabezas-Clavijo,Alicia Moreno-Delgado*
...
### [98] [MathModDB: A Database for Mathematical Models](https://arxiv.org/abs/2606.27933)
*Jochen Fiedler,Christine Biedinger,Marco Reidelbach,Björn Schembera,Burkhard Schmidt,Aurela Shehu,Thomas Koprucki*
...
### [100] [Test-Input Generation for Tensor Programs: What Actually Finds Kernel Bugs](https://arxiv.org/abs/2606.27396)
*Dipankar Sarkar*
...
### [101] [Implementing GenAI-Supported Learning in Software Engineering and Computer Science Education using Bloom's Taxonomy](https://arxiv.org/abs/2606.27398)
...
### [102] [Formal Grammars in Business Process Management: A Systematic Literature Review](https://arxiv.org/abs/2606.27399)
...
### [103] [Recall Before Rerank: Benchmarking Deep Learning Models for Large-Scale Code-to-Code Retrieval](https://arxiv.org/abs/2606.27401)
...
### [104] [Towards Evaluation of Implicit Software World Models in Coding LLMs](https://arxiv.org/abs/2606.27406)
...
### [105] [Speculative Refinement: A Hybrid Autoregressive Diffusion Decoding Strategy and Its Behavior Across Benchmarks](https://arxiv.org/abs/2606.27474)
...
### [106] [Contextual Associations Between Webpage Elements for Web Accessibility: An Empirical Study](https://arxiv.org/abs/2606.27506)
...
### [107] [Test Case Selection for Deep Neural Networks: A Replication Study on LLMs for Code](https://arxiv.org/abs/2606.27601)
...
### [108] [LLM-Assisted Model-Based GUI Testing for Vue.js Web Applications](https://arxiv.org/abs/2606.27665)
...
### [109] [BashCoder-R1: Towards Robust and Explainable Bash Code Generation with Robustness-Aware Group Relative Policy Optimization](https://arxiv.org/abs/2606.27733)
...
### [110] [UNICS: Multilingual Code Search via Unified Pseudocode and Contrastive Transfer Learning](https://arxiv.org/abs/2606.27747)
...
### [111] [Reasoning Beyond Prediction: From Data-Driven to Causal Software Engineering](https://arxiv.org/abs/2606.27960)
...
### [112] [Evolution-Aware Regression Test Prioritization of ML-Enabled Systems Using Gradient-Based Behavior Vectors](https://arxiv.org/abs/2606.28037)
...
### [113] [SBridge: Identifying Source-to-Binary Function Similarity via Cross-Domain Control Block Matching](https://arxiv.org/abs/2606.28058)
...
### [114] [The ARDoCo Tool Landscape: REST API, TraceView, and TraceViz for Architecture Traceability](https://arxiv.org/abs/2606.28064)
...
### [115] [How Humans, Bots, and Agents Communicate About Vulnerabilities in Pull Requests](https://arxiv.org/abs/2606.28125)
...
### [116] [CrossLangFuzzer: Differential Testing of Cross-Language JVM Compilers](https://arxiv.org/abs/2606.28132)
...
### [117] [Humanizing Automatically Generated Unit Test Suites with LLM-Based Refactoring](https://arxiv.org/abs/2606.28229)
...
### [118] [Govern the Repository, Not the Agent: Measuring Ecosystem-Level Risk in AI-Native Software](https://arxiv.org/abs/2606.28235)
*Daniel Russo*
...
### [119] [How far does a random forest generalize from a 54-run LAMMPS+SPICA benchmark?](https://arxiv.org/abs/2606.27695)
...
### [120] [Lightweight Multi-Vehicle Collaborative Perception Acceleration with Fusion Position Adjustment](https://arxiv.org/abs/2606.27750)
...
### [121] [Optimizing Teacher-Student Partitioning for Scalable Knowledge Distillation on HPC Systems](https://arxiv.org/abs/2606.27797)
...
### [122] [RAMSES: Secure high-performance computing for sensitive data](https://arxiv.org/abs/2606.27919)
...
### [123] [DataStates-LLM: Scalable Checkpointing for Transformer Models Using Composable State Providers](https://arxiv.org/abs/2601.16956)
...
### [124] [Single- and Double-$Λ$ Hypernuclear Correlations Calibrate $ΛΛ$ Interaction Energies](https://arxiv.org/abs/2606.27541)
...
Abstract: Double-$Λ$ hypernuclei are essential for probing the $ΛΛ$ interaction in the double-strangeness $S=-2$ sector, yet the scarcity of experimental data severely limits systematic predictions. We present an evaluation framework based on nuclear many-body theory that exploits the intrinsic structural similarity between single-$Λ$ and double-$Λ$ systems to transfer empirical constraints from the well-mapped $S = -1$ sector to the $S = -2$ sector. By analyzing theoretical deviations of binding energies in light single- and double-$Λ$ hypernuclei, we identify a robust linear correlation between two sectors. This correlation enables a statistical evaluation of double-$Λ$ separation energies ($B_{ΛΛ}$) and $ΛΛ$ interaction energies ($ΔB_{ΛΛ}$) for heavier double-$Λ$ hypernuclei, by drawing on a wealth of empirical data from the single-$Λ$ sector with quantified uncertainties. Our results show that evaluated $ΔB_{ΛΛ}$ values, while consistent with existing data, are systematically larger than direct relativistic density functional predictions constrained only by the NAGARA event. This discrepancy suggests that standard mean-field-based extrapolations may underestimate $ΛΛ$ correlations and other many-body effects, motivating an evaluation-based correction that offers crucial benchmarks for future $S = -2$ experiments at facilities such as HIAF and J-PARC.

</details>


### [125] [Oblate-prolate shape mixing and E0 transition in 28Si](https://arxiv.org/abs/2606.27631)
...
### [127] [Efficient calculation of two-neutrino double-beta-decay nuclear matrix elements](https://arxiv.org/abs/2606.28224)
*Mihai Horoi*
...
### [130] [A Sensitivity-Aware Test Collection for Search Among Personal Information](https://arxiv.org/abs/2606.27559)
...
### [131] [Intuition-Guided Latent Reasoning for LLM-Based Recommendation](https://arxiv.org/abs/2606.27684)
...
### [132] [Bifocal Diffusion Language Models: Asymmetric Bidirectional Context for Parallel Generation](https://arxiv.org/abs/2606.27732)
...
### [133] [End-to-End Dynamic Sparsity for Resource-Adaptive LLM Inference](https://arxiv.org/abs/2606.27743)
...
### [134] [From Bootstrapping to Sequence Modeling: A Unified Generative Framework for Personalized Landing-Page Modeling](https://arxiv.org/abs/2606.27865)
...
### [135] [An LLM-Powered Semantic Alignment Framework for Journal Recommendation](https://arxiv.org/abs/2606.27930)
...
### [136] [Listwise Explanation of Embedding-Based Rankings via Semantic Chunk Grouping](https://arxiv.org/abs/2606.27980)
...
### [137] [Fast and Feasible: Permutation-based Constrained Reranking for Revenue Maximization](https://arxiv.org/abs/2606.28059)
...
### [155] [AI-Driven Synthesis for High-Tech System Design: Automating Innovation](https://arxiv.org/abs/2606.28126)
...
### [158] [Comparison of Non-Deterministic Nonlinear Systems](https://arxiv.org/abs/2606.27464)
...
### [159] [Threshold Optimization and Dynamic Adaptation of Distributed Optimal Power Flow in 5G Networks](https://arxiv.org/abs/2606.27542)
...
### [160] [Real-Time State Estimation in Smart Grids over 5G Networks: Experimental Validation Using Raspberry Pis and Typhoon HIL](https://arxiv.org/abs/2606.27642)
...
### [161] [Characterizing Driver Interactions with Autonomous Vehicles via Response Maps](https://arxiv.org/abs/2606.27656)
...
### [162] [A Bi-Layer TSN Formulation for Separable Scheduling of Mobile Emergency Resources](https://arxiv.org/abs/2606.27712)
...
### [163] [Bearing-based Circumnavigation with Collision Avoidance in Time-varying Graphs under Limited Target Information](https://arxiv.org/abs/2606.27719)
...
### [164] [Repair-before-veto control for safe lithium-ion fast charging under unknown ambient and cooling-fault conditions](https://arxiv.org/abs/2606.27781)
*Yifan Wang*
...
### [165] [From Detection to Action: Using LLM Agents for Fault-Tolerant Control](https://arxiv.org/abs/2606.28011)
...
### [166] [Decentralized Stability of IBR-dominated Power Grids Using Block Diagonal Dominance](https://arxiv.org/abs/2606.28023)
...
### [167] [Effects of motion cueing on longitudinal acceleration perception in a driving simulator](https://arxiv.org/abs/2606.28055)
...
### [168] [Specification-aware Robustness Margins for Symbolic Controllers](https://arxiv.org/abs/2606.28143)
...
### [169] [PAC-Bayesian Certificates for Quadratic Closed-Loop Control](https://arxiv.org/abs/2606.28281)
*Domagoj Herceg*
