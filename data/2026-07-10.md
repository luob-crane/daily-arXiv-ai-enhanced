...
### [84] [From Prompts to Contracts: Harness Engineering for Auditable Enterprise LLM Agents](https://arxiv.org/abs/2607.08028)
...
### [86] [Workflow as Knowledge: Semantic Persistence for LLM-Mediated Workflows](https://arxiv.org/abs/2607.08740)
...
### [87] [Persona Cartography: Charting Language Model Personality Traits in Weight Space](https://arxiv.org/abs/2607.07916)
...
### [88] [Evaluating the Effect of Frame Rate in Sequence-Based Classification of Autism-Related Self-Stimulatory Hand Idiosyncrasies](https://arxiv.org/abs/2607.07957)
...
### [89] [Agentic Neural Architecture Search](https://arxiv.org/abs/2607.07984)
...
### [90] [Concretized Proposition Prompting Resolves Composition-Knowledge Dichotomy in Large Language Models](https://arxiv.org/abs/2607.08018)
...
### [129] [Neutral pion momentum in hypertriton mesonic decay through a root-finding method](https://arxiv.org/abs/2607.07928)
*Emile Meoto*
...
Abstract: A root-finding method is used to study two-body mesonic decay in the hypertriton. We validate this Newton--Raphson root-finding approach by applying it to the negative-pion decay channel ($^{3}_Λ\mathrm{H} \rightarrow {}^{3}\mathrm{He} + π^{-}$), for which the pion momentum and lambda binding energy were recently reported by MAMI A1 Collaboration as $p_{π^-} = 113.789 \pm 0.020_{\text{stat.}} \pm 0.112_{\text{syst.}} \text{ MeV}/c$ and $B_Λ = 0.523 \pm 0.013_{\text{stat.}} \pm 0.075_{\text{syst.}}$ MeV, respectively. Using their reported $Λ$ binding energy, the root-finding method and an exact kinematic formula both yield $p_{π^{-}} = 113.790$ MeV/$c$, agreeing with each other. We then apply both the Newton--Raphson method and the exact formula to the neutral-pion decay channel ($^{3}_Λ\mathrm{H} \rightarrow {}^{3}\mathrm{H} + π^{0}$), for which the neutral pion momentum cannot be directly measured due to difficulties in experimental setup. Both methods agree, yielding a predicted neutral-pion momentum of $p_{π^{0}} = 118.129$ MeV/$c$. This validates the root-finding algorithm as a robust equivalent for predicting pion momenta that may be experimentally inaccessible in some cases. Furthermore, it establishes the method as a reliable tool for extension to three-body mesonic decays, for which the pion momentum is a continuum and the exact kinematic formula can no longer be applied. In addition, the pion momentum computed allows for its 4-momentum to be completely determined, a useful input for investigating its two-photon decay ($π^0 \to γγ$) in the rest frame of the hypertriton.

</details>


### [130] [Microscopic description of $^{12}$C+$^{12,13}$C fusion reactions at nuclear astrophysical energies](https://arxiv.org/abs/2607.08502)
...
### [132] [Lectures on lepton-nucleus quasielastic scattering with relativistic models](https://arxiv.org/abs/2607.08629)
...
### [133] [Relativistic Mean Field Approach with Chiral Symmetry Breaking and Quark Confinement in the light of Astrophysical Observations](https://arxiv.org/abs/2607.08412)
...
### [134] [Secondary Hadron--Nucleus Collisions of Short-Lived Hadrons in Ultra-Relativistic Fixed-Target Heavy-Ion Interactions](https://arxiv.org/abs/2607.08658)
...
### [137] [BACH: A Bayesian Admixture of Contrastive Heads for Multi-Interest Two-Tower Retrieval](https://arxiv.org/abs/2607.08107)
...
### [138] [DaV-Gen: End-to-End Generative Retrieval via Draft-and-Verify](https://arxiv.org/abs/2607.08365)
...
### [139] [H3D: Benchmarking Unsupervised Text Hashing for Fine-Grained Document Deduplication](https://arxiv.org/abs/2607.08382)
...
### [143] [A 'normal' research trap limits scientific breakthroughs and disruptive innovation in the European Union](https://arxiv.org/abs/2607.08328)
...
### [144] [Uniform High-Probability ISS Tubes for Sampled-Data State Estimation](https://arxiv.org/abs/2607.07892)
*Jerzy Baranowski*
...
### [145] [Reachability-Preserving Bellman Operator for the Discounted Reach-Cost Value Function: Uniting Hamilton-Jacobi Reachability and Reinforcement Learning](https://arxiv.org/abs/2607.07893)
...
### [146] [Quantifying Implicit Overload Mandates in Phase Jump Requirements for Grid Forming Inverters](https://arxiv.org/abs/2607.07904)
...
### [147] [Modeling Stakeholders and Lifecycle Requirements of Marine Hydrokinetic Energy Systems](https://arxiv.org/abs/2607.08022)
...
### [148] [Model-Based Detection of Anomalous Events in Submarine Cables Using Distributed Deformation Sensing and Kalman Filtering](https://arxiv.org/abs/2607.08099)
...
### [149] [Geometry-Informed Maritime Anomaly Detection Using Probabilistic Roadmaps](https://arxiv.org/abs/2607.08100)
...
### [150] [Cost of Sensing in Optimal Control: Basic Formulations, Examples, and Applications](https://arxiv.org/abs/2607.08119)
...
### [151] [Input-Constrained Spatiotemporal Tubes for Safe Navigation of Unknown Euler-Lagrange Systems in Dynamic Environments](https://arxiv.org/abs/2607.08189)
...
### [152] [Data-Driven Critic-Free Policy Iteration for Continuous-Time Linear Quadratic Regulation](https://arxiv.org/abs/2607.08204)
...
### [153] [On the Convergence of the Current-Constrained Power Angle Curve of Virtual Admittance-Based Grid Forming Converters](https://arxiv.org/abs/2607.08214)
...
### [154] [A graph theoretic view on small signal stability of inverter-based power grids](https://arxiv.org/abs/2607.08260)
...
### [155] [Preconditioner-Based Acceleration Method for Solving EMTP Linear Equations](https://arxiv.org/abs/2607.08442)
...
### [156] [Decoupled Online Feedforward Generation of Optimal References for Saturated Synchronous Machine Drives](https://arxiv.org/abs/2607.08528)
...
### [157] [Robust Dynamic Operating Envelopes in Unbalanced Three-Phase Distribution Systems](https://arxiv.org/abs/2607.08578)
...
### [158] [REFORGE: A Method for Benchmarking LLMs' Reverse Engineering Capabilities in Decompiled Binary Function Naming](https://arxiv.org/abs/2607.07738)
...
### [159] [PERFOPT-Bench: Evaluating Coding Agents on Software Performance Optimization](https://arxiv.org/abs/2607.07744)
...
### [160] [Functional and Secure Code Generation with Task Vectors](https://arxiv.org/abs/2607.07881)
...
### [161] [ProjAgent: Procedural Similarity Retrieval for Repository-Level Code Generation](https://arxiv.org/abs/2607.08691)
...
### [162] [Bug Report Specification Refinement with Trajectory Guidance for Automated Program Repair](https://arxiv.org/abs/2607.07882)
...
### [163] [The Memory Wall of Green Software: Empirical Energy Evaluation of Memento Design Pattern](https://arxiv.org/abs/2607.07944)
...
### [164] [DeepSWE: Measuring Frontier Coding Agents on Original, Long-Horizon Engineering Tasks](https://arxiv.org/abs/2607.07946)
...
### [165] [3100 Opinions on Code Review in an AI World: Building Causal Theory from Practitioner Discourse](https://arxiv.org/abs/2607.07980)
...
### [166] [On the Correctness of Software Merge](https://arxiv.org/abs/2607.07987)
...
### [167] [Aleena: Alignment Agent for Research Software Engineering Collaborations](https://arxiv.org/abs/2607.08043)
...
### [168] [TTHE: Test-Time Harness Evolution](https://arxiv.org/abs/2607.08124)
...
### [169] [CTA-Pipelining: A Latency-Oriented Spatial Scaling Method for Multi-GPU Systems](https://arxiv.org/abs/2607.07862)
...
### [170] [Toward a Unified GPU-Aware OpenSHMEM Specification](https://arxiv.org/abs/2607.08006)
...
### [171] [On the Limitations of Non-GPU AI Accelerators for Large-Model Inference: A Field Study of MoE and Multimodal Serving on Huawei Ascend](https://arxiv.org/abs/2607.08215)
*Zheng Yu*
...
### [172] [Self-Stabilizing Algorithms in the Uniform Port Model](https://arxiv.org/abs/2607.08244)
...
### [173] [Empirical Analysis of GPU Frequency Behavior Under ML Workloads](https://arxiv.org/abs/2607.08307)
...
### [174] [Adaptive Row Selection Meets Asynchrony in Randomized Kaczmarz](https://arxiv.org/abs/2607.08313)
*Evan Coleman*
...
### [175] [Computing in Anonymous Dynamic Networks with One-Bit Communications](https://arxiv.org/abs/2607.08358)
...
### [176] [Coded Task Offloading for Fluid Computing: A Privacy-Aware Approach under D2D Networks](https://arxiv.org/abs/2607.08440)
...
### [177] [SMetric: Rethink LLM Scheduling for Serving Agents with Balanced Session-centric Scheduling](https://arxiv.org/abs/2607.08565)
...
### [178] [A study of neutrinoless double electron capture in $^{40}$Ca from the AMoRE experiment](https://arxiv.org/abs/2607.08039)
