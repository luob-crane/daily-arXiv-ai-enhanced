...
### [98] [Deuterium-Proton Fusion in an Effective Field Theory Constructed from On-Shell Amplitudes](https://arxiv.org/abs/2607.05514)
*Tim M. P. Tait*
...
### [99] [Full configuration interaction quantum Monte Carlo for accurate $\textit{ab initio}$ nuclear structure calculations: algorithms and calculation details](https://arxiv.org/abs/2607.05525)
...
### [100] [Can average speed of sound and thermodynamic response functions signal the exotic phases in neutron star cores?](https://arxiv.org/abs/2607.05555)
...
### [102] [Self-consistent description of emission processes in axially-symmetric nuclei](https://arxiv.org/abs/2607.05886)
...
Abstract: We present a theory of cluster emission processes in terms of proton ($π$) and neutron ($ν$) single--particle (sp) degrees of freedom within a self--consistent mean--field (SCMF) constructed from a two--particle interaction having relative (rel) and center of mass (com) terms centered on the nucler surface, the latter describing the interaction between the com of a pair of particles and the surface of an axially--symmetric nucleus. In this way the $α$-clustering phenomenon becomes enhanced on the nuclear surface. We present applications for unstable nuclei that decay through the emission of $α$--particles above $^{100}\textrm{Sn}$, $^{208}\textrm{Pb}$ and within the actinidies series.

</details>


### [103] [Full Uncertainty Quantification of Sign-Problem-Free Quantum Monte Carlo Methods and Nuclear Lattice Effective Field Theory Benchmarks](https://arxiv.org/abs/2607.06044)
...
### [104] [Bottomonium production in an open quantum system approach with interactions from lattice quantum chromodynamic](https://arxiv.org/abs/2607.06191)
...
### [105] [Bounded-Memory Parallel Image Pulling for Large Container Images](https://arxiv.org/abs/2607.05596)
...
### [106] [Layer 2 Coordinated Trusted Setup for Continuous CRS Generation](https://arxiv.org/abs/2607.05776)
...
### [107] [MatrixFSDP: communication-free matrix optimizers under ZeRO-3 parameter sharding](https://arxiv.org/abs/2607.05895)
...
### [108] [The Surplus Parking Gathering Problem in Infinite Grids](https://arxiv.org/abs/2607.05983)
...
### [109] [A Dual-CRDT Architecture for Decentralized Trust Governance and Evolution](https://arxiv.org/abs/2607.06068)
*Amos Brocco*
...
### [110] [DDB: Source-Level Interactive Debugging for Distributed Applications](https://arxiv.org/abs/2607.06107)
...
### [111] [Ordering by Unanimity: Giving Applications Sequencing Rights Without Breaking Composability](https://arxiv.org/abs/2607.06144)
*Andrea Canidio*
...
### [112] [UBEP: Re-architecting Expert Parallelism Communication Library for Production Superpods](https://arxiv.org/abs/2607.06202)
...
### [113] [$K^{*}(892)^0$ production and the time between freeze-outs in $^{40}$Ar+$^{45}$Sc collisions by NA61/SHINE at the CERN SPS](https://arxiv.org/abs/2607.05595)
...
### [114] [Interplay between Nuclear Shell Structure and Pairing around Doubly Magic $^{132}$Sn](https://arxiv.org/abs/2607.05647)
...
### [115] [A New Low $Q^2$ Measurement of the Proton's $g_1$ Spin Structure Function from Longitudinal & Transverse Polarized Data](https://arxiv.org/abs/2607.05741)
...
### [116] [Modality Relevance is not Modality Utility: Post-hoc Selective Modality Escalation for Cost-Aware Multimodal RAG](https://arxiv.org/abs/2607.05438)
*Xue Li,Yiming Gai*
...
### [117] [PORTS: Preference-Optimized Retrievers for Tool Selection with Large Language Models](https://arxiv.org/abs/2607.05441)
...
### [118] [Scientific Code Search at Scale: A Multi-Domain Dataset and Benchmark](https://arxiv.org/abs/2607.05443)
...
### [119] [Prompting Beats Fine-Tuning: Generative Expected Value Scoring for Statutory Term Retrieval](https://arxiv.org/abs/2607.05582)
...
### [120] [Retrieving a Set, Not Independent Passages: Set-Level Compatibility Learning for Efficient Set Exploration](https://arxiv.org/abs/2607.05712)
...
### [121] [SCOReD: Student-Aware CoT Optimization for Recommendation Distillation](https://arxiv.org/abs/2607.05734)
...
### [122] [Quantifying and Expanding the Theoretical Capacity of Late-Interaction Retrieval Models](https://arxiv.org/abs/2607.05803)
...
### [123] [CMDR: Contextual Multimodal Document Retrieval](https://arxiv.org/abs/2607.05927)
...
### [124] [Faithful or Findable? Evaluating LLM-Generated Metadata for RDF Dataset Search](https://arxiv.org/abs/2607.05970)
...
### [125] [Uncertainty-Aware Cross-Modal Remote Sensing Image-Text Retrieval via Evidential Learning](https://arxiv.org/abs/2607.06032)
...
### [126] [Learn to Pool: Lightweight Fine-Tuning for Flexible Multi-Vector Compression](https://arxiv.org/abs/2607.06036)
*Stefan Josef*
...
### [127] [Reachability Analysis for Power Systems with Heterogeneous Resources via Jordan Transformation](https://arxiv.org/abs/2607.05599)
...
### [128] [Input-to-State Stability Implications in Contraction Theory](https://arxiv.org/abs/2607.05640)
...
### [129] [Learning Stable Controlled Dynamical Systems via Input-Contraction Neural Differential Models](https://arxiv.org/abs/2607.05718)
*Syed Pouladi*
...
### [130] [Inertia-Informed Federated Learning Control Framework for Distributed Smart Grid Resilience](https://arxiv.org/abs/2607.05720)
...
### [131] [Causal--Structural Dynamic Graph Learning for Online Transient Stability Trajectory Prediction in Power Systems](https://arxiv.org/abs/2607.05729)
...
### [132] [Generalized Feedback Control Modeling Method for Control-Driven Converter Systems](https://arxiv.org/abs/2607.05782)
...
### [133] [Network Interdependency-Informed Power System Dynamic Trajectory Prediction Utilizing Black-Box Modeling of Inverter-Based Resources](https://arxiv.org/abs/2607.05843)
...
### [134] [Implementation of an Electric Drive Digital Twin in a Networked Test Lab Environment](https://arxiv.org/abs/2607.05877)
...
### [135] [FlexRC: A Flexible Multi-Point Model Order Reduction Method for Many-Port RC Networks](https://arxiv.org/abs/2607.05934)
...
### [136] [LLM-Guided Measurement Credibility Correction for Trustworthy Industrial Process Inference](https://arxiv.org/abs/2607.06111)
...
### [137] [Structural Analysis and Internal Stability Enhancement of Virtual-Admittance-Based Cascaded GFMIs Under Unity Voltage-Feedback Decoupling](https://arxiv.org/abs/2607.06192)
...
### [138] [Understanding Small-Signal Impedance Matrices in Different Reference Frames](https://arxiv.org/abs/2607.06416)
*J. Pedra*
...
### [139] [Adaptive and Neural Operator Control of Nonlinear Volterra Hyperbolic PDEs](https://arxiv.org/abs/2607.06425)
*Miroslav Krstic*
...
### [140] [Input-to-State Stability Certification via Projection Residuals for Koopman Learning Control of Nonlinear Repetitive Systems](https://arxiv.org/abs/2607.06459)
...
### [141] [Catalyst Papers in Artificial Intelligence Research: A Landscape on ICLR from 2017 to 2025](https://arxiv.org/abs/2607.05401)
*Fan Huang*
...
### [142] [When AI Classifies: What Counts as Public Administration?](https://arxiv.org/abs/2607.05420)
...
### [143] [Linking Hadith Narrator Identities Across Heterogeneous Arabic Biographical Databases: A Multi-Signal Entity Resolution Pipeline](https://arxiv.org/abs/2607.05424)
*Taufiq Wirahman*
...
### [144] [Women Enter Too, but Men Persist:The Temporal Structure of Gender Inequality in the Global Citation Elite](https://arxiv.org/abs/2607.05427)
*Marek Kwiek*
...
### [145] [CHARLIE: An On-Premise Multi-Agent Retrieval-Augmented Generation System for Evidential Reasoning in Forensic Science](https://arxiv.org/abs/2607.05428)
...
### [146] [Bibby AI: An Editor-Native Agentic Platform for Academic Research, Writing, and Publishing](https://arxiv.org/abs/2607.05435)
*Nilesh Jain*
...
### [147] [Publishing Without Journals: An Open, Forkable Archive with Attributed Review](https://arxiv.org/abs/2607.05454)
*Matthew Lorig*
...
### [148] [KAT-Coder-V2.5 Technical Report](https://arxiv.org/abs/2607.05471)
...
### [150] [A Mechanistic Lens on Semantic Conflicts: Using Activation Patching to Understand LLM Behavior](https://arxiv.org/abs/2607.05587)
...
### [151] [Bridging Stakeholder and Product Requirements: An Empirical Study of Requirement Engineering in the Automotive Industry](https://arxiv.org/abs/2607.05632)
...
### [152] [EvalLoop: A Methodology for Evaluation-Driven Iterative Improvement of Business AI Systems](https://arxiv.org/abs/2607.05638)
...
### [153] [Agents with Feelings? Personality and Emotion in Multi-Agent Software Teams](https://arxiv.org/abs/2607.05659)
...
### [155] [The Cathedral and the Bazaar of Software Vulnerabilities: From the NVD to the CNAs](https://arxiv.org/abs/2607.05670)
...
### [156] [From Conversation to Contribution: Characterizing Coding Agent in Open-Source Software](https://arxiv.org/abs/2607.05677)
...
### [157] [Articulating Assumptions in AI-Generated Scientific Analyses through Task Decomposition](https://arxiv.org/abs/2607.05762)
...
### [158] [Detecting Vulnerability-Inducing Commits via Multi-Stage Reasoning with LLM-Based Agents](https://arxiv.org/abs/2607.05772)
...
### [159] [Can Large Language Models Generate Observability-Aware Code?](https://arxiv.org/abs/2607.05785)
...
### [160] [SCOPE: Leveraging Subgoal Critiques for Code Generation](https://arxiv.org/abs/2607.05810)
...
### [161] [Beyond Refusal: A Same-Lineage Study of Aligned and Abliterated LLMs for Vulnerability Analysis](https://arxiv.org/abs/2607.05842)
...
### [162] [DebugTracker: Lightweight Process Evidence for Classroom Debugging](https://arxiv.org/abs/2607.05871)
...
### [163] [Hidden Amplifiers: Cross-Level Risk in Software Supply Chains](https://arxiv.org/abs/2607.05894)
...
### [164] [xDECAF: An Extensible Data Flow Diagram Analysis Framework for Information Security](https://arxiv.org/abs/2607.05913)
...
### [165] [Mitigating Errors in LLM-Generated Web API Invocations via Retrieval-Augmented Generation and Constrained Decoding](https://arxiv.org/abs/2607.05936)
...
### [166] [Large Language Models Have Unreliable Understanding of Software Engineering Terminology](https://arxiv.org/abs/2607.06004)
...
### [167] [Automating Quality Assessment with NLP of LLM-Generated Defeaters](https://arxiv.org/abs/2607.06039)
...
### [168] [SWE-Review: Closing the Loop on Issue Resolution with Agentic Code Review](https://arxiv.org/abs/2607.06065)
...
### [169] [Prompt Coach: An Empirical Evaluation of an Agentic Tutor for Learning Prompt Engineering in Software Development](https://arxiv.org/abs/2607.06074)
...
### [170] [Collaborative Multi-Agent Testing for Emergent Failure Discovery in Autonomous Driving Systems](https://arxiv.org/abs/2607.06078)
...
### [171] [Agents That Teach: Towards Designing Incidental Learning Back into AI-Assisted Software Development](https://arxiv.org/abs/2607.06101)
...
### [172] [Static Metrics Are Insufficient: Predicting Java Method Energy Usage with Execution Time](https://arxiv.org/abs/2607.06124)
...
### [173] [Evaluating Fine-Tuning and Metrics for Neural Decompilation of Dart AOT Binaries](https://arxiv.org/abs/2607.06125)
...
### [174] [Property-Driven Synthetic Data Engineering for Data-Scarce Software Systems: Reflections from the Breast Cancer Domain](https://arxiv.org/abs/2607.06133)
...
### [175] [A Global Author-Identity Map for the World of Code:62.7M Developer Identities from 106.8M Author Strings over 5.87B Commits](https://arxiv.org/abs/2607.06183)
*Audris Mockus*
...
### [176] [What Resolve Rate Hides: Trajectory Structure Diagnostics for Coding Agents](https://arxiv.org/abs/2607.06184)
...
### [177] [LogicHunter: Testing LLM Agent Frameworks with an Agentic Oracle](https://arxiv.org/abs/2607.06195)
...
### [178] [AgentTether: Graph-Guided Diagnosis and Runtime Intervention for Reliable LLM Agent Operation](https://arxiv.org/abs/2607.06273)
...
### [179] [UI2App: Benchmarking Visual Interaction Inference in Executable Web Application Generation](https://arxiv.org/abs/2607.06306)
...
### [180] [RuBench: A Repository-Level Agentic Coding Benchmark with Natively Authored Russian Task Specifications](https://arxiv.org/abs/2607.06411)
*Evgeny Shilov*
...
### [181] [Domain-Driven Design in Practice: A Large-Scale Empirical Characterisation of the Open-Source Ecosystem](https://arxiv.org/abs/2607.06471)
...
### [182] [Industry Classification of GitHub Repositories Using the North American Industry Classification System (NAICS)](https://arxiv.org/abs/2607.06505)
...
### [183] [Prompt-to-Paper: Agentic AI System for Bioinformatics](https://arxiv.org/abs/2607.05456)
...
### [184] [From Graphs to Gradients: Physics-Inspired Structural Attribution for Cyber-Physical IoT Systems and Beyond](https://arxiv.org/abs/2607.05563)
...
### [185] [CSTutorBench: Benchmarking Small Language Models as Tutors for Block-Based Programming](https://arxiv.org/abs/2607.05571)
...
### [186] [Foundation Models for Automatic CAD Generation](https://arxiv.org/abs/2607.05573)
...
### [187] [Narrative World Model: Narratology-Grounded Writer Memory for Long-Form Fiction](https://arxiv.org/abs/2607.05577)
...
### [188] [FirstResearch: Auditable Question Formation for LLM Scientific Discovery Agents](https://arxiv.org/abs/2607.05682)
*Yufeng Wang*
...
### [189] [Memory in the Loop: In-Process Retrieval as ExtendedWorking Memory for Language Agents](https://arxiv.org/abs/2607.05690)
...
### [190] [Akashic: A Low-Overhead LLM Inference Service with MemAttention](https://arxiv.org/abs/2607.05708)
...
### [191] [ArtisanCAD: An Industrial-Level CAD Agent with Expert-Grounded Knowledge Distillation](https://arxiv.org/abs/2607.05750)
...
### [192] [Synthetic Consumer Insight Generation with Large Language Models](https://arxiv.org/abs/2607.05761)
...
### [193] [Beyond Static Evaluation: Building Simulation Environments for Scalable Agentic Reinforcement Learning](https://arxiv.org/abs/2607.05773)
...
### [194] [Beyond the Leaderboard: A Synthesis of Tool-Use, Planning, and Reasoning Failures in Large Language Model Agents](https://arxiv.org/abs/2607.05775)
...
### [195] [Controlling Tool Use with Heading-Specific Activation Steering](https://arxiv.org/abs/2607.05790)
...
### [196] [From Passive Retrieval to Active Memory Navigation: Learning to Use Memory as a Structured Action Space](https://arxiv.org/abs/2607.05794)
...
### [197] [Auto-DSM Under the Lens: A Black-Box Evaluation Framework for LLM-Based DSM Generation](https://arxiv.org/abs/2607.05985)
...
### [198] [TurnOPD: Making On-Policy Distillation Turn-Aware for Efficient Long-Horizon Agent Training](https://arxiv.org/abs/2607.05804)
...
### [199] [Onnes: A Physics-Grounded Multi-Agent LLM Simulator for Cryogenic Fault Diagnosis in Quantum Computing Infrastructure](https://arxiv.org/abs/2607.05805)
...
### [200] [StateFuse: Deterministic Conflict-Preserving Memory for Multi-Agent Systems](https://arxiv.org/abs/2607.05844)
...
### [201] [Uncovering Latent Depression Severity for Binary Depression Detection via Advantage-weighting Ranking](https://arxiv.org/abs/2607.05901)
...
### [202] [PCBWorld: A Benchmark Environment for Engine-Grounded PCB Design Automation](https://arxiv.org/abs/2607.05915)
...
### [203] [SearchEyes: Towards Frontier Multimodal Deep Search Intelligence via Search World Simulation](https://arxiv.org/abs/2607.05943)
...
### [204] [Integrating knowledge graphs and multilingual scholarly corpora for domain-adaptive LLMs in SSH](https://arxiv.org/abs/2607.05956)
...
### [205] [AgoraSim: A Hybrid Agent-Based Modeling Framework](https://arxiv.org/abs/2607.05999)
*Chung-Chi Chen*
...
### [206] [Information Limits and Attractor Dynamics in Economies of Frontier LLM Agents: A Pre-Registered Test](https://arxiv.org/abs/2607.06001)
*Cheng Qian*
...
### [207] [PolyWorkBench: Benchmarking Multilingual Long-Horizon LLM Agents](https://arxiv.org/abs/2607.06008)
...
### [208] [Reward-Density Heuristic for Dynamic Multi-Vehicle Routing: Performance and Computational Efficiency](https://arxiv.org/abs/2607.06066)
...
### [209] [When do prophets profit in prediction markets?](https://arxiv.org/abs/2607.06166)
...
### [210] [A toy framework for single and multi-agent human-AI curiosity ecosystems](https://arxiv.org/abs/2607.06214)
*Ilya E. Monosov*
...
### [211] [Information Gain-based Rollout Policy Optimization: An Adaptive Tree-Structured Rollout Approach for Multi-Turn LLM Agents](https://arxiv.org/abs/2607.06223)
...
### [212] [Demonstrating TOFFEE: A Learned System for Synthesizing Data Agent Trajectories at Scale](https://arxiv.org/abs/2607.06233)
...
### [213] [From Application-Layer Simulation to Native Meta-Architecture: Structural Tension as an Endogenous Driver for Heterogeneous AI Evolution](https://arxiv.org/abs/2607.06269)
*Heting Mao*
...
### [214] [Task Decomposition-Guided Reranking for Adaptive Agent Skill Retrieval](https://arxiv.org/abs/2607.06283)
...
### [215] [DT-Guard: Intent-Driven Reasoning-Active Training for Reasoning-Free LLM Safety Guardrail](https://arxiv.org/abs/2607.06326)
...
### [216] [Driving the Wrong Way: Leveraging Interpretability in End2End Autonomous Driving Models](https://arxiv.org/abs/2607.06328)
...
### [217] [TopoBrick: Agentic Topology Sampling of Exogenous Variables for Zero-Shot Building IoT Forecasting](https://arxiv.org/abs/2607.06349)
...
### [218] [A Definition and Roadmap for World Models](https://arxiv.org/abs/2607.06401)
...
### [219] [ExplAIner: A Declarative Query Language for Explaining Classification Models](https://arxiv.org/abs/2607.06407)
...
### [220] [Finding H. pylori in the Fine Print: Evidence-Linked Multi-Agent Case Finding from Gastric Biopsy Reports](https://arxiv.org/abs/2607.06435)
...
### [221] [Danus: Orchestrating Mathematical Reasoning Agents with Fact-Graph Memory](https://arxiv.org/abs/2607.06447)
...
### [222] [A Physics-Informed Neural Network Framework for Elastodynamic Wave Propagation in Bimaterial Systems](https://arxiv.org/abs/2607.06479)
...
### [223] [Multi-Agent Deep Reinforcement Learning for Multi Objective Battery Management in Dairy Farms](https://arxiv.org/abs/2607.06489)
...
### [224] [Doomed from the Start: Early Abort of LLM Agent Episodes via a Recall-Controlled Probe Cascade](https://arxiv.org/abs/2607.06503)
...
### [225] [RMISC: A Large-scale Real-world Multivariate Corpus for Time Series Foundation Models](https://arxiv.org/abs/2607.06504)
...
### [226] [FootsiesGym: A Fighting Game Benchmark for Two-Player Zero-Sum Imperfect-Information Games](https://arxiv.org/abs/2607.06514)
...
### [227] [FreqDepthKV: Frequency-Guided Depth Sharing for Robust KV Cache Compression in Long-Context LLM Inference](https://arxiv.org/abs/2607.06519)
*Anna Córdoba,Adam Puente Tercero,Nerea Angulo Hijo,Mar Linares Tercero,Julia Barrientos,Ainhoa Miranda,Jesús Olivera*
...
### [228] [Bridging Physical Reasoning and Task Generalization via Visual Action Outcome Reasoning Alignment](https://arxiv.org/abs/2607.06522)
...
### [229] [DepthWeave-KV: Token-Adaptive Cross-Layer Residual Factorization for Long-Context KV Cache Compression](https://arxiv.org/abs/2607.06523)
...
### [230] [The Large Cancer Assistant (LCA): A Model-Agnostic Orchestration Framework for Scalable Clinical Decision Support in Oncology](https://arxiv.org/abs/2607.06531)
...
### [231] [Rethinking Indic AI from a Lens of Cultural Heritage Preservation](https://arxiv.org/abs/2607.06544)
...
### [232] [TMF-RSE: Tri-Modal Fusion with Regional Semantics and Evidential Uncertainty for Lung Severity Scoring](https://arxiv.org/abs/2607.06356)
